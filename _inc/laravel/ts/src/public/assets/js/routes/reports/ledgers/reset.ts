...
((): void => {
  try {
    ...
    const flag = "data-reset-ledger-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.reset-ledger") : null);
          if (!a) return;
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Ledger report route is unavailable. Please contact technical support or your domain administrator.";
