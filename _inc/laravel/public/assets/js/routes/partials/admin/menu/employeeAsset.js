/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/employeeAsset.js
 * @generated from original JavaScript - manual review recommended
 * @module employeeAsset
 */
(() => {
    const listenerAttr = "data-employees-asset-setup-listener-active", el = document.getElementById("employees-asset-setup-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[employeeAsset] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=employeeAsset.js.map