        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                        ...
                        <div class="card">
                            <?php echo e(Collective\Html\FormFacade::open(array('route' => R::FQ.'.store', 'method'=>'post', 'enctype' => "multipart/form-data"))); ?>
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="faq_status"
                                                        id="faq_status"  <?php echo e($lpSettings[LandingPageSettingsConstants::FAQ_STT_K] == 'on' ? 'checked="checked"' : ''); ?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::FAQ_TTL_K,$lpSettings[LandingPageSettingsConstants::FAQ_TTL_K], ['class' => 'form-control', 'placeholder' => __('Enter Title')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::FAQ_HDG_K,$lpSettings[LandingPageSettingsConstants::FAQ_HDG_K], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::FAQ_DESC_K, $lpSettings[LandingPageSettingsConstants::FAQ_DESC_K], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
...
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\Modules/LandingPage\Resources/views/landingpage/faqs/index.blade.php ENDPATH**/ ?>