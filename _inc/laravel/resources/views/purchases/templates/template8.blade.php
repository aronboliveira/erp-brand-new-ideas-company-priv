            ...
            <table>
                <tbody>
                    <tr style="border-bottom:1px solid var(--theme-color);">
                        ...
                        <td class="text-right">
                            <h3 style="text-transform:uppercase;font-size:40px;font-weight:bold;color:var(--theme-color);"><?= e(__('PURCHASE')) ?></h3>
                        </td>
                    </tr>
                </tbody>
            </table>
