...
class ExpenseController extends Controller
{
    ...
    public function vendor(Request $request)
    {
        ...
        return view('expense.vendor_detail', compact('vendor'));
    }
    ...
    public function index(Request $request)
    {
        ...
        if (\Auth::user()->can('manage bill')) {
            ...
            return view('expense.index', compact('expenses', 'vendor', 'status', 'category'));
        } else {
    ...
    public function create($Id)
    {
        if (\Auth::user()->can('create bill')) {
            ...
            return view('expense.create', compact('employees', 'customers', 'vendors', 'expense_number', 'product_services', 'category', 'customFields', 'Id', 'chartAccounts', 'accounts'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        if (\Auth::user()->can('create bill')) {
            ...
            if ($request->type == 'employee') {
                $expense->vendor_id      = $request->employee_id;
            } elseif ($request->type == 'customer') {
                $expense->vendor_id      = $request->customer_id;
            } else {
    ...
    public function productDestroy(Request $request)
    {
        ...
        if (\Auth::user()->can('delete bill product')) {
            ...
            Utility::updateUserBalance('vendor', $expense->vendor_id, $request->amount, 'credit');
    ...
    public function destroy($id)
    {
        ...
        if (\Auth::user()->can('delete bill')) {
            ...
            if ($expense->created_by == \Auth::user()->creatorId()) {
                ...
                if ($expense->vendor_id != 0 && $expense->status != 0) {
                    Utility::updateUserBalance('vendor', $expense->vendor_id, $expense->getDue(), 'credit');
                }
