...
((): void => {
  try {
    ...
    const flag = "data-apply-monthly-attendance-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            f.getAttribute("data-guard-msg") ?? "Monthly attendance apply route is unavailable. Please contact technical support or your domain administrator.";
