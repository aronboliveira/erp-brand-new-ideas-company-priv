<div class="col-form-label">
    <div class="row px-3">
        ...
        <div class="col-lg-12 our-system">
            {{Collective\Html\FormFacade::open(array('route'=>array('payslip.updateemployee',$payslip->employee_id),'method'=>'post'))}}
            {!! Collective\Html\FormFacade::hidden('payslip_id', $payslip->id, ['class' => 'form-control']) !!}
            <div class="row">
                                    ...
                                    <div class="row px-3">
                                        ...
                                        @foreach($allowances as $allownace)
                                            <div class="col-md-12 form-group">
                                                {!! Collective\Html\FormFacade::label('title', $allownace->title,['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('allowance[]', $allownace->amount, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('allowance_id[]', $allownace->id, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($commissions as $commission)
                                            <div class="col-md-12 form-group">
                                                {!! Collective\Html\FormFacade::label('title', $commission->title,['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('commission[]', $commission->amount, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('commission_id[]', $commission->id, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($loans as $loan)
                                            <div class="col-md-12 form-group">
                                                {!! Collective\Html\FormFacade::label('title', $loan->title,['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('loan[]', $loan->amount, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('loan_id[]', $loan->id, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($saturation_deductions as $deduction)
                                            <div class="col-md-12 form-group">
                                                {!! Collective\Html\FormFacade::label('title', $deduction->title,['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('saturation_deductions[]', $deduction->amount, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('saturation_deductions_id[]', $deduction->id, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="card bg-none mb-0">
                                    <div class="row px-3">
                                        ...
                                        @foreach($other_payments as $payment)
                                            <div class="col-md-12 form-group">
                                                {!! Collective\Html\FormFacade::label('title', $payment->title,['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('other_payment[]', $payment->amount, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('other_payment_id[]', $payment->id, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                    ...
                                    <div class="row px-3">
                                        ...
                                        @foreach($overtimes as $overtime)
                                            ...
                                            <div class="col-md-6 form-group">
                                                {!! Collective\Html\FormFacade::label('rate', $overtime->title.' '.__('Rate'),['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('rate[]', $overtime->rate, ['class' => 'form-control']) !!}
                                                {!! Collective\Html\FormFacade::hidden('rate_id[]', $overtime->id, ['class' => 'form-control']) !!}
                                            </div>
                                            <div class="col-md-6 form-group">
                                                {!! Collective\Html\FormFacade::label('hours',$overtime->title.' '.__('Hours'),['class'=>'col-form-label']) !!}
                                                {!! Collective\Html\FormFacade::text('hours[]', $overtime->hours, ['class' => 'form-control']) !!}
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
