/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/taxSummary.js
 * @generated from original JavaScript - manual review recommended
 * @module taxSummary
 */
(() => {
    const listenerAttr = "data-tax-summary-listener-active", el = document.getElementById("tax-summary-link");
