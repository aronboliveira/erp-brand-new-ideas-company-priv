            ...
            el.addEventListener("click", (e) => {
                try {
                    ...
                    const msg = el.getAttribute("data-guard-msg") ??
                        "Create project task stage route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
