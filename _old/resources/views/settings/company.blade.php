                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    {{ Form::text('vendor_prefix', null, ['class' => 'form-control']) }}
                                    @error('vendor_prefix')
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Form::checkbox('twilio_vendor_notification', '1', isset($setting['twilio_vendor_notification']) && $setting['twilio_vendor_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_vendor_notification']) }}
                                                <label class="form-check-label"
