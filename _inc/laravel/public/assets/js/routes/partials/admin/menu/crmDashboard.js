/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/crmDashboard.js
 * @generated from original JavaScript - manual review recommended
 * @module crmDashboard
 */
(() => {
    const listenerAttr = "data-crm-dashboard-listener-active", el = document.getElementById("crm-dashboard-link");
