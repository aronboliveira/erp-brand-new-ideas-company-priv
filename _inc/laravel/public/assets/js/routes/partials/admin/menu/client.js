/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/client.js
 * @generated from original JavaScript - manual review recommended
 * @module client
 */
(() => {
    const listenerAttr = "data-clients-index-listener-active", el = document.getElementById("clients-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("clients-index-link"))
            observer.disconnect();
    });
