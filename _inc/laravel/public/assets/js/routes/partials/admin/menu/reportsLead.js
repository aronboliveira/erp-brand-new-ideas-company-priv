/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsLead.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsLead
 */
(() => {
    const listenerAttr = "data-lead-listener-active", el = document.getElementById("reports-lead-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsLead] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsLead.js.map