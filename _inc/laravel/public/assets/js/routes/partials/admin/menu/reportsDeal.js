/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsDeal.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsDeal
 */
(() => {
    const listenerAttr = "data-deal-listener-active", el = document.getElementById("reports-deal-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsDeal] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsDeal.js.map