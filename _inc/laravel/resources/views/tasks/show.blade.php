    ...
    <div class="modal-content">
        <div class="modal-header">
            <div class="col d-flex align-items-center">
                <div class="custom-control custom-checkbox mt-n1">
                    <input type="checkbox" class="custom-control-input" id="complete_task" @if($task[ProjectsConstants::COL_IS_CP] == 1) checked @endif data-url="{{ route('change.complete',[$task->project_id,$task->id]) }}">
            ...
            <div class="col-auto">
                <div class="actions text-end">
                    <div class="float-left">
                        <a href="#" class="action-item {{($task[ProjectsConstants::COL_IS_FV]) ? 'action-favorite' : ''}} active" data-url="{{ route('change.fav',[$task->project_id,$task->id]) }}" id="add_favourite" data-toggle="tooltip" data-original-title="{{__('Mark as favorite')}}">
        ...
        <div class="scrollbar-inner">
            <div class="modal-body">
                ...
                <div class="{{ ViewClassNamesConstants::LG_FLSH_MB0 }}">
                ...
                <div class="{{ ViewClassNamesConstants::LG_FLSH_MB0 }}" id="comments">
