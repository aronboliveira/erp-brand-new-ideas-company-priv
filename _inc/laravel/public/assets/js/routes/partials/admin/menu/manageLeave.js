/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/manageLeave.js
 * @generated from original JavaScript - manual review recommended
 * @module manageLeave
 */
(() => {
    const listenerAttr = "data-manage-leave-listener-active", el = document.getElementById("manage-leave-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[manageLeave] Error:`, error);
            }
        });
    }
