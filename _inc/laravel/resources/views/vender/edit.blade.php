@php
    ...
    $showShipping = \App\Models\Utility::getValByName('shipping_display') === 'on';
@endphp

{{ Form::model($vendor,[
    'route'   => [ViewsConstants::VND . '.update', $vendor->id],
    'method'  => 'PUT'
]) }}
...
<div class="modal-body">
    ...
    @if($showShipping)
        <div class="col-md-12 text-end mb-3">
            <button type="button" id="billing_data" class="btn btn-primary">
