/**
 * @fileoverview TypeScript version of public/assets/js/routes/bills/lang/edit.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    fr: {
      ...
      vendor_detail_fetch_failed:
        "Échec de la récupération des détails du fournisseur.",
      item_data_fetch_failed:
        "Échec de la récupération des données de l’article.",
      bill_items_fetch_failed:
        "Échec de la récupération des lignes de facture.",
    ...
    it: {
      ...
      vendor_detail_fetch_failed:
        "Impossibile recuperare i dettagli del fornitore.",
