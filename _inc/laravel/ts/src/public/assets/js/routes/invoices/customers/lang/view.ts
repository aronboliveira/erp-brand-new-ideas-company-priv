/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/customers/lang/view.js
 * @generated from original JavaScript — automated migration
 * @module view
 */
/* eslint-disable @typescript-eslint/no-unsafe-member-access */
export {};
declare const is_page: (name: string) => boolean;
declare const is_404: () => boolean;
declare global {
  interface Window {
