/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsDailyPos.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsDailyPos
 */
(() => {
    const listenerAttr = "data-daily-pos-listener-active", el = document.getElementById("daily-pos-report-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsDailyPos] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsDailyPos.js.map