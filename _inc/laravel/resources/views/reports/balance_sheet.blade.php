...
@section(YieldingConstants::ADM_ACT_BTN)
    ...
    <div class="{{ VC::FEND }} me-2">
        ...
        data-guard-msg="{{ $balanceSheetHorizontalGuardMsg }}"
        data-sv-localized="true">
                ...
                <div class="{{ VC::CD }}">
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $fmt = function($v){ $u = $user; return ($u && method_exists($u,'priceFormat')) ? ($u->priceFormat($v) ?? number_format((float)$v,2)) : number_format((float)$v,2); };
                            $totalAmount = 0;
                        @endphp
                                    ...
                                    @foreach ($accounts as $account)
                                        ...
                                        <div class="border-bottom {{ VC::PY2 }}">
                                            ...
                                            <div class="account-inner {{ VC::DFL_AIC_JCB }} ps-4">
                                                ...
                                                <p class="fw-bold mb-2 text-end">{{ $fmt($lastNet) }}</p>
                                            </div>
                                        </div>
                                        @php
