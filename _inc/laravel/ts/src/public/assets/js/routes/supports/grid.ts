/**
 * @fileoverview TypeScript version of public/assets/js/routes/supports/grid.js
        ...
        l.addEventListener("click", (e: Event) => {
          try {
            ...
            const msg =
              ...
              "Grid support route is unavailable. Please contact technical support or your domain administrator.";
            const hasBootstrap = !!(
