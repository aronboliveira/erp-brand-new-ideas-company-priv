        ...
        l.addEventListener("click", function (e) {
            try {
                ...
                const msg = l.getAttribute("data-guard-msg") ??
                    "Dashboard route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBs = linkEl !== null && window.bootstrap.Toast;
                ...
                if (hasBs) {
                    ...
                    t.addEventListener("hidden.bs.toast", function () {
                        try {
                            ...
                            console.error(`[dashboard] Error:`, _);
                        }
                    });
                    inst.show();
                }
