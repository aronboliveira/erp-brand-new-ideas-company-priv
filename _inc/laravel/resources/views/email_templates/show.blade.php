    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body ">
                    {{-- <div class="card"> --}}
                    {{Collective\Html\FormFacade::model($currEmailTempLang, array('route' => array('email_template.update', $currEmailTempLang->parent_id), 'method' => 'PUT')) }}
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            {{ Collective\Html\FormFacade::label('subject', __('Subject'), ['class' => 'col-form-label text-dark']) }}
                            {{ Collective\Html\FormFacade::text('subject', null, ['class' => 'form-control font-style', 'required' => 'required']) }}
                        </div>
                        <div class="form-group col-md-6">
                            {{ Collective\Html\FormFacade::label('from', __('From'), ['class' => 'col-form-label text-dark']) }}
                            {{ Collective\Html\FormFacade::text('from', $emailTemplate->from, ['class' => 'form-control font-style', 'required' => 'required']) }}
                        </div>

                        <div class="form-group col-12">
                            {{ Collective\Html\FormFacade::label('content', __('Email Message'), ['class' => 'col-form-label text-dark']) }}
                            {{ Collective\Html\FormFacade::textarea('content', $currEmailTempLang->content, ['class' => 'summernote-simple', 'required' => 'required']) }}
                        </div>

                        <div class="modal-footer">
                            {{ Collective\Html\FormFacade::hidden('lang', null) }}
                            {{ Collective\Html\FormFacade::submit(__('Save Changes'), ['class' => 'btn btn-xs btn-primary']) }}
                        </div>
