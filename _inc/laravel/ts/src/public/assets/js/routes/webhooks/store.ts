/**
 * @fileoverview TypeScript version of public/assets/js/routes/webhooks/store.js
  ...
  try {
    ...
    f.addEventListener("submit", e => {
      try {
        ...
        const msg =
          f.getAttribute("data-guard-msg") ?? "Store webhook route is unavailable. Please contact technical support or your domain administrator.";
