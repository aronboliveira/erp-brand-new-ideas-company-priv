            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                        ...
                        <div class="card">
                            ...
                            <?php echo e(Form::open(array('route' => R::DV.'.store', 'method'=>'post', 'enctype' => "multipart/form-data"))); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text(LPC::DC_HDG_K, !empty($lpSettings[LPC::DC_HDG_K]) ? $lpSettings[LPC::DC_HDG_K] : __('No heading found for discover'), ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text(LPC::DC_DESC_K, !empty($lpSettings[LPC::DC_DESC_K]) ? $lpSettings[LPC::DC_DESC_K] : __('No description found for discover'), ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text(LPC::DC_DEMO_LNK_K, !empty($lpSettings[LPC::DC_DEMO_LNK_K]) ?$lpSettings[LPC::DC_DEMO_LNK_K] : __('No demo link available'), ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>

                                                <?php $__errorArgs = [LPC::DC_DEMO_LNK_K];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text(LPC::DC_BUY_LNK_K, !empty($lpSettings[LPC::DC_BUY_LNK_K]) ? $lpSettings[LPC::DC_BUY_LNK_K] : __('No buy now link available'), ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>

                                                <?php $__errorArgs = [LPC::DC_BUY_LNK_K];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="<?php echo e(VC::CLMS_JCE3); ?>">
                                        <a 
                                            ...
                                            class="<?php echo e(VC::BT_SM_PM); ?> <?php echo e($canCreateDiscover ? '' : 'disabled'); ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                           <?php if(Utility::isFilled($discover_of_features)): ?>
                                                <?php
                                                    $no = 1;
                                                ?>
                                                <?php $__currentLoopData = $discover_of_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(Utility::isFilled($feature)): ?>
                                                        <tr>
                                                            <td><?php echo e($no++); ?></td>
                                                            <td><?php echo e(!empty($feature[LPC::DC_HDG_K]) ? $feature[LPC::DC_HDG_K] : __('Unnamed Feature')); ?></td>
                                                            <?php
                                                                $editRoute    = R::DV.'.edit';
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <div class="text-center">
                                                            <?php echo e(__('No discover feature found')); ?>
