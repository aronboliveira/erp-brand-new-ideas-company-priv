...
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="archive-form-"][data-url][data-guard-msg]'));
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        const msg = fm.getAttribute("data-guard-msg") ??
                            "Archive job application route is unavailable. Please contact technical support or your domain administrator.";
        ...
        const links = Array.from(document.querySelectorAll('a[id^="archive-link-"][data-url][data-guard-msg]'));
        links.forEach(l => {
            try {
