/**
 * Auto-generated Playwright tests for interview_schedules routes
 * Generated: 2026-03-08T23:55:10.526Z
 * 
...
test.describe('interview_schedules.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/interview_schedules-create.html');
...
test.describe('interview_schedules.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/interview_schedules-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('interview_schedules.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/interview_schedules-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('interview_schedules.show', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/interview_schedules-show.html');
    await page.waitForLoadState('networkidle');
