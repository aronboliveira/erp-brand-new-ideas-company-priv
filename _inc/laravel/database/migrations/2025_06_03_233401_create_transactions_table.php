    ...
    public function up(): void
    {
        if (!Schema::hasTable(self::TABLE))
            Schema::create(self::TABLE, function (Blueprint $table) {
                ...
                $table->enum(BC::COL_PAY_TP, [TransactionType::Bill->value, TransactionType::Invoice->value, TransactionType::Pos->value, TransactionType::Other->value])->default(TransactionType::Other->value)->nullable()->index();
                $table->uuid(BC::COL_PAY_ID)->nullable()->index(); // ? Referes to a bill payment OR an invoice payment OR a POS payment
