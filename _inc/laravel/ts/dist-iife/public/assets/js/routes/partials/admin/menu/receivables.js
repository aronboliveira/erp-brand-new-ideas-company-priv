...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/receivables.js
 * @generated from original JavaScript - manual review recommended
 * @module receivables
 */
(() => {
    const listenerAttr = "data-receivables-listener-active", el = document.getElementById("receivables-link");
