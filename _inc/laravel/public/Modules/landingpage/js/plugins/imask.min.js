!(function (t, e) {
  ...
  class d {
    ...
    _appendCharRaw(t) {
      return t
        ? ((this._value += t), new i({ inserted: t, rawInserted: t }))
        : new i();
    }
    _appendChar(t) {
      let e =
    ...
    append(t, e, s) {
      ...
      for (let s = 0; s < t.length; ++s) {
        ...
        if (!i.rawInserted && !this.doSkipInvalid(t[s], e, n)) break;
        u.aggregate(i);
      }
      return (
        null != n && (u.tailShift += this.appendTail(n).tailShift),
      ...
      let t =
        ...
        e =
          arguments.length > 1 && void 0 !== arguments[1]
            ...
            : this.value.length;
      return (
        (this._value = this.value.slice(0, t) + this.value.slice(e)), new i()
      );
    }
    withValueRefresh(t) {
    ...
    splice(t, e, s, a) {
      ...
      if (
        (a !== u.NONE &&
          ((d = this.nearestInputPos(t, e > 1 && 0 !== t && !l ? u.NONE : a)),
          (p.tailShift = d - t)),
        p.aggregate(this.remove(d)),
        l && a !== u.NONE && o === this.rawInputValue)
      )
        if (a === u.FORCE_LEFT) {
          let t;
          for (; o === this.rawInputValue && (t = this.value.length); )
            p.aggregate(new i({ tailShift: -1 })).aggregate(this.remove(t - 1));
  ...
  function p(t) {
    ...
    return t instanceof RegExp
      ...
      ? t
      : t instanceof s.Masked
      ? t.constructor
      : t instanceof Function
      ? s.MaskedFunction
      : (console.warn("Mask not found for mask", t), s.Masked);
  }
  function c(t) {
  ...
  class f {
    ...
    _appendChar(t) {
      ...
      return (
        a.inserted &&
          !1 === this.doValidate(e) &&
          ((a.inserted = a.rawInserted = ""), (this.masked.state = s)),
        a.inserted ||
          this.isOptional ||
          this.lazy ||
          e.input ||
        ...
        (this.isFilled = Boolean(a.inserted)),
        a
      );
    }
    append() {
  ...
  class C extends d {
      ...
      for (let r = 0; r < e.length; ++r) {
        ...
        const o =
          ...
          d = l
            ...
            : new m({ char: h, eager: this.eager, isUnmasking: i });
        this._blocks.push(d);
      }
    }
    get state() {
    ...
    _appendCharRaw(t) {
      ...
      for (let i = s.index; ; ++i) {
        ...
        const r = s._appendChar(
          ...
          h = r.skip;
        if ((a.aggregate(r), h || r.rawInserted)) break;
      }
      return a;
    }
    extractTail() {
    ...
    _appendPlaceholder(t) {
      ...
      return (
        this._blocks.slice(a, u).forEach(s => {
          if (!s.lazy || null != t) {
  ...
  class b extends C {
    ...
    _update(t) {
      ...
      (t.mask = i.slice(0, a).replace(/0/g, "\\0") + "0".repeat(e - a)),
        super._update(t);
    }
    get isComplete() {
    ...
    doPrepare(t) {
      ...
      if (
        (([t, e] = r(super.doPrepare(t.replace(/\D/g, ""), s))),
        !this.autofix || !t)
      )
        return t;
  ...
  class T {
    ...
    updateOptions(t) {
      const { mask: s } = t,
        ...
        u = !h(this.masked, i);
      a && (this.mask = s),
        u && this.masked.updateOptions(i),
        (a || u) && this.updateControl();
    }
    updateCursor(t) {
    ...
    _onInput(t) {
      ...
      a !== u.NONE && (n = this.masked.nearestInputPos(n, u.NONE)),
        this.updateControl(),
        this.updateCursor(n),
  ...
  (w.UNMASKED_RADIX = "."),
    ...
    (w.EMPTY_VALUES = [...d.EMPTY_VALUES, 0]),
    (s.MaskedNumber = w);
  class y extends d {
    _update(t) {
  ...
  class P extends d {
    ...
    doPrepare(t) {
      ...
      if (this.currentMask) {
        let t;
        ([s, t] = r(super.doPrepare(s, this.currentMaskFlags(e)))),
          (i = i.aggregate(t));
      }
      return [s, i];
    }
    ...
    set state(t) {
      const { compiledMasks: s, currentMaskRef: i, currentMask: a } = t,
        u = e(t, V);
          ...
          return (
            ...
            n.appendTail(i),
            {
              ...
              totalInputPositions: n.totalInputPositions(
                0,
                Math.max(l, n.nearestInputPos(n.value.length, u.FORCE_LEFT))
              ),
            }
          );
        });
