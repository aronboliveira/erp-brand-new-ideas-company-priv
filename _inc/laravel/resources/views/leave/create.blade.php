{{Collective\Html\FormFacade::open(array('url'=>'leave','method'=>'post'))}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {{Collective\Html\FormFacade::select('employee_id',$employees,null,array('class'=>'form-control select','id'=>'employee_id','placeholder'=>__('Select Employee')))}}
                    </div>
                </div>
            </div>
        @endif
