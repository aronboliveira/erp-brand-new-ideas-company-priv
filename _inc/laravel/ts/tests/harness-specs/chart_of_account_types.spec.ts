/**
 * Auto-generated Playwright tests for chart_of_account_types routes
...
test.describe('chart_of_account_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/chart_of_account_types-create.html');
...
test.describe('chart_of_account_types.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/chart_of_account_types-index.html');
    await page.waitForLoadState('networkidle');
