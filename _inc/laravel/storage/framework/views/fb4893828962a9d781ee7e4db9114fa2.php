            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                        ...
                        <div class="card">
                            ...
                            <?php echo e(Collective\Html\FormFacade::open(array('route' => 'features.store', 'method'=>'post', 'enctype' => "multipart/form-data"))); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::FT_TTL_K,$lpSettings[LandingPageSettingsConstants::FT_TTL_K], ['class' => 'form-control', 'placeholder' => __('Enter Title')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text('feature_heading',$lpSettings['feature_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text('feature_description', $lpSettings['feature_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Collective\Html\FormFacade::text('feature_buy_now_link', $lpSettings['feature_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="<?php echo e(ViewClassNamesConstants::CLMS_JCE3); ?>">
                                        ...
                                        <a
                                            ...
                                            class="<?php echo e(ViewClassNamesConstants::BT_SM_PM); ?> <?php echo e($canCreateFeature ? '' : 'disabled'); ?>"
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn <?php echo e(ViewClassNamesConstants::BG_P); ?> ms-2">
                                                                    <?php if(Route::has('features.edit')): ?>
                                                                        <a href="#"
                                                                           class="mx-3 btn btn-sm align-items-center"
                                                                           data-url="<?php echo e(route('features.edit', $key)); ?>"
                                                                           data-ajax-popup="true"
                                                                ...
                                                                <div class="<?php echo e(ViewClassNamesConstants::ACT_BTN_DNG_2); ?>">
                                                                    <?php if(Route::has('features.destroy')): ?>
                        ...
                        <div class="card">
                            ...
                            <?php echo e(Collective\Html\FormFacade::open(array('route' => R::FT . '.highlight.store', 'method'=>'post', 'enctype' => "multipart/form-data"))); ?>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php echo e(Collective\Html\FormFacade::label('highlight_feature_heading', __('Heading'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Collective\Html\FormFacade::text('highlight_feature_heading', $lpSettings['highlight_feature_heading'], ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <?php echo e(Collective\Html\FormFacade::label('highlight_feature_heading', __('Description'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Collective\Html\FormFacade::text('highlight_feature_description', $lpSettings['highlight_feature_description'], ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="logo-content mt-4">
                                                    <img id="image1" src="<?php echo e($logo.'/'. $lpSettings['highlight_feature_image']); ?>"
                                                        class="big-logo img_setting">
                                                </div>
                                                <div class="choose-files mt-5">
                                                    <label for="highlight_feature_image">
                                                        <div class=" <?php echo e(ViewClassNamesConstants::BG_P); ?> dark_logo_update" style="cursor: pointer;"> <i class="ti ti-upload px-1">
                                                            ...
                                                            <span>
                                                                <div class="action-btn <?php echo e(ViewClassNamesConstants::BG_P); ?> ms-2">
                                                                    <a
                                                                        ...
                                                                        class="mx-3 btn btn-sm align-items-center <?php echo e($canEdit ? '' : 'disabled'); ?>"
...
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\Modules/LandingPage\Resources/views/landingpage/features/index.blade.php ENDPATH**/ ?>