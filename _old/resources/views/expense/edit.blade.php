                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col employee">
                                <div class="form-group" id="employee-box">
                                    ...
                                    {{ Form::select('employee_id', $employees,$expense->vendor_id, array('class' => 'form-control select','id'=>'employee','data-url'=>route('expense.employee'))) }}
                                </div>
                            ...
                            <div class="col customer d-none">
                                <div class="form-group" id="customer-box">
                                    ...
                                    {{ Form::select('customer_id', $customers,$expense->vendor_id, array('class' => 'form-control select','id'=>'customer','data-url'=>route('expense.customer'))) }}
                                </div>
                            ...
                            <div class="col vendor d-none">
                                <div class="form-group" id="vendor-box">
                                    {{ Form::label('vendor_id', __('Payee'),['class'=>'form-label']) }}
                                    {{ Form::select('vendor_id', $vendors,$expense->vendor_id, array('class' => 'form-control select','id'=>'vendor','data-url'=>route('expense.vendor'))) }}
                                </div>
