/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/projectDashboard.js
 * @generated from original JavaScript - manual review recommended
 * @module projectDashboard
 */
(() => {
    const listenerAttr = "data-project-dashboard-listener-active", el = document.getElementById("project-dashboard-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[projectDashboard] Error:`, error);
            }
        });
    }
