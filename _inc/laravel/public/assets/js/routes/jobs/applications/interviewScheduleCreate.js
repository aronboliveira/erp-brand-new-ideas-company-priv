...
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="interview-schedule-create-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[interviewScheduleCreate] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=interviewScheduleCreate.js.map