...
<?php $__env->startSection(YieldingConstants::ADM_BDC); ?>
    ...
    <li class="breadcrumb-item">
        <a href="<?php echo e($dashboardUrl); ?>" id="<?php echo e($dashboardLinkId); ?>" data-url="<?php echo e($dashboardUrl); ?>" data-guard-msg="<?php echo e($dashboardGuardMsg); ?>" <?php echo e($dashboardUrl === '#' ? 'aria-disabled=true' : ''); ?>>
    ...
    <?php $__env->startPush(StacksConstants::ADM_SCR_PG); ?>
        <script>
            (() => {
                try {
                    const el = document.getElementById('<?php echo e($dashboardLinkId); ?>');
                    if (!el) return;
...
<?php $__env->startSection(YieldingConstants::ADM_ACT_BTN); ?>
    ...
    <div class="<?php echo e(VC::FEND); ?>">
        <?php if($viewVal === 'grid'): ?>
            <a href="<?php echo e($projectsListUrl); ?>" id="<?php echo e($projectsListLinkId); ?>" data-url="<?php echo e($projectsListUrl); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('List View')); ?>" class="<?php echo e(VC::BT_SM_PM); ?>" data-guard-msg="<?php echo e($projectsListGuardMsg); ?>">
                <i class="<?php echo e(VC::TI_LT); ?>"></i>
            </a>
        <?php else: ?>
            <a href="<?php echo e($projectsIndexUrl); ?>" id="<?php echo e($projectsIndexLinkId); ?>" data-url="<?php echo e($projectsIndexUrl); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Grid View')); ?>" class="<?php echo e(VC::BT_SM_PM); ?>" data-guard-msg="<?php echo e($projectsIndexGuardMsg); ?>">
                <i class="ti ti-layout-grid"></i>
            </a>
        <?php endif; ?>
        <a href="#" class="<?php echo e(VC::BT_SM_PM); ?> action-item" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(PermissionsConstants::MNG_PRJ)): ?>
            <a href="<?php echo e($projectsCreateUrl); ?>" id="<?php echo e($projectsCreateLinkId); ?>" data-url="<?php echo e($projectsCreateUrl); ?>" data-size="lg" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Project')); ?>" data-title="<?php echo e(__('Create Project')); ?>" class="<?php echo e(VC::BT_SM_PM); ?>" data-guard-msg="<?php echo e($projectsCreateGuardMsg); ?>">
        ...
        <script>
            (() => {
                try {
                    ...
                    wireGuard('<?php echo e($projectsListLinkId); ?>', 'data-list-listener');
                    wireGuard('<?php echo e($projectsIndexLinkId); ?>', 'data-index-listener');
                    wireGuard('<?php echo e($projectsCreateLinkId); ?>', 'data-create-listener');
                } catch (error) {}
            })();
        </script>
    <?php $__env->stopPush(); ?>
  ...
  k =>
    ...
    <script defer>
        (()=>{
            ...
            try{
                const endpoint='<?php echo e(route('filter.project.view')); ?>';
                currentRequest=$.ajax({
                url:endpoint,
                data,
            ...
            $(()=>{
                ...
                try{
                    ...
                    const url='<?php echo e(route(VW::PRJ . ".invite.user.member")); ?>';
                    $.ajax({
                    url,
                    method:'POST',
                    dataType:'json',
                    data:{ project_id, user_id, _token:'<?php echo e(csrf_token()); ?>' },
                    success:(data)=>{
...
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aronboliveira/Desktop/programming/Prestech/erp/erpgo-fork/erp_prestech/_inc/laravel/resources/views/projects/index.blade.php ENDPATH**/ ?>