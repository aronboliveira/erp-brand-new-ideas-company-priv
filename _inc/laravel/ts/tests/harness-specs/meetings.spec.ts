/**
 * Auto-generated Playwright tests for meetings routes
...
test.describe('meetings.calendar', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/meetings-calendar.html');
...
test.describe('meetings.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/meetings-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('meetings.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/meetings-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('meetings.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/meetings-index.html');
    await page.waitForLoadState('networkidle');
