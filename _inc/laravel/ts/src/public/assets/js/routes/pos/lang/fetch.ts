/**
 * @fileoverview TypeScript version of public/assets/js/routes/pos/lang/fetch.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      pos_fetch_unavailable:
        "Produkte konnten nicht aus dem Lager abgerufen werden",
    ...
    fr: {
      pos_fetch_unavailable:
        "Impossible de récupérer les produits de l’entrepôt",
    ...
    nl: {
      pos_fetch_unavailable:
        "Producten konden niet uit het magazijn worden opgehaald",
