...
<div class="modal-body">
    <div class="table-responsive">
        {{ Collective\Html\FormFacade::open(['route' => ['projects.copy.link', $projectID], 'method' => 'POST']) }}
...
{{--                {{ Collective\Html\FormFacade::button(__('Save'), ['type' => 'submit', 'class' => 'btn btn-primary']) }}--}}
{{--            </div>--}}
