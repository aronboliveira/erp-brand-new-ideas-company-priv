/**
 * @fileoverview TypeScript version of public/assets/js/routes/budgets/lang/editToggle.js
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      income_calculation_failed:
        "Fehler bei der Berechnung des Gesamteinkommens.",
      expense_calculation_failed:
        "Fehler bei der Berechnung der Gesamtaufwendungen.",
    ...
    pl: {
      income_calculation_failed:
        "Nie udało się obliczyć całkowitego przychodu.",
