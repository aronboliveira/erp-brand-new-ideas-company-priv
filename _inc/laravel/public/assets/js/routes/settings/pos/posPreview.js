...
(() => {
    try {
        ...
        const msg = ifr.getAttribute("data-guard-msg") ??
            "POS preview route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') && window.bootstrap);
...
//# sourceMappingURL=posPreview.js.map