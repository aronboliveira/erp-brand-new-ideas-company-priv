        ...
        l.addEventListener("click", (e) => {
            try {
                ...
                const msg = l.getAttribute("data-guard-msg") ??
                    "List taskboard route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = document.querySelector('link[href*="bootstrap"]') &&
                    window.bootstrap;
