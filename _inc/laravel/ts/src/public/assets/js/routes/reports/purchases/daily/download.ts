...
((): void => {
  try {
    ...
    const flag = "data-download-daily-purchase-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for daily purchases is unavailable. Please contact technical support or your domain administrator.";
