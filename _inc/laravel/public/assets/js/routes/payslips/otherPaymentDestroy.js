...
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="other-payment-delete-form-"][data-url][data-guard-msg]')) ?? [];
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[otherPaymentDestroy] Error:`, err);
                    }
                });
            }
            catch (err) {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="other-payment-delete-link-"][data-url][data-guard-msg]')) ?? [];
        links.forEach(l => {
            try {
...
//# sourceMappingURL=otherPaymentDestroy.js.map