...
use App\Http\Controllers\Companies\CompanyPolicyController;
use Illuminate\Http\{RedirectResponse, JsonResponse, Request, Response};
use Illuminate\View\View;

/**
 * Comprehensive tests for CompanyPolicyController
 * Includes I/O variations, edge cases, and performance tests
 * 
 * @covers \App\Http\Controllers\Companies\CompanyPolicyController
 */
class CompanyPolicyControllerTest extends TestCase
{
    ...
    {
        $this->assertSame('index', CompanyPolicyController::IDX);
    }

    public function test_constant_CRT_equals_create_2(): void
    {
        $this->assertSame('create', CompanyPolicyController::CRT);
    }

    public function test_constant_STR_equals_store_3(): void
    {
        $this->assertSame('store', CompanyPolicyController::STR);
    }

    public function test_constant_SHW_equals_show_4(): void
    {
        $this->assertSame('show', CompanyPolicyController::SHW);
    }

    public function test_constant_EDT_equals_edit_5(): void
    {
        $this->assertSame('edit', CompanyPolicyController::EDT);
    }

    public function test_constant_UPD_equals_update_6(): void
    {
        $this->assertSame('update', CompanyPolicyController::UPD);
    }

    public function test_constant_DEL_equals_destroy_7(): void
    {
        $this->assertSame('destroy', CompanyPolicyController::DEL);
    }

    public function test_index_8(): void
    {
        $this->loginMockUser();
        $ctrl = new CompanyPolicyController();
        try {
