/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/applications/lang/index.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    es: {
      ...
      application_order_unavailable:
        "Fallo al actualizar el orden de la solicitud",
