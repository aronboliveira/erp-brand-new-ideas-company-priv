                ...
                <div class="card">
                    ...
                    <div class="card-body dash-card-body">
                        <div class="page-title">
                            <div class="row justify-content-between align-items-center full-calendar">
                        ...
                        <center>
                            <div class="row">
                                <div class="col-md-6 float-right border-right">
                                    {{Collective\Html\FormFacade::open(array('url'=>'smployeeAttendance/attendance','method'=>'post'))}}
                                ...
                                <div class="col-md-6 float-left">
                                    @if(!empty($employeeAttendance) && $employeeAttendance->clock_out == '00:00:00')
                                        {{Collective\Html\FormFacade::model($employeeAttendance,array('route'=>array('employeeAttendance.update',$employeeAttendance->id),'method' => 'PUT')) }}
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                <div class="card card-box">
                    <div class="left-card">
                        <div class="icon-box"><i class="{{ ViewClassNamesConstants::TI_USRS }}"></i></div>
