/**
 * @file Reports Leave Download Route Guard
 * @description Guards leave report download links with function check using ERPGuard singleton
 */
(() => {
  try {
    ...
    guard.bindClickGuard("a.download-leave-reports", {
      fallbackMsg:
