                    ...
                    @foreach ($images as $image)
                        <div class="swiper-slide" id="slide-{{$image->id}}">
                            ...
                            <div class="time_in_slider">{{date('H:i:s, d M ',strtotime($image->time))}} |
                                ...
                                <a href="#" class="mx-3 {{ ViewClassNamesConstants::BT_SM }} align-items-center {{ ViewClassNamesConstants::ACT_BTN_DNG_2 }} bs-pass-para"  data-confirm-delete="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="removeImage({{$image->id}})">
