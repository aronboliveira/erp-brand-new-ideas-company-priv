/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/hrmDashboard.js
 * @generated from original JavaScript - manual review recommended
 * @module hrmDashboard
 */
(() => {
    const listenerAttr = "data-hrm-dashboard-listener-active", el = document.getElementById("hrm-dashboard-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[hrmDashboard] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=hrmDashboard.js.map