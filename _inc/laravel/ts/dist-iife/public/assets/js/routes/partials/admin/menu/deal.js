...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/deal.js
 * @generated from original JavaScript - manual review recommended
 * @module deal
 */
(() => {
    const listenerAttr = "data-dl-index-listener-active", el = document.getElementById("dl-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("dl-index-link"))
            observer.disconnect();
    });
