    {{Collective\Html\FormFacade::model($plan, array('route' => array('plans.update', $plan->id), 'method' => 'PUT', 'enctype' => "multipart/form-data")) }}
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{Collective\Html\FormFacade::text('name',null,array('class'=>'form-control font-style','placeholder'=>__('Enter Plan Name'),'required'=>'required'))}}
        </div>
        @if($plan->price >0)
            <div class="form-group col-md-6">
                {{Collective\Html\FormFacade::label('price',__('Price'),['class'=>'form-label'])}}
                {{Collective\Html\FormFacade::number('price',null,array('class'=>'form-control','placeholder'=>__('Enter Plan Price'),'required'=>'required'))}}
            </div>
        @endif
        <div class="form-group col-md-6">
            {{ Collective\Html\FormFacade::label('duration', __('Duration'),['class'=>'form-label']) }}
            {!! Collective\Html\FormFacade::select('duration', $arrDuration, null,array('class' => 'form-control select','required'=>'required')) !!}
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('max_users',__('Maximum Users'),['class'=>'form-label'])}}
            {{Collective\Html\FormFacade::number('max_users',null,array('class'=>'form-control','required'=>'required'))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('max_customers',__('Maximum Customers'),['class'=>'form-label'])}}
            {{Collective\Html\FormFacade::number('max_customers',null,array('class'=>'form-control','required'=>'required'))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('max_vendors',__('Maximum Vendors'),['class'=>'form-label'])}}
            {{Collective\Html\FormFacade::number('max_vendors',null,array('class'=>'form-control','required'=>'required'))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('max_clients',__('Maximum Clients'),['class'=>'form-label'])}}
            {{Collective\Html\FormFacade::number('max_clients',null,array('class'=>'form-control','required'=>'required'))}}
            <span class="small">{{__('Note: "-1" for Unlimited')}}</span>
        </div>
        <div class="form-group col-md-6">
            {{ Collective\Html\FormFacade::label('storage_limit', __('Storage limit'), ['class' => 'form-label']) }}
            <div class="input-group">
                {{ Collective\Html\FormFacade::number('storage_limit', null,array('class'=>'form-control','required'=>'required')) }}
