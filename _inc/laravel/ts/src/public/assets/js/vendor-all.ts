...
/* eslint-disable @typescript-eslint/explicit-function-return-type, @typescript-eslint/no-floating-promises, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unused-vars, @typescript-eslint/prefer-optional-chain, no-cond-assign, no-prototype-builtins, no-var, prefer-const, prefer-rest-params */
/* global $, jQuery */
/*==============================
		popover js
============================== */
 ...
 */ (function (a, b) {
  ...
  function s(a, c) {
    ...
    const f = { top: e, height: c.railYHeight };
  ...
  function t(a, b) {
    function c(b) {
      (b.touches?.[0] && (b[k] = b.touches[0].pageY),
        (s[o] = t + v * (b[k] - u)),
        g(a, p),
        q(a),
        b.stopPropagation(),
  ...
  ((B.prototype.bind = function (a, b) {
    ...
    (B.prototype.unbindAll = function () {
      for (const a in this.handlers) this.unbind(a);
    }),
  ...
  ((D.prototype.eventElement = function (a) {
    let b = this.eventElements.filter(function (b) {
      return b.element === a;
    })[0];
    ...
    G = {
      ...
      keyboard: function (a) {
        ...
        a.event.bind(a.ownerDocument, "keydown", function (d) {
          if (
            !(d.isDefaultPrevented?.() || d.defaultPrevented) &&
            (f() || g())
          ) {
      ...
      wheel: function (b) {
        ...
        function f(b, c, d) {
          ...
          for (let e = b; e && e !== h; ) {
            ...
            const f = a(e); // if deltaY && vertical scrollable
            if (d && f.overflowY.match(/(scroll|auto)/)) {
              const g = e.scrollHeight - e.clientHeight;
              if (
                0 < g &&
