...
@php
    try {
        ...
        \Log::error('employees/templates/joining_letter_pdf — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@push(StacksConstants::CTC_SCR_PG)
    ...
    <script async src="{{ asset('assets/js/routes/employees/templates/joining/lang/pdf.js') }}"></script>
    <script defer>
        (function () {
        const errFb = "# ERROR";
