/**
 * Auto-generated Playwright tests for labels routes
...
test.describe('labels.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/labels-create.html');
...
test.describe('labels.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/labels-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('labels.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/labels-index.html');
    await page.waitForLoadState('networkidle');
