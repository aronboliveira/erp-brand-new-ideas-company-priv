# \_inc/laravel/utils/.llms/ — LLM Session Context & Working Notes
...
for coding conventions see `_inc/laravel/utils/prompts/.guidelines/`, for architecture/domain
guidelines see `_inc/laravel/.notes/.llms/.guidelines/`.
...
| What                               | Where                                                                   |
| ---------------------------------- | ----------------------------------------------------------------------- |
| This tooling context               | `_inc/laravel/utils/.llms/` (here)                                              |
...
| App-specific guidelines            | `_inc/laravel/.notes/.llms/`                                             |
