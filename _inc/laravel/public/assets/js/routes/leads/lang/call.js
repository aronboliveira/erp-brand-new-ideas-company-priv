(() => {
    const t = {
        ...
        es: {
            ...
            ai_generate_unavailable: "La generación de contenido con IA no está disponible.",
        },
        fr: {
            ld_call_route_unavailable: "Action indisponible.",
            ai_generate_unavailable: "La génération de contenu par IA est indisponible.",
        },
        he: {
        ...
        it: {
            ...
            ai_generate_unavailable: "La generazione di contenuti IA non è disponibile.",
        },
        ja: {
