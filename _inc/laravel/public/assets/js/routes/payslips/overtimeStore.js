/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/overtimeStore.js
 * @generated from original JavaScript - manual review recommended
 * @module overtimeStore
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="overtime-store-form-"][data-url][data-guard-msg]')) ?? [];
        if (forms.length === 0)
            return;
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[overtimeStore] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=overtimeStore.js.map