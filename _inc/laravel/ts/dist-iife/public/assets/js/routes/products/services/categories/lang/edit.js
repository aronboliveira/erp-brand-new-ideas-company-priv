(() => {
    ...
    const t = {
        ar: {
            account_toggle_unavailable: "تعذر تبديل عرض الحساب",
            get_account_unavailable: "تعذر جلب قائمة الحسابات",
        },
        da: {
            account_toggle_unavailable: "Kunne ikke skifte konto-visibility",
            get_account_unavailable: "Kan ikke hente kontoliste",
        },
        de: {
            account_toggle_unavailable: "Kontosichtbarkeit konnte nicht umgeschaltet werden",
            get_account_unavailable: "Kontenliste konnte nicht geladen werden",
        },
        en: {
        ...
        es: {
            account_toggle_unavailable: "No se puede alternar la visibilidad de cuenta",
            get_account_unavailable: "No se puede obtener la lista de cuentas",
        },
        fr: {
            account_toggle_unavailable: "Impossible d’afficher/masquer la section compte",
        ...
        nl: {
            account_toggle_unavailable: "Kan zichtbaarheid van account niet wisselen",
        ...
        pt: {
            account_toggle_unavailable: "Não foi possível alternar a visibilidade da conta",
        ...
        ru: {
            account_toggle_unavailable: "Не удалось переключить видимость счета",
