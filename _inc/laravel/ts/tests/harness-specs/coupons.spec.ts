/**
 * Auto-generated Playwright tests for coupons routes
...
test.describe('coupons.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/coupons-create.html');
...
test.describe('coupons.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/coupons-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('coupons.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/coupons-index.html');
    await page.waitForLoadState('networkidle');
