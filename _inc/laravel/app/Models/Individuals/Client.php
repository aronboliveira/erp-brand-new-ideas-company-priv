...
class Client extends Model
{
	...
	private function ensureDefaults(): void
	{
	    try {
    		...
    		$del = $this->getAttribute(UC::COL_D_ST);
    		if (!is_numeric($del)) $this->setAttribute(UC::COL_D_ST, 1);
    		...
    		$msg = trim((string) ($this->getAttribute(UC::COL_MC) ?? ''));
    		if ($msg === '') $this->setAttribute(UC::COL_MC, '#2180f3');
	    } catch (\Throwable $e) {
	...
	private function normalizeCoreFields(): void
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeCoreFields — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
		...
		private function enforceClientUserType(): void
	{
    		...
    		try {
		        ...
		        Log::error(static::class . '::enforceClientUserType — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
		    }
	}
}
