...
@if(!empty($invoice) && isset($invoice->id))
    @php
        $fields = [
            ...
            ['name'=>'account_id','type'=>'select','label'=>__('Account'),'options'=> (is_array($accounts) && count($accounts)) || ($accounts instanceof \Illuminate\Support\Collection && $accounts->isNotEmpty()) ? $accounts : [__('No account available')],'cols'=>6,'attrs'=>['class'=>'form-control select','required'=>'required']],
