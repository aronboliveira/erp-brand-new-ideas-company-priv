/**
 * Auto-generated Playwright tests for pipelines routes
...
test.describe('pipelines.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/pipelines-create.html');
...
test.describe('pipelines.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/pipelines-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('pipelines.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/pipelines-index.html');
    await page.waitForLoadState('networkidle');
