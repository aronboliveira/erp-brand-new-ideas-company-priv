        ...
        try {
          const a =
            ...
            ((e.target as Element).closest
              ? (e.target as Element).closest("a.download-tax-reports")
              : null);
          if (!a) return;
          ...
          const msg =
            ...
            "Download function for Tax Reports is unavailable. Please contact technical support or your domain administrator.";
