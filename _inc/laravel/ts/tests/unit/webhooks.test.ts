/**
 * Jest unit tests for webhooks routes
...
describe('webhooks.create', () => {
  // TypeScript sources: src/public/assets/js/routes/webhooks/store
  // Import would be: import * as module0 from 'src/public/assets/js/routes/webhooks/store';
...
describe('webhooks.edit', () => {
  // TypeScript sources: src/public/assets/js/routes/webhooks/update
  // Import would be: import * as module0 from 'src/public/assets/js/routes/webhooks/update';
