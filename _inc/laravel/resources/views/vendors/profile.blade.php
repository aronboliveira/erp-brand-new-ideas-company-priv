            ...
            <section class="col-lg-12 pricing-plan card">
                <div class="our-system password-card p-3">
                    <div class="row">
                                        ...
                                        {!! Form::model($userDetail, [
                                            ...
                                            <div class="row">
                                                @foreach((array) $tab['fields'] as $f)
                                                    ...
                                                    @endphp
                                                    <div class="form-group col-md-{{ $fcols }}">
                                                        ...
                                                        @elseif($fileW === true)
                                                            <div class="choose-file">
                                                                <label for="{{ $fid }}">
                                                                    <div>{{ $flabel }}</div>
                                                                    <input type="file" name="{{ $fname }}" id="{{ $fid }}" class="form-control" data-filename="{{ $fdfn }}">
                                                                </label>
                                                                <p class="{{ $fdfn }}"></p>
                                                            </div>
                                                        @else
                        ...
                        @else
                            <div class="col-12">
                                <p class="text-center text-muted">{{ __('No profile sections available') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
