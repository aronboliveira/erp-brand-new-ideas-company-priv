...
const DEFAULT_ROOT = path.resolve(__dirname, "..", "..", "..", "..", "..", "..", "resources");
...
const PATTERNS = [
  {
    ...
    regex: /\.innerHTML\s*=(?!=)/g,
    severity: "HIGH",
    ext: [".js", ".cjs", ".mjs", ".ts", ".vue", ".blade.php"],
  },
  {
    label: "eval() call",
    regex: /\beval\s*\(/g,
    severity: "CRITICAL",
    ext: [".js", ".cjs", ".mjs", ".ts", ".vue"],
  },
  {
...
module.exports = { scanDir, PATTERNS };
