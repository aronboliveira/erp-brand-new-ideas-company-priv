/**
 * Jest unit tests for payslip_types routes
...
describe('payslip_types.create', () => {
  // TypeScript sources: src/public/assets/js/routes/payslips/types/store
  // Import would be: import * as module0 from 'src/public/assets/js/routes/payslips/types/store';
