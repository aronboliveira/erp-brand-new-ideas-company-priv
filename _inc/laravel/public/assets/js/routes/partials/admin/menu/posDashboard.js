/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/posDashboard.js
 * @generated from original JavaScript - manual review recommended
 * @module posDashboard
 */
(() => {
    const listenerAttr = "data-pos-dashboard-listener-active", el = document.getElementById("pos-dashboard-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[posDashboard] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=posDashboard.js.map