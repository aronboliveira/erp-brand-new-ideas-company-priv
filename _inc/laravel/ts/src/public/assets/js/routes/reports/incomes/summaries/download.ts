...
((): void => {
  try {
    ...
    const flag = "data-download-income-summary-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for income summary report is unavailable. Please contact technical support or your domain administrator.";
