/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsPayroll.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsPayroll
 */
(() => {
    const listenerAttr = "data-payroll-listener-active", el = document.getElementById("reports-payroll-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsPayroll] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsPayroll.js.map