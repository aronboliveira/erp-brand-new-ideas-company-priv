/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/applications/resumeDownload.js
 * @generated from original JavaScript - manual review recommended
 * @module resumeDownload
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="resume-download-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
...
//# sourceMappingURL=resumeDownload.js.map