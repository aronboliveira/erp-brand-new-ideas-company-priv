/**
 * Auto-generated Playwright tests for leaves routes
...
test.describe('leaves.action', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leaves-action.html');
...
test.describe('leaves.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leaves-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('leaves.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leaves-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('leaves.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leaves-index.html');
    await page.waitForLoadState('networkidle');
