                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php echo e(Collective\Html\FormFacade::label('Offer Text', __('Offer Text'), ['class' => 'form-label'])); ?>

                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_OFF_TXT_K, $lpSettings[LandingPageSettingsConstants::HM_OFF_TXT_K], ['class' => 'form-control', 'placeholder' => __('70% Special Offer')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_TTL_K, $lpSettings[LandingPageSettingsConstants::HM_TTL_K], ['class' => 'form-control', 'placeholder' => __('Enter Title')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_HDG_K, $lpSettings[LandingPageSettingsConstants::HM_HDG_K], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php echo e(Collective\Html\FormFacade::label('Trusted by', __('Trusted by'), ['class' => 'form-label'])); ?>

                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_TRST_BY_K, $lpSettings[LandingPageSettingsConstants::HM_TRST_BY_K], ['class' => 'form-control', 'placeholder' => __('1,000+ customers')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_DESC_K, $lpSettings[LandingPageSettingsConstants::HM_DESC_K], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_DEMO_LNK_K, $lpSettings[LandingPageSettingsConstants::HM_DEMO_LNK_K], ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::HM_BUY_LNK_K, $lpSettings[LandingPageSettingsConstants::HM_BUY_LNK_K], ['class' => 'form-control', 'placeholder' => __('Enter Link')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <?php echo e(Collective\Html\FormFacade::label('Banner', __('Banner'), ['class' => 'form-label',
                                            'id' => 'banner_image'])); ?>

                                            <div class="logo-content mt-4">
                                                <img id="banner_image" src="<?php echo e(asset('uploads/landing_page_image/'.$lpSettings[LandingPageSettingsConstants::HM_BNR_K])); ?>"
                                                    class="big-logo">
                                            </div>
                                            ...
                                            <?php $__errorArgs = [LandingPageSettingsConstants::HM_BNR_K];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <?php echo e(Collective\Html\FormFacade::label('Logo', __('Logo'), ['class' => 'form-label'])); ?>

                                            <div class="text-end">
                                                <button class="<?php echo e(ViewClassNamesConstants::BT_SM_PM); ?> btn-icon m-1" data-repeater-create
                                                    type="button"><i class="<?php echo e(ViewClassNamesConstants::TI_PLS); ?>"></i></button>
                                            </div>
                                            <div data-repeater-list="home_logo">
                                                <div data-repeater-item class="text-end">
                                                    <div class="<?php echo e(ViewClassNamesConstants::CD_NSD); ?>product_Image">
                                                        <div class="px-2 py-2">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-auto">
                                                                    <p class="card-text small text-muted">
                                                                        ...
                                                                        <img src="<?php echo e(asset('uploads/landing_page_image/home_logo.png')); ?>" width="70px"
                                                                            alt="Image placeholder" data-dz-thumbnail="">
                                                                    </p>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a data-repeater-delete href="javascript:void(0)"
                                                                        class="action-item <?php echo e(ViewClassNamesConstants::BT_SM); ?> btn-icon btn-light-secondary repeater-action-btn ms-2">
                                                                        <i class="<?php echo e(ViewClassNamesConstants::BT_SM_PM); ?>"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <?php if($lpSettings[LandingPageSettingsConstants::HM_LGO_K] != ''): ?>
                                            <div id="imageContainer">
                                                <?php $__currentLoopData = explode(',', $lpSettings[LandingPageSettingsConstants::HM_LGO_K]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $home_logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="<?php echo e(ViewClassNamesConstants::CD_NSD); ?>product_Image">
                                                        <div class="px-2 py-2">
                                                            <div class="row align-items-center">
                                                                <div class="col ml-n2">
                                                                    <p class="card-text small text-muted">
                                                                        <img src="<?php echo e(asset('uploads/landing_page_image/home_logo.png')); ?>"
                                                                            width="70px" alt="Image placeholder"
                                                                            data-dz-thumbnail="">
                                                                    </p>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a class="action-item <?php echo e(ViewClassNamesConstants::BT_SM); ?> btn-icon btn-light-secondary"
                                                                        href="<?php echo e($logo . '/' . $home_logo); ?>" download=""
                                                                        data-toggle="tooltip" data-original-title="Download">
                                                                        <i class="<?php echo e(ViewClassNamesConstants::TI_DWN); ?>"></i>
                                                                    </a>
                                                                </div>
                                                                <div class="col-auto actions">
                                                                    <a class="action-item <?php echo e(ViewClassNamesConstants::BT_SM); ?> btn-icon btn-light-secondary delete-button"
                                        ...
                                        <input type="hidden" class="form-control" id="imageNames" name="savedlogo"
                                            value="<?php echo e($lpSettings[LandingPageSettingsConstants::HM_LGO_K]); ?>">
                                    </div>
                                </div>
                            </div>
...
Object.keys(t).forEach(
  k =>
    ...
    <script async src="<?php echo e(asset('assets/js/jquery.repeater.min.js')); ?>"></script>
    <script async>
        (() => {
          const errFb = "# ERROR";
          const dataClientLocalized = "data-client-localized";
          ...
          window.updateImagePreview = (input) => {
            try {
              ...
              img.src = input.files?.[0]
                ...
                : "<?php echo e($logo . '/placeholder.png'); ?>";
            } catch {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aronboliveira/Desktop/programming/Prestech/erp/erpgo-fork/erp_prestech/_inc/laravel/Modules/LandingPage/Resources/views/landingpage/home_section.blade.php ENDPATH**/ ?>