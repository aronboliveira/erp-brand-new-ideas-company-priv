...
@section(YieldingConstants::ADM_CTT)
    {{ Form::open(array('url' => ViewsConstants::JRN_ET,'class'=>'w-100')) }}
            ...
            <div class="row">
                <div class="{{ VC::CLM4 }}">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$user?->journalNumberFormat($journalId)}}" readonly>
                    </div>
                </div>
                <div class="{{ VC::CLM4 }}">
                    <div class="form-group">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td></td>
                                <td class="text-end"><strong>{{__('Total Credit')}} ({{$user?->currencySymbol() ?? __('Failed to get currency')}})</strong></td>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td class="text-end"><strong>{{__('Total Debit')}} ({{$user?->currencySymbol() ?? __('Failed to get currency')}})</strong></td>
