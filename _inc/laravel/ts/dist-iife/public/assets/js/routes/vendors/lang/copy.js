(function () {
    ...
    const t = {
        ...
        da: {
            copy_billing_unavailable: "Kunne ikke kopiere faktureringsdata til levering.",
            plugin_unavailable: "Et påkrævet bibliotek blev ikke indlæst.",
        },
        de: {
            copy_billing_unavailable: "Rechnungsdaten konnten nicht in Versand übernommen werden.",
        ...
        es: {
            copy_billing_unavailable: "No se pudieron copiar los datos de facturación al envío.",
            plugin_unavailable: "No se cargó una biblioteca requerida.",
        },
        fr: {
            copy_billing_unavailable: "Impossible de copier la facturation vers la livraison.",
        ...
        it: {
            copy_billing_unavailable: "Impossibile copiare i dati di fatturazione nella spedizione.",
        ...
        nl: {
            copy_billing_unavailable: "Kon factuurgegevens niet naar verzending kopiëren.",
            plugin_unavailable: "Een vereiste bibliotheek is niet geladen.",
        },
        pl: {
            copy_billing_unavailable: "Nie można skopiować danych rozliczeniowych do wysyłki.",
            plugin_unavailable: "Wymagana biblioteka nie została wczytana.",
        },
        pt: {
            copy_billing_unavailable: "Não foi possível copiar o faturamento para o envio.",
        ...
        ru: {
            copy_billing_unavailable: "Не удалось скопировать данные оплаты в доставку.",
