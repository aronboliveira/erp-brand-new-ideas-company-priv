 ...
 */
(() => {
    const ERR_KEY = "image_preview_failed", ATTACH_SELECTOR = "#attachment", IMAGE_SELECTOR = "#image", attachEl = document.querySelector(ATTACH_SELECTOR), imageEl = document.querySelector(IMAGE_SELECTOR);
    if (!attachEl || !imageEl)
        return;
    const showError = (msg) => {
