/**
 * Jest unit tests for competencies routes
...
describe('competencies.index', () => {
  // TypeScript sources: src/public/assets/js/routes/competencies/index
  // Import would be: import * as module0 from 'src/public/assets/js/routes/competencies/index';
