/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/trainer.js
 * @generated from original JavaScript - manual review recommended
 * @module trainer
 */
(() => {
    const listenerAttr = "data-trainer-index-listener-active", el = document.getElementById("trainer-index-link");
