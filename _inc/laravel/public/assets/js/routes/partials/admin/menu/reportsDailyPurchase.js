/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsDailyPurchase.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsDailyPurchase
 */
(() => {
    const listenerAttr = "data-daily-purchase-listener-active", el = document.getElementById("daily-purchase-report-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsDailyPurchase] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsDailyPurchase.js.map