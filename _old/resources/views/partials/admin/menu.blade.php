...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
            ...
            <ul class="dash-navbar">
                ...
                @if (!empty($userPlan) && $userPlan->hrm == 1)
                    @if (Gate::check('manage employee') || Gate::check('manage setsalary'))
                        <li
                            class="dash-item dash-hasmenu {{ Request::segment(1) == 'holiday-calendar' ||
                            Request::segment(1) == 'leavetype' ||
                            Request::segment(1) == 'leave' ||
                            Request::segment(1) == 'EmployeeAttendance' ||
                            ...
                            Request::segment(1) == 'leave_calendar' ||
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                    <li
                                        class="dash-item dash-hasmenu  {{ Request::segment(1) == 'leave' || Request::segment(1) == 'EmployeeAttendance' ? 'active dash-trigger' : '' }}">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @can('manage attendance')
                                                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'EmployeeAttendance' ? 'active dash-trigger' : '' }}"
                                                    href="#navbar-attendance" data-toggle="collapse" role="button"
                                                    aria-expanded="{{ Request::segment(1) == 'EmployeeAttendance' ? 'true' : 'false' }}">
                                                    <a class="dash-link" href="#">{{ __('Attendance') }}<span
                                                            class="dash-arrow"><i
                                                                data-feather="chevron-right"></i></span></a>
                                                    <ul class="dash-submenu">
                                                        <li
                                                            class="dash-item {{ Request::route()->getName() == 'EmployeeAttendance.index' ? 'active' : '' }}">
                                                            <a class="dash-link"
                                                                href="{{ route('EmployeeAttendance.index') }}">{{ __('Mark Attendance') }}</a>
                                                        </li>
                                                        @can('create attendance')
                                                            <li
                                                                class="dash-item {{ Request::route()->getName() == 'EmployeeAttendance.bulkattendance' ? 'active' : '' }}">
                                                                <a class="dash-link"
                                                                    href="{{ route('EmployeeAttendance.bulkattendance') }}">{{ __('Bulk Attendance') }}</a>
                                                            </li>
                                                        @endcan
                                                    </ul>
                                                </li>
                                ...
                                @if (Gate::check('manage award') ||
                                    ...
                                    <li
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @can('manage holiday')
                                                <li
                                                    class="dash-item {{ request()->is('holiday*') || request()->is('holiday-calendar') ? 'active' : '' }}">
                                                    <a class="dash-link"
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Gate::check('manage vendor') ||
                                    ...
                                    Gate::check('manage debit note'))
                                <li
                                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'bill' || Request::segment(1) == 'vendor' || Request::segment(1) == 'expense' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note' ? 'active dash-trigger' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Purchases') }}<span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        @if (Gate::check('manage vendor'))
                                            <li
                                                class="dash-item {{ Request::segment(1) == 'vendor' ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('vendor.index') }}">{{ __('Suppiler') }}</a>
                                            </li>
                                        @endif
                                        <li
        ...
        @if (\Auth::user()->type != 'super admin')
            ...
            <li
                class="dash-item dash-hasmenu {{ Request::segment(1) == 'zoom-meeting' || Request::segment(1) == 'zoom-meeting-calendar' ? 'active' : '' }}">
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'calendar' ? ' active' : '' }}">
                        <a href="{{ route('task.calendar', ['all']) }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-calendar"></i></span><span
                                class="dash-mtext">{{ __('Task calendar') }}</span>
                        </a>
                    </li>
                @endif
