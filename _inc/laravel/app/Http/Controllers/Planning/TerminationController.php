...
class TerminationController extends Controller
{
    ...
    public function index(Request $request): View|RedirectResponse|null
    {
        ...
        try {
            ...
            return view(ViewsConstants::TMN . '.' . __FUNCTION__, compact('terminations'));
        } catch (\Throwable $e) {
    ...
    public function create(Request $request): View|RedirectResponse|null
    {
        ...
        return view(
            ViewsConstants::TMN . '.' . __FUNCTION__,
            compact('employees', 'terminationTypes')
        );
    }
    ...
    public function show(Request $request, Termination $termination): View|RedirectResponse|null
    {
        ...
        return view(ViewsConstants::TMN . '.' . __FUNCTION__, compact('termination'));
    }
        ...
        try {
            ...
            if (!empty($settings['termination_sent'])) {
                ...
                $terminationArr = [
                    ...
                    'termination_type'  => TerminationType::find(
    ...
    public function edit(Request $request, Termination $termination): View|RedirectResponse|null
    {
        ...
        return view(
            ViewsConstants::TMN . '.edit',
            compact('termination', 'employees', 'terminationTypes')
        );
    }
    ...
    public function description(Request $request, int $id): View|RedirectResponse|null
    {
        ...
        return view(ViewsConstants::TMN . '.description', compact('termination'));
    }
}
