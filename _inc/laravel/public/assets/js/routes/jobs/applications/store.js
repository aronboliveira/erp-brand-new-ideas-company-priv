/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/applications/store.js
...
(() => {
    try {
        const fm = document.getElementById("job-app-store-form");
        if (!fm)
            return;
            ...
            fm.addEventListener("submit", (e) => {
                try {
                    ...
                    const msg = fm.getAttribute("data-guard-msg") ??
                        "Job application route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
