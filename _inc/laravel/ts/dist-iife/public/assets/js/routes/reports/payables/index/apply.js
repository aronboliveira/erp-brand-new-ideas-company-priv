...
(() => {
    try {
        const host = document.documentElement, flag = "data-apply-payables-listener";
        ...
        document.addEventListener("click", function (e) {
            try {
                const a = e.target &&
                    (e.target.closest
                        ? e.target.closest("a.apply-payables")
                        : null);
                if (!a)
                    return;
                e.preventDefault();
                ...
                const msg = f.getAttribute("data-guard-msg") ??
                    "Payables apply route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
