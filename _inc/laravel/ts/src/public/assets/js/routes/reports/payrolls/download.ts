        ...
        try {
          const a =
            ...
            ((e.target as Element).closest
              ? (e.target as Element).closest("a.download-payroll")
              : null);
          if (!a) return;
          ...
          const msg =
            ...
            "Download function for payroll report is unavailable. Please contact technical support or your domain administrator.";
