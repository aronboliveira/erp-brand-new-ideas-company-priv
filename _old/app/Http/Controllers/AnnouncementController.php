...
class AnnouncementController extends Controller
{
    public function index()
    {
        if(\Auth::user()->can('manage announcement'))
        {
            ...
            if(Auth::user()->type == 'Employee')
            {
                ...
                $announcements    = Announcement::orderBy('announcements.id', 'desc')->leftjoin('employee_announcements', 'announcements.id', '=', 'employee_announcements.announcement_id')->where('employee_announcements.employee_id', '=', $current_employee->id)->orWhere(
                    function ($q){
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create announcement'))
        {
            ...
            {
                $employeeannouncement                  = new employeeannouncement();
                $employeeannouncement->announcement_id = $announcement->id;
                $employeeannouncement->employee_id     = $employee;
                $employeeannouncement->created_by      = \Auth::user()->creatorId();
