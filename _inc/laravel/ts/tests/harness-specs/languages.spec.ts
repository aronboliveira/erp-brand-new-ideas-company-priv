/**
 * Auto-generated Playwright tests for languages routes
...
test.describe('languages.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/languages-create.html');
...
test.describe('languages.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/languages-index.html');
    await page.waitForLoadState('networkidle');
