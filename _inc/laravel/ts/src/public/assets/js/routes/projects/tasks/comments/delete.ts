    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.delete-comment") : null);
          if (!a) return;
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Destroy project task comment route is unavailable. Please contact technical support or your domain administrator.";
