...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/salesReport.js
 * @generated from original JavaScript - manual review recommended
 * @module salesReport
 */
(() => {
    const listenerAttr = "data-sales-listener-active", el = document.getElementById("sales-report-link");
