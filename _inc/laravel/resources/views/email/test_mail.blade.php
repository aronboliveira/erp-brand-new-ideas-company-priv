                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" class="w-100">
                            ...
                            <td class="text-start">
                                ...
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="mb-2 fw-bold">{{ __('Subject : ') . 'Testing purpose mail send' }}</p>
                                        <p class="mb-3 fw-bold">{{ __('Hi Dear,') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="mb-3">{{ __('This mail send only for testing purpose.') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="my-2">{{ __('Feel free to reach out if you have any questions.') }}</p>
                                        <p class="my-2">{{ __('Thank you for your business!') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
