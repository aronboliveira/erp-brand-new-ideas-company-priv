{{Collective\Html\FormFacade::model($commission,array('route' => array('commissions.update', $commission->id), 'method' => 'PUT')) }}
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {{ Collective\Html\FormFacade::select('type', $commissions, null, ['class' => 'form-control select amount_type', 'required' => 'required']) }}
                </div>
            </div>
