/**
 * Auto-generated Playwright tests for jobs routes
...
test.describe('jobs.apply', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/jobs-apply.html');
...
test.describe('jobs.career', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/jobs-career.html');
    await page.waitForLoadState('networkidle');
...
test.describe('jobs.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/jobs-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('jobs.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/jobs-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('jobs.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/jobs-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('jobs.requirement', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/jobs-requirement.html');
    await page.waitForLoadState('networkidle');
...
test.describe('jobs.show', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/jobs-show.html');
    await page.waitForLoadState('networkidle');
