/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/applications/resumePreview.js
 * @generated from original JavaScript - manual review recommended
 * @module resumePreview
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="resume-preview-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[resumePreview] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=resumePreview.js.map