{{ Collective\Html\FormFacade::open(array('route' => array('vendor.import'),'method'=>'post', 'enctype' => "multipart/form-data")) }}
<div class="modal-body">

    <div class="row">
        <div class="col-md-12 mb-6">
            {{Collective\Html\FormFacade::label('file',__('Download sample vendor CSV file'),['class'=>'form-label'])}}
