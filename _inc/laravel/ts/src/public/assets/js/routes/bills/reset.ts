...
((): void => {
  try {
    ...
    const flag = "data-reset-bill-summary-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Bill summary report route is unavailable. Please contact technical support or your domain administrator.";
