/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/incomeVsExpenses/summaries/reset.js
...
((): void => {
  try {
    ...
    const flag = "data-reset-income-vs-expense-summary-listener";
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest
              ? e.target.closest("a.reset-income-vs-expense-summary")
              : null);
          if (!a) return;
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Income vs expense summary report route is unavailable. Please contact technical support or your domain administrator.";
