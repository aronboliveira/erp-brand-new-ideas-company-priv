/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/contract.js
 * @generated from original JavaScript - manual review recommended
 * @module contract
 */
(() => {
    const listenerAttr = "data-ctc-index-listener-active", el = document.getElementById("ctc-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("ctc-index-link"))
            observer.disconnect();
    });
