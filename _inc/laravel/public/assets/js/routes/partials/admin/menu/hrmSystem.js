/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/hrmSystem.js
 * @generated from original JavaScript - manual review recommended
 * @module hrmSystem
 */
(() => {
    const listenerAttr = "data-hrm-system-setup-listener-active", el = document.getElementById("hrm-system-setup-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[hrmSystem] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=hrmSystem.js.map