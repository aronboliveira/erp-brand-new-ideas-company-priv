    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.resent-purchase") : null);
          if (!a) return;
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Resend purchase route is unavailable. Please contact technical support or your domain administrator.";
