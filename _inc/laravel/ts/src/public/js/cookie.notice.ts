...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    if (!instance) new cookieNoticeJS();
  });
  ...
  window.cookieNoticeJS = function () {
    ...
    if (!testCookie() || getNoticeCookie()) return;
    ...
    if (learnMoreLink) noticeDomElement.appendChild(learnMoreLink);
  ...
  function createNotice(message, bgColor, textColor, position) {
    ...
    for (const [k, v] of Object.entries({
      ...
      (noticeStyle as unknown as Record<string, unknown>)[k] = v;
  ...
  function createDismissButton(message, buttonColor, buttonTextColor) {
    ...
    for (const [k, v] of Object.entries({
      ...
      (dismissButtonStyle as unknown as Record<string, unknown>)[k] = v;
  ...
  function createLearnMoreLink(
    ...
    for (const [k, v] of Object.entries({
      ...
      (learnMoreLink as unknown as Record<string, unknown>)[k] = v;
