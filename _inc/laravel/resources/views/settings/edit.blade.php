            ...
            <div class="col-md-6">
                <div class="card">
                                            ...
                                            <td>
                                                @if(in_array('manage '.$module,(array) $permissions))
                                                    @if($key = array_search('manage '.$module,$permissions))
                                                        <div class="{{ ViewClassNamesConstants::FM_CHK_IL }}">
                                                            {{Collective\Html\FormFacade::checkbox('permissions[]',$key,$role->permission, ['id' =>'permission'.$key])}}
                                                            {{Collective\Html\FormFacade::label('permission'.$key,'Manage')}}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                                @if(in_array('create '.$module,(array) $permissions))
                                                    @if($key = array_search('create '.$module,$permissions))
                                                        <div class="{{ ViewClassNamesConstants::FM_CHK_IL }}">
                                                            {{Collective\Html\FormFacade::checkbox('permissions[]',$key,$role->permission, ['id' =>'permission'.$key])}}
                                                            {{Collective\Html\FormFacade::label('permission'.$key,'Create')}}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                                @if(in_array('edit '.$module,(array) $permissions))
                                                    @if($key = array_search('edit '.$module,$permissions))
                                                        <div class="{{ ViewClassNamesConstants::FM_CHK_IL }}">
                                                            {{Collective\Html\FormFacade::checkbox('permissions[]',$key,$role->permission, ['id' =>'permission'.$key])}}
                                                            {{Collective\Html\FormFacade::label('permission'.$key,'Edit')}}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                                @if(in_array('delete '.$module,(array) $permissions))
                                                    @if($key = array_search('delete '.$module,$permissions))
                                                        <div class="{{ ViewClassNamesConstants::FM_CHK_IL }}">
                                                            {{Collective\Html\FormFacade::checkbox('permissions[]',$key,$role->permission, ['id' =>'permission'.$key])}}
                                                            {{Collective\Html\FormFacade::label('permission'.$key,'Delete')}}<br>
                                                        </div>
                                                    @endif
                                                @endif
                                            </td>
                    ...
                    <div class="card-footer">
                        {{Collective\Html\FormFacade::submit(__('Update'),array('class'=>'btn btn-primary'))}}
