...
((): void => {
  try {
    ...
    const flag = "data-download-profit-loss-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for Profit & Loss report is unavailable. Please contact technical support or your domain administrator.";
