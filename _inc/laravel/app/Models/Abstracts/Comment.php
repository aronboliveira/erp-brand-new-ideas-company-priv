...
abstract class Comment extends Model
{
	...
	protected function enforceCommentInvariants(): void
	{
	    try {
	        ...
	        Log::error(static::class . '::enforceCommentInvariants — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected function sanitizeCommentBody(mixed $value): string
	{
	    try {
	        ...
	        Log::error(static::class . '::sanitizeCommentBody — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return '';
	    }
	}
	...
	public function getReactionTotalAttribute(): int
	{
	    try {
	        ...
	        Log::error(static::class . '::getReactionTotalAttribute — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return 0;
	    }
	}
	...
	public function markDeleted(?string $deleterId = null): void
	{
	    try {
	        ...
	        Log::error(static::class . '::markDeleted — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	public function addEdit(string $newComment, ?string $editorId = null): void
	{
	    try {
	        ...
	        Log::error(static::class . '::addEdit — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
