...
@section(YieldingConstants::ADM_BDC)
    ...
    <li class="breadcrumb-item">{{!empty($employeesId) ? $employeesId : (!empty($employee) && isset($employee) ? $employee->id : __('Employee id not found')) }}</li>
@endsection
                            ...
                            <div class="{{ VC::CM6 }}">
                                <div class="{{ VC::CD }} emp_details">
                                    ...
                                    <div class="card-body employee-detail-edit-body">
                                        ...
                                        @endphp
                                        @if (($employeedoc instanceof Collection && $employeedoc->isNotEmpty()) || (is_array($employeedoc) && count($employeedoc)))
                                            @foreach($documents as $key => $document)
                                                <div class="{{ VC::RW }}">
                                                    <div class="{{ VC::FM_GCB12 }}">
                                                        <div class="float-left col-4">
                                                            <label for="document" class="float-left pt-1 {{ VC::FM_LB }}">{{ $document->name }} @if($document->is_required == 1) <span class="text-danger">*</span> @endif</label>
                                                        </div>
                    ...
                    @else
                        <div class="{{ VC::RW }}">
                            <div class="{{ VC::CM6 }}">
                                <div class="employee-detail-wrap">
                                    <div class="{{ VC::CD }} emp_details">
                                        <div class="card-header"><h6 class="{{ VC::MB0 }}">{{ __('Document Detail') }}</h6></div>
                                        <div class="card-body employee-detail-edit-body">
                                            <div class="{{ VC::RW }}">
                                                @php
