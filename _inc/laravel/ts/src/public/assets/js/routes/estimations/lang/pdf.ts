/**
 * @fileoverview TypeScript version of public/assets/js/routes/estimations/lang/pdf.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      estimate_pdf_unavailable:
        "PDF-Erstellung für Kostenvoranschlag fehlgeschlagen.",
    },
