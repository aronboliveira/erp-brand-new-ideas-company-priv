/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/bugStatus.js
 * @generated from original JavaScript - manual review recommended
 * @module bugStatus
 */
(() => {
    const listenerAttr = "data-bug-status-listener-active", el = document.getElementById("bug-status-index-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[bugStatus] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("bug-status-index-link"))
            observer.disconnect();
    });
    observer.observe(document.body, { childList: true, subtree: true });
})();
//# sourceMappingURL=bugStatus.js.map