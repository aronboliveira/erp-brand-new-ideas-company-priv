/**
 * Auto-generated Playwright tests for goal_types routes
...
test.describe('goal_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/goal_types-create.html');
...
test.describe('goal_types.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/goal_types-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('goal_types.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/goal_types-index.html');
    await page.waitForLoadState('networkidle');
