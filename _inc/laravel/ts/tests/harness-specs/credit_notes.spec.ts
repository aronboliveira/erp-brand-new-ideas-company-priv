/**
 * Auto-generated Playwright tests for credit_notes routes
...
test.describe('credit_notes.custom_create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/credit_notes-custom_create.html');
...
test.describe('credit_notes.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/credit_notes-index.html');
    await page.waitForLoadState('networkidle');
