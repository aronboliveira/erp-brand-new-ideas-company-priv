/**
 * Auto-generated Playwright tests for settings routes
...
test.describe('settings.company', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/settings-company.html');
...
test.describe('settings.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/settings-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('settings.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/settings-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('settings.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/settings-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('settings.pos', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/settings-pos.html');
    await page.waitForLoadState('networkidle');
...
test.describe('settings.print', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/settings-print.html');
    await page.waitForLoadState('networkidle');
...
test.describe('settings.test_mail', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/settings-test_mail.html');
    await page.waitForLoadState('networkidle');
