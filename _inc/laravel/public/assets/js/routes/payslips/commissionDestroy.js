/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/commissionDestroy.js
 * @generated from original JavaScript - manual review recommended
 * @module commissionDestroy
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="commission-delete-form-"][data-url][data-guard-msg]')) ?? [];
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[commissionDestroy] Error:`, err);
                    }
                });
            }
            catch (err) {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="commission-delete-link-"][data-url][data-guard-msg]')) ?? [];
        links.forEach(l => {
            try {
...
//# sourceMappingURL=commissionDestroy.js.map