/**
 * @fileoverview TypeScript version of public/assets/js/routes/pos/monthly/printable.js
 * @generated from original JavaScript - manual review recommended
 * @module printable
 */
(() => {
    const BS_LINK = 'link[href*="bootstrap"]', PRINTABLE_AREA = "printableArea", FILENAME_INPUT = "#filename", TOAST_CONTAINER_CLASS = "toast-container", _translations = {
        ar: {
