/**
 * Auto-generated Playwright tests for job_stages routes
...
test.describe('job_stages.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_stages-create.html');
...
test.describe('job_stages.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_stages-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_stages.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_stages-index.html');
    await page.waitForLoadState('networkidle');
