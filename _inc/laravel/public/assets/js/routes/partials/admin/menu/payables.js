/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/payables.js
 * @generated from original JavaScript - manual review recommended
 * @module payables
 */
(() => {
    const listenerAttr = "data-payables-listener-active", el = document.getElementById("payables-link");
