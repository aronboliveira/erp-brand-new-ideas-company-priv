/**
 * Auto-generated Playwright tests for custom_questions routes
...
test.describe('custom_questions.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/custom_questions-create.html');
...
test.describe('custom_questions.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/custom_questions-index.html');
    await page.waitForLoadState('networkidle');
