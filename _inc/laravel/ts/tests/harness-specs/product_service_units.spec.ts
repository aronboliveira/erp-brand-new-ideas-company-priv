/**
 * Auto-generated Playwright tests for product_service_units routes
...
test.describe('product_service_units.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_units-create.html');
...
test.describe('product_service_units.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_units-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('product_service_units.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_units-index.html');
    await page.waitForLoadState('networkidle');
