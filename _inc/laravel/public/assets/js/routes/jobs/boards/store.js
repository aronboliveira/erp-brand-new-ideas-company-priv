/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/boards/store.js
 * @generated from original JavaScript - manual review recommended
 * @module store
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="job-ob-store-form-"][data-url][data-guard-msg]'));
        if (forms.length === 0)
            return;
        forms.forEach(fm => {
