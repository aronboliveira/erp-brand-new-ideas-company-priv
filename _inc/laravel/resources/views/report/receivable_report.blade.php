...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        {{ Collective\Html\FormFacade::open(['route' => ['receivables.print']]) }}
            ...
            <div class="col-md-12">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            {{ Collective\Html\FormFacade::open(['route' => [ViewsConstants::RPT . '.receivables'], 'method' => 'GET', 'id' => 'report_bill_summary']) }}
                                ...
                                <div class="col-auto mt-4">
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <a href="{{ route(ViewsConstants::RPT . '.receivables') }}" class="btn btn-sm btn-danger"
