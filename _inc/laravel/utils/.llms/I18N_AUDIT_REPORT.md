...
\* The single failure (`financial.spec.cjs:133` — expense create form) is a **pre-existing** route change (`/expenses/create` now redirects to `/product_service_units?modal=create`), unrelated to i18n.
