                                        ...
                                        <div class="btn-box">
                                            ...
                                            <select class="select form-select" name="all_users" id="all_users">
                                                ...
                                                <?php if(Utility::isFilled($usersList) ?? []): ?>
                                                    <?php $__currentLoopData = $usersList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="table-responsive">
                    <table class="table datatable">
                        ...
                        <?php if(Utility::isFilled($projectsList) ?? []): ?>
                            <?php $__currentLoopData = $projectsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    <td>
                                        <div class="avatar-group" id="project_<?php echo e($projId); ?>">
                                            <?php if(Utility::isFilled($usersSafe) ?? []): ?>
                                                <?php $__currentLoopData = $usersSafe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($idx < 3): ?>
