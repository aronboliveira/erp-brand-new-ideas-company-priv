/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/applications/destroy.js
 * @generated from original JavaScript - manual review recommended
 * @module destroy
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="delete-form-"][data-url][data-guard-msg]'));
        forms.forEach(fm => {
            try {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="delete-link-"][data-url][data-guard-msg]'));
        links.forEach(l => {
            try {
