/**
 * Auto-generated Playwright tests for taxes routes
...
test.describe('taxes.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/taxes-create.html');
...
test.describe('taxes.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/taxes-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('taxes.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/taxes-index.html');
    await page.waitForLoadState('networkidle');
