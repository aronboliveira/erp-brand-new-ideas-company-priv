/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/support.js
...
((): void => {
  const listenerAttr = "data-support-listener-active",
    el = document.getElementById("support-link");
  ...
  const observer = new MutationObserver((): void => {
    if (!document.getElementById("support-link")) observer.disconnect();
  });
