        ...
        <div class="modal-body">
            ...
            <div class="{{ VC::RW }}">
                ...
                <div class="{{ VC::FM_GCB6 }}">
                    ...
                    {{ Form::select('user_id', ((is_array($users) && count($users)) || ($users instanceof Collection && $users->isNotEmpty())) ? $users : ['' => __('No user available')], null, [ 'class' => VC::FM_CT_SL . ' select', 'required' => 'required' ]) }}
                </div>
                <div class="{{ VC::FM_GCB6 }}">
                ...
                <div class="{{ VC::FM_GCB6 }}">
                    ...
                    {{ Form::select('pipeline_id', ((is_array($pipelines) && count($pipelines)) || ($pipelines instanceof Collection && $pipelines->isNotEmpty())) ? $pipelines : ['' => __('No pipeline available')], null, [ 'class' => VC::FM_CT_SL . ' select', 'required' => 'required' ]) }}
                </div>
                <div class="{{ VC::FM_GCB6 }}">
                ...
                <div class="{{ VC::FM_GCB12 }}">
                    ...
                    {{ Form::select('sources[]', ((is_array($sources) && count($sources)) || ($sources instanceof Collection && $sources->isNotEmpty())) ? $sources : ['' => __('No source available')], null, [ 'class' => VC::FM_CT_SL . ' select2', 'id' => 'choices-multiple1', 'multiple' => 'multiple', 'required' => 'required' ]) }}
                </div>
                <div class="{{ VC::FM_GCB12 }}">
                    {{ Form::label('products', __('Products'), [ 'class' => VC::FM_LB ]) }}<span class="text-danger">*</span>
                    {{ Form::select('products[]', ((is_array($products) && count($products)) || ($products instanceof Collection && $products->isNotEmpty())) ? $products : ['' => __('No product available')], null, [ 'class' => VC::FM_CT_SL . ' select2', 'id' => 'choices-multiple2', 'multiple' => 'multiple', 'required' => 'required' ]) }}
                </div>
                <div class="{{ VC::FM_GCB12 }}">
