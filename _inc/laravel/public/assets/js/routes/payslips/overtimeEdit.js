/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/overtimeEdit.js
 * @generated from original JavaScript - manual review recommended
 * @module overtimeEdit
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="overtime-edit-link-"][data-url][data-guard-msg]')) ?? [];
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[overtimeEdit] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=overtimeEdit.js.map