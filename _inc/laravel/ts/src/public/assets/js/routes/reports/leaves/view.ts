...
((): void => {
  try {
    ...
    const flag = "data-view-employee-leave-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Leave detail route is unavailable. Please contact technical support or your domain administrator.";
