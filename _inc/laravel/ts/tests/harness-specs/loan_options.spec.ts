/**
 * Auto-generated Playwright tests for loan_options routes
...
test.describe('loan_options.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/loan_options-create.html');
...
test.describe('loan_options.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/loan_options-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('loan_options.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/loan_options-index.html');
    await page.waitForLoadState('networkidle');
