                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <?php if (method_exists($bill, 'getTotalDiscount') && $bill->getTotalDiscount()): ?>
                                    <tr style="border-bottom:1px solid <?= e($color) ?>">
                                        ...
                                        <td><?php try {
                                                ...
                                                Log::error('Discount fmt: ' . $e->getMessage());
                                                echo '0';
                                            } ?></td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                <tr style="border-bottom:1px solid <?= e($color) ?>">
                                    ...
                                    <td><?php
                                        try {
                                            $paid = (method_exists($bill, 'getTotal') ? $bill->getTotal() : 0) - (method_exists($bill, 'getDue') ? $bill->getDue() : 0) - (method_exists($bill, 'billTotalDebitNote') ? $bill->billTotalDebitNote() : 0);
                                            echo e(Utility::priceFormat($settings, $paid));
                                        } catch (\Throwable $e) {
