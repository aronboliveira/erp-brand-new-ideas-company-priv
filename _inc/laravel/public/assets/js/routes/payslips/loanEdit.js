/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/loanEdit.js
 * @generated from original JavaScript - manual review recommended
 * @module loanEdit
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="loan-edit-link-"][data-url][data-guard-msg]')) ?? [];
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
...
//# sourceMappingURL=loanEdit.js.map