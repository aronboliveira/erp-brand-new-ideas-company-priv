...
((): void => {
  try {
    ...
    const flag = "data-reset-payables-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.reset-payables") : null);
          if (!a) return;
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Payables reset route is unavailable. Please contact technical support or your domain administrator.";
