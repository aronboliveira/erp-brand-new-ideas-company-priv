/**
 * Auto-generated Playwright tests for expenses routes
...
test.describe('expenses.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/expenses-create.html');
...
test.describe('expenses.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/expenses-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('expenses.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/expenses-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('expenses.view', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/expenses-view.html');
    await page.waitForLoadState('networkidle');
