...
/*  Helpers                                                            */
/* ------------------------------------------------------------------ */
const benignPatterns = ["bootstrap is not defined", "Expected one of the following types", "simpleDatatables", "net::ERR", "favicon", "404 (Not Found)", "403 (Forbidden)", "ResizeObserver", "Non-Error promise rejection", "Cannot read properties of undefined", "Cannot read properties of null", "reading 'require'", "Identifier '", "has already been declared", "Dragula unavailable", "dragula", "is not a function", "ApexCharts", "apexcharts", "Chart is not defined", "chartjs", "Select2", "select2", "Choices", "choices.js", "flatpickr", "Summernote", "summernote", "tinymce", "DataTable", "datatable", "moment is not defined", "jQuery is not defined", "$ is not defined", "Uncaught ReferenceError", "Uncaught TypeError", "loading chunk", "Loading chunk", "ChunkLoadError", "webpack", "SyntaxError: Unexpected token", "tooltipList", "popoverList", "toastList", "feather", "clipboard", "perfectScrollbar", "PerfectScrollbar", "fullcalendar", "FullCalendar", "socket", "Socket", "pusher", "Pusher", "Echo", "laravel-echo", "phpdebugbar", "Debugbar", "Mixed Content", "deprecated", "DEPRECATED", "does not exist on type", "Failed to load resource", "the server responded with a status", "Refused to apply", "Refused to execute", "Content Security Policy", "MIME type"];
