                            ...
                            @foreach ($projects as $key => $project)
                                @if(isset($project) && is_object($project))
                                    @php
                                        ...
                                        $copyCandidates = [ViewsConstants::PRJ.'.copy', Str::kebab(ViewsConstants::PRJ.'.copy'), VW::PRJ . '.copy', Str::kebab(VW::PRJ . '.copy')];
                                        $copyResolved = null;
                                        ...
                                        $authUserId = $user?->id;
                                        $destroyBase = ViewsConstants::PRJ.'.user.destroy';
                                        ...
                                        <td>
                                            <div class="avatar-group" id="project_{{ !empty($projectId) ? $projectId : 'unknown' }}">
                                                @if(isset($project->users) && 
                                                    ...
                                                    @endif
                                                @else
                                                    <span class="text-muted">{{ __('No users could be found for the project.') }}</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="text-end">
