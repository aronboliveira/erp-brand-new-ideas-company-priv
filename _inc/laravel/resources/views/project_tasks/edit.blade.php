...
@endphp
{{ Form::model($task, ['route' => [ViewsConstants::PRJ_TSK_C.'.update',[$project->id, $task->id]], 'id' => 'edit_task', 'method' => 'POST']) }}
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    {{ Form::label(ProjectsConstants::COL_NM, 
                        __('Task name'),['class' => 'form-label']) }}<span class="text-danger">*</span>
                    {{ Form::text(ProjectsConstants::COL_NM, 
                        null, ['class' => 'form-control','required'=>'required']) }}
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    {{ Form::label(ProjectsConstants::COL_ML_ID, __('Milestone'),['class' => 'form-label']) }}
            ...
            <div class="col-6">
                <div class="form-group">
                    {{ Form::label(ProjectsConstants::COL_E_HRS, __('Estimated Hours'),['class' => 'form-label']) }}<span class="text-danger">*</span>
            ...
            <div class="col-6">
                <div class="form-group">
                    {{ Form::label(ProjectsConstants::COL_E_DT, __('End Date'),['class' => 'form-label']) }}
