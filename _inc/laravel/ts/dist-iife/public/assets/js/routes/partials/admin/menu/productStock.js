...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/productStock.js
 * @generated from original JavaScript - manual review recommended
 * @module productStock
 */
(() => {
    const listenerAttr = "data-product-stock-listener-active", el = document.getElementById("product-stock-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[productStock] Error:`, error);
            }
        });
    }
