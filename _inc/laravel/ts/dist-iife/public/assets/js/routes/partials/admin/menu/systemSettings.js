...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/systemSettings.js
 * @generated from original JavaScript - manual review recommended
 * @module systemSettings
 */
(() => {
    const listenerAttr = "data-system-settings-listener-active", el = document.getElementById("system-settings-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("system-settings-link"))
            observer.disconnect();
    });
