 ...
 */
(() => {
    const listenerAttr = "data-financial-goal-index-listener-active", el = document.getElementById("financial-goal-index-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[financialGoal] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("financial-goal-index-link"))
            observer.disconnect();
    });
