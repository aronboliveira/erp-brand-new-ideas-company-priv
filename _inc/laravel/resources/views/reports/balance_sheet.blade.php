...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        {{ Collective\Html\FormFacade::open(['route' => ['balance.sheet.print']]) }}
    ...
    <div class="float-end me-2">
        {{ Collective\Html\FormFacade::open(['route' => ['balance.sheet.export']]) }}
        <input type="hidden" name="start_date" class="start_date">
        <input type="hidden" name="end_date" class="end_date">
    ...
    <div class="float-end me-2">
        <a href="{{ route(ViewsConstants::RPT.'.balance.sheet' , 'horizontal')}}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Horizontal View') }}"
            ...
            <div class="col-md-8">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            {{ Collective\Html\FormFacade::open(['route' => [ViewsConstants::RPT.'.balance.sheet'], 'method' => 'GET', 'id' => 'report_bill_summary']) }}
                                ...
                                <div class="col-auto mt-4">
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <a href="{{ route(ViewsConstants::RPT.'.balance.sheet') }}" class="btn btn-sm btn-danger"
