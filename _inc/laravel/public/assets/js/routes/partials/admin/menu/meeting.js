/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/meeting.js
 * @generated from original JavaScript - manual review recommended
 * @module meeting
 */
(() => {
    const listenerAttr = "data-meeting-index-listener-active", el = document.getElementById("meeting-index-link");
