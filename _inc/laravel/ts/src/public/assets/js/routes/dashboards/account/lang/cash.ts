/**
 * @fileoverview TypeScript version of public/assets/js/routes/dashboards/account/lang/cash.js
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    da: {
      ...
      incExpBarChart_unavailable:
        "Kunne ikke indlæse søjlediagram for indtægter/udgifter.",
      expenseByCategory_unavailable:
        "Kunne ikke indlæse diagram over udgifter efter kategori.",
      incomeByCategory_unavailable:
        "Kunne ikke indlæse diagram over indtægter efter kategori.",
    ...
    de: {
      ...
      incExpBarChart_unavailable:
        "Balkendiagramm für Einnahmen/Ausgaben konnte nicht geladen werden.",
      expenseByCategory_unavailable:
        "Diagramm der Ausgaben nach Kategorie konnte nicht geladen werden.",
      incomeByCategory_unavailable:
        "Diagramm der Einnahmen nach Kategorie konnte nicht geladen werden.",
      limitChart_unavailable:
        "Speicherlimit-Diagramm konnte nicht geladen werden.",
    },
    en: {
    ...
    es: {
      ...
      incExpBarChart_unavailable:
        "No se pudo cargar el gráfico de barras de ingresos/gastos.",
      expenseByCategory_unavailable:
        "No se pudo cargar el gráfico de gastos por categoría.",
      incomeByCategory_unavailable:
        "No se pudo cargar el gráfico de ingresos por categoría.",
      limitChart_unavailable:
        "No se pudo cargar el gráfico del límite de almacenamiento.",
    },
    fr: {
      cash_flow_unavailable:
        "Impossible de charger le graphique de flux de trésorerie.",
      incExpBarChart_unavailable:
        "Impossible de charger l’histogramme des revenus/dépenses.",
      expenseByCategory_unavailable:
        "Impossible de charger le graphique des dépenses par catégorie.",
      incomeByCategory_unavailable:
        "Impossible de charger le graphique des revenus par catégorie.",
      limitChart_unavailable:
        "Impossible de charger le graphique de limite de stockage.",
    },
    he: {
    ...
    it: {
      cash_flow_unavailable:
        "Impossibile caricare il grafico del flusso di cassa.",
      incExpBarChart_unavailable:
        "Impossibile caricare il grafico a barre entrate/spese.",
      expenseByCategory_unavailable:
        "Impossibile caricare il grafico delle spese per categoria.",
      incomeByCategory_unavailable:
        "Impossibile caricare il grafico delle entrate per categoria.",
      limitChart_unavailable:
        "Impossibile caricare il grafico del limite di archiviazione.",
    },
    ja: {
    ...
    nl: {
      ...
      incExpBarChart_unavailable:
        "Kan staafdiagram voor inkomsten/uitgaven niet laden.",
      expenseByCategory_unavailable:
        "Kan grafiek met uitgaven per categorie niet laden.",
      incomeByCategory_unavailable:
        "Kan grafiek met inkomsten per categorie niet laden.",
      limitChart_unavailable: "Kan opslaglimietgrafiek niet laden.",
    },
    pl: {
      cash_flow_unavailable:
        "Nie udało się załadować wykresu przepływów pieniężnych.",
      incExpBarChart_unavailable:
        "Nie udało się załadować wykresu słupkowego przychodów/wydatków.",
      expenseByCategory_unavailable:
        "Nie udało się załadować wykresu wydatków według kategorii.",
      incomeByCategory_unavailable:
        "Nie udało się załadować wykresu przychodów według kategorii.",
      limitChart_unavailable:
        "Nie udało się załadować wykresu limitu pamięci masowej.",
    },
    pt: {
    ...
    ru: {
      ...
      incExpBarChart_unavailable:
        "Не удалось загрузить столбчатый график доходов/расходов.",
      expenseByCategory_unavailable:
        "Не удалось загрузить график расходов по категориям.",
      incomeByCategory_unavailable:
        "Не удалось загрузить график доходов по категориям.",
