...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/formBuilder.js
 * @generated from original JavaScript - manual review recommended
 * @module formBuilder
 */
(() => {
    const listenerAttr = "data-form-builder-listener-active", el = document.getElementById("form-builder-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("form-builder-link"))
            observer.disconnect();
    });
