...
((): void => {
  try {
    ...
    const flag = "data-download-payroll-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.download-payroll") : null);
          if (!a) return;
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for payroll report is unavailable. Please contact technical support or your domain administrator.";
