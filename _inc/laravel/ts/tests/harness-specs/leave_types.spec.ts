/**
 * Auto-generated Playwright tests for leave_types routes
...
test.describe('leave_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leave_types-create.html');
...
test.describe('leave_types.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leave_types-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('leave_types.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/leave_types-index.html');
    await page.waitForLoadState('networkidle');
