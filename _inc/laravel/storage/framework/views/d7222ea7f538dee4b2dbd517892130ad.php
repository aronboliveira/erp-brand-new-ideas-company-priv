                                        ...
                                        <div class="<?php echo e(VC::RW); ?>">
                                            ...
                                            <div class="<?php echo e(VC::CL_XL3); ?>">
                                                <div class="btn-box">
                                                    ...
                                                    <?php echo e(Form::date('start_date', !empty($filter['startDateRange']) ? $filter['startDateRange'] : __('No start date range available'), ['class' => 'startDate ' . VC::FM_CT])); ?>
                                            ...
                                            <div class="<?php echo e(VC::CL_XL3); ?>">
                                                <div class="btn-box">
                                                    ...
                                                    <?php echo e(Form::date('end_date', !empty($filter['endDateRange']) ? $filter['endDateRange'] : __('No end date range available'), ['class' => 'endDate ' . VC::FM_CT])); ?>
