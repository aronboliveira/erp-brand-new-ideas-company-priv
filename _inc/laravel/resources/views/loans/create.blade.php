@php
    ...
    $storeGuard = Utility::fetchLinkMessage($lang, VW::LN, 'loan_store_route_unavailable') ?? __('Loan store route is unavailable. Please contact technical support or your domain administrator.');
