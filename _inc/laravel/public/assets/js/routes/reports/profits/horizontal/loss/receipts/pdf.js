/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/profits/horizontal/loss/receipts/pdf.js
 * @generated from original JavaScript - manual review recommended
 * @module pdf
 */
(function () {
    const $ = window.jQuery;
    const qs = (s, r = document) => r.querySelector(s), errFb = "# ERROR", dataClientLocalized = "data-client-localized", dataGuardMsg = "data-guard-msg", dataSvLocalized = "data-sv-localized", dataErrGuard = "data-error-guard", dataFilterGuard = "data-filter-guard", dataPrintGuard = "data-print-guard";
    ...
    const saveAsPDF = () => {
        ...
        const name = String($ ? ($("#filename").val() ?? "") : "export").trim(), opt = {
            margin: 0.3,
            filename: name,
