/**
 * @fileoverview TypeScript version of public/assets/js/routes/dashboards/clients/lang/chart.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      chart_projects_unavailable:
        "Projektstatus-Diagramm konnte nicht dargestellt werden.",
    },
    en: {
    ...
    it: {
      ...
      chart_tasks_unavailable:
        "Impossibile visualizzare il grafico delle attività.",
      chart_projects_unavailable:
        "Impossibile visualizzare il grafico di stato del progetto.",
    },
    ja: {
    ...
    pl: {
      ...
      chart_projects_unavailable:
        "Nie udało się wyświetlić wykresu statusu projektu.",
    },
    pt: {
      ...
      chart_projects_unavailable:
        "Falha ao exibir gráfico de status do projeto.",
    },
    "pt-br": {
      calendar_init_failed: "Falha ao inicializar o calendário.",
      event_modal_unavailable: "Falha ao carregar detalhes do evento.",
    ...
    ru: {
      ...
      chart_projects_unavailable:
        "Не удалось отобразить график статуса проекта.",
    },
    tr: {
