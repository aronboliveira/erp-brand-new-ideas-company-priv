/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/daily/printable.js
...
(() => {
  ...
  const saveAsPDF = () => {
    try {
      ...
      if (typeof window.html2pdf !== "object" || typeof window.html2pdf().set !== "function") {
        showError("no_lib");
        return;
      }
      window
