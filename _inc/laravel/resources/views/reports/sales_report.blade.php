...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        {{ Collective\Html\FormFacade::open(['route' => ['sales.report.print']]) }}
    ...
    <div class="float-end me-2">
        {{ Collective\Html\FormFacade::open(['route' => ['sales.export']]) }}
        <input type="hidden" name="start_date" class="start_date">
        <input type="hidden" name="end_date" class="end_date">
        <input type="hidden" name="report" class="report">
            ...
            <div class="col-md-12">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            {{ Collective\Html\FormFacade::open(['route' => [ViewsConstants::RPT . '.sales'], 'method' => 'GET', 'id' => 'report_bill_summary']) }}
                                ...
                                <div class="col-auto mt-4">
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <a href="{{ route(ViewsConstants::RPT . '.sales') }}" class="btn btn-sm btn-danger"
