...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/projects/tasks/boardView.js
 * @generated from original JavaScript - manual review recommended
 * @module boardView
 */
(() => {
    const btn = document.getElementById("taskboard-view-list-btn");
    ...
    if (!btn.getAttribute("data-listener-bound-click")) {
        ...
        btn.addEventListener("click", (e) => {
            try {
                ...
                console.error(`[boardView] Error:`, err);
            }
        });
    }
})();
