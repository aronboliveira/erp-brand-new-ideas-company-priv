    ...
    <div class="proposal-preview-main" id="boxes">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <img class=" proposal-logo" src="{{$img}}" alt="" style="margin-bottom: 15px;">
        ...
        <div class="proposal-body">
            ...
            <table class=" proposal-summary" style="margin-top: 30px;">
                ...
                <tbody style="border-bottom:1px solid <?= $color ?>"> @if(isset($proposal->itemData) && count($proposal->itemData) > 0)
