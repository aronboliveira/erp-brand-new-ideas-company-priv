...
class CreatePosTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create(self::TABLE, function (Blueprint $table) {
            ...
            $table->string(BC::COL_DVC_SR)->index()->nullable(); // ? nullable for tests, device serial number
            ...
            $table->uuid(BC::COL_WRH_ID)->index()->nullable();
            ...
            $table->enum('type', PosType::values())->default(PosType::Other->value)->index()->nullable(); // ? nullable for tests
            ...
            $table->enum(BC::COL_STT_LB, PosStatus::values())->default(PosStatus::Other->value)->index()->nullable(); // ? nullable for tests
