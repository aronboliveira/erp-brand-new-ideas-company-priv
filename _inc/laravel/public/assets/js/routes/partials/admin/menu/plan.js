/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/plan.js
 * @generated from original JavaScript - manual review recommended
 * @module plan
 */
(() => {
    const listenerAttr = "data-plan-listener-active", el = document.getElementById("plan-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("plan-index-link"))
            observer.disconnect();
    });
