...
(() => {
    try {
        ...
        b.addEventListener("click", function (e) {
            try {
                const url = b.getAttribute("data-url") ?? b.getAttribute("data-action") ?? "#";
                if (url !== "#")
                    return;
                e.preventDefault();
                const msg = b.getAttribute("data-guard-msg") ??
                    "Store file for task comment route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
