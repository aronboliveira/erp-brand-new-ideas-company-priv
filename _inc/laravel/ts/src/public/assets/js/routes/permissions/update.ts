/**
 * @fileoverview TypeScript version of public/assets/js/routes/permissions/update.js
  ...
  form.addEventListener(
    ...
    e => {
      ...
      if (!url || url === "#") {
        e.preventDefault();
        const msg =
          form.getAttribute("data-guard-msg") ?? "Update Permission route is unavailable. Please contact technical support or your domain administrator.";
        showToast(msg);
      }
    },
    { passive: false }
