...
| ID   | Issue                                                     | Resolution                                                                                   |
| ---- | --------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| D-3  | PHPUnit DashboardDataTest migration/factory errors          | Fixed factories (billing_* cols, UUID bill_id), namespace import, createdBy(), risky tests — 26/26 pass (2026-03-04) |
