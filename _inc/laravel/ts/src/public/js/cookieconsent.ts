    ...
    const kb = function (eb) {
        let e = {
            ...
            La = function (a) {
                ...
                T || (T = k("div"), T.id = "c-bns", a?.consent_modal && !0 === a.consent_modal.swap_buttons ? (d && T.appendChild(S), c && T.appendChild(W), T.className = "swap") : (c && T.appendChild(W), d && T.appendChild(S)), (c || d) && ba.appendChild(T), x.appendChild(ba));
                Q = !0
            },
            ab = function (a) {
        ...
        var cb = function (a) {
            ...
            gb = function (a) {
                ...
                if (0 < b.length)
                    for (let c = 0; c < b.length; c++) - 1 !== H(a, I[c]) ? (b[c].checked = !0, R[c] || (V.push(I[c]),
        ...
        m.allowedCategory = function (a) {
            const b = K || "opt-in" === e.mode ? JSON.parse(wa(e.cookie_name, "one", !0) || "{}").level || [] : Ia;
            return -1 < H(b, a)
        };
        m.run = function (a) {
            if (!document.getElementById("cc_div") &&
                ...
                if (t = JSON.parse(wa(e.cookie_name, "one", !0) || "{}"), K = void 0 !== t.level, C = void 0 !== t.data ? t.data : null, Z = "number" === typeof a.revision ? K ? -1 < a.revision ? t.revision === e.revision : !0 : !0 : !0, Q = !K || !Z, fb(), hb(a.theme_css, function () {
                    ...
                    const b = "boolean" === typeof t.rfc_cookie;
        ...
        m.loadScript = function (a, b, c) {
            ...
            if (document.querySelector('script[src="' + a + '"]')) d && b();
                ...
                const f = k("script");
                if (c && 0 < c.length)
                    for (let l = 0; l < c.length; ++l) c[l] && f.setAttribute(c[l].name, c[l].value);
        ...
        m.hideSettings = function () {
            ...
            E.setAttribute("aria-hidden", "true");
            setTimeout(function () {
                na ? (Ja?.focus(), v = Ka) : (qa?.focus(), v = null);
                oa = !1
            }, 200)
        };
        ...
        m.eraseCookies = function (a, b,
            ...
            if ("object" === typeof a && 0 < a.length)
                for (let f = 0; f < a.length; f++) this.validCookie(a[f]) && d.push(a[f]);
        ...
        var Ra = function (a, b) {
            ...
            bb = function (a, b, c) {
                ...
                for (let d = 0; d < a.length; d++)
                    for (let f = 0; f < c.length; f++) document.cookie = a[d] + "=; path=" + b + (-1 < c[f].indexOf(".") ? "; domain=" + c[f] : "") + "; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"
            };
