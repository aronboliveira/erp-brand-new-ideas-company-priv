    ...
    <body>
        <div class="proposal-preview-main" id="boxes">
            <div class="proposal-header">
                <table class="vertical-align-top">
                    <tbody>
                        <tr>
                            <td>
                                <h3 style="text-transform:uppercase;font-size:20px;font-weight:bold;color:<?= e($color) ?>"><?= e(__('PROPOSAL')) ?></h3>
                            </td>
                        ...
                        <tr>
                            <td>
                                <p>
                                    ...
                                    <?= e(data_get($settings, 'mail_from_address', __('No email available.'))) ?><br><br><br>
                                    ...
                                    <?= e(data_get($settings, 'company_state', __('No state available.'))) ?><?= !empty(data_get($settings, 'company_state')) ? '' : '' ?>
            ...
            <div class="proposal-body">
                ...
                <table class="proposal-summary" style="border-bottom:1px solid <?= e($color) ?>">
