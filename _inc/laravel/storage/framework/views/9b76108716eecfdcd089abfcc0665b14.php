                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text(SettingsConstants::SC_HDG_K,$lpSettings[SettingsConstants::SC_HDG_K], ['class' => 'form-control', 'placeholder' => __('Enter Heading')])); ?>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="<?php echo e(VC::CLMS_JCE3); ?>">
                                        ...
                                        <a
                                            ...
                                            class="<?php echo e(VC::BT_SM_PM); ?> <?php echo e($canCreate ? '' : 'disabled'); ?>"
                                           ...
                                           <?php if(is_array($screenshots) || is_object($screenshots)): ?>
                                               ...
                                               ?>
                                                <?php $__currentLoopData = $screenshots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($no++); ?></td>
                                                        <td><?php echo e(!empty($value[SettingsConstants::SC_HDG_K]) ? $value[SettingsConstants::SC_HDG_K] : __('No heading available')); ?></td>
                                                        <td>
                                                            <span>
