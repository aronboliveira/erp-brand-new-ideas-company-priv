    ...
    <div class="col-md-12">
        <div class="mt-2" id="multiCollapseExample1">
            <div class="card" id="show_filter">
                <div class="card-body">
                    {{ Collective\Html\FormFacade::open(['route' => ['chart-of-account.index'], 'method' => 'GET', 'id' => 'report_bill_summary']) }}
                                ...
                                <tbody>
                                    @foreach ($accounts as $account)
                                        ...
                                        <tr>
                                            <td>{{ $account->code }}</td>
                                            <td><a
                                                    href="{{ route(ViewsConstants::RPT.'.ledger', $account->id) }}?account={{ $account->id }}">{{ $account->name }}</a>
                                            </td>
                                            ...
                                            <td class="Action">
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="{{ route(ViewsConstants::RPT.'.ledger', $account->id) }}?account={{ $account->id }}"
