...
class DebitNoteController extends Controller
{
    ...
    public function update(Request $request, $bill_id, $debitNote_id)
    {
        ...
        if (\Auth::user()->can('edit debit note')) {
            ...
            //            Utility::userBalance('vendor', $billDue->vendor_id, $debit->amount, 'credit');
            Utility::updateUserBalance('vendor', $billDue->vendor_id, $debit->amount, 'debit');
            ...
            $debit->description = $request->description;
            $debit->save();
            //            Utility::userBalance('vendor', $billDue->vendor_id, $request->amount, 'debit');
            Utility::updateUserBalance('vendor', $billDue->vendor_id, $request->amount, 'credit');
