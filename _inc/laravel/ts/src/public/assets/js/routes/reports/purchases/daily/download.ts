        ...
        try {
          const a =
            ...
            ((e.target as Element).closest
              ? (e.target as Element).closest("a.download-daily-purchase")
              : null);
          if (!a) return;
          ...
          const msg =
            ...
            "Download function for daily purchases is unavailable. Please contact technical support or your domain administrator.";
