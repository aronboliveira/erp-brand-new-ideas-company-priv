/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/document.js
 * @generated from original JavaScript - manual review recommended
 * @module document
 */
(() => {
    const listenerAttr = "data-document-setup-listener-active", el = document.getElementById("document-setup-link");
