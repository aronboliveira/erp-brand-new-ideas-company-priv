/**
 * @fileoverview TypeScript version of public/assets/js/routes/coupons/store.js
 * @generated from original JavaScript - manual review recommended
 * @module store
 */
(() => {
    try {
        const fm = document.getElementById("coupon-store-form");
        if (!fm)
            return;
            ...
            fm.addEventListener("submit", (e) => {
                try {
                    ...
                    const msg = fm.getAttribute("data-guard-msg") ??
                        "Store coupon route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
