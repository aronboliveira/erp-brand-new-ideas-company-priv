...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/lead.js
 * @generated from original JavaScript - manual review recommended
 * @module lead
 */
(() => {
    const listenerAttr = "data-ld-index-listener-active", el = document.getElementById("ld-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("ld-index-link"))
            observer.disconnect();
    });
