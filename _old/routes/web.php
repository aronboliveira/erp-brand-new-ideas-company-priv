...
Route::get('/vendor/bill/{id}/', [BillController::class, 'invoiceLink'])->name('bill.link.copy');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        [
            ...
            Route::post('bill/vendor', [BillController::class, 'vendor'])->name('bill.vendor');
...
//        Route::get('report/profit-loss-summary', [ReportController::class, 'profitLossSummary'])->name('report.profit.loss.summary');
    ...
    Route::resource('document-upload', DocumentUploadController::class)->middleware(['auth', 'XSS']);
    Route::resource('transfer', TransferController::class)->middleware(['auth', 'XSS']);
    Route::get('EmployeeAttendance/bulkattendance', [EmployeeAttendanceController::class, 'bulkAttendance'])->name('EmployeeAttendance.bulkattendance')->middleware(['auth', 'XSS']);
    Route::post('EmployeeAttendance/bulkattendance', [EmployeeAttendanceController::class, 'bulkAttendanceData'])->name('EmployeeAttendance.bulkattendance')->middleware(['auth', 'XSS']);
    Route::post('EmployeeAttendance/attendance', [EmployeeAttendanceController::class, 'attendance'])->name('EmployeeAttendance.attendance')->middleware(['auth', 'XSS']);

    Route::resource('EmployeeAttendance', EmployeeAttendanceController::class)->middleware(['auth', 'XSS']);
...
//    Route::get('{id}/plan-get-payment-status', [PaypalController::class, 'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::get('zoom-meeting-calendar', [ZoomMeetingController::class, 'calendar'])->name('zoom-meeting.calendar')->middleware(['auth', 'XSS']);
...
//    Route::get('/bill/{id}/', 'PurchaseController@purchaseLink')->name('purchase.link.copy');
            ...
            Route::post('purchase/vendor', [PurchaseController::class, 'vendor'])->name('purchase.vendor');
    ...
    Route::get('meeting-calendar', [MeetingController::class, 'calendar'])->name('meeting.calendar')->middleware(['auth', 'XSS']);
    ...
    Route::group(
        [
            ...
            Route::post('expense/vendor', [ExpenseController::class, 'vendor'])->name('expense.vendor');
