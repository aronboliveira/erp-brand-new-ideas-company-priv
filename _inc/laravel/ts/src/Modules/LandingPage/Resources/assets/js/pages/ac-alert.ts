/**
 * @fileoverview TypeScript version of Modules/LandingPage/Resources/assets/js/pages/ac-alert.js
 * @generated from original JavaScript - manual review recommended
 * @module ac-alert
 */

"use strict";
/* eslint-disable @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-misused-promises */
...
document.querySelector(".bs-ajex-req")?.addEventListener("click", function () {
  Swal.fire({
    ...
    preConfirm: (login: unknown) => {
      const loginStr = login as string;
      return fetch(`//api.github.com/users/` + loginStr)
        ...
        .catch((error: unknown) => {
          Swal.showValidationMessage(`Request failed: ` + String(error));
        });
    },
...
document.querySelector(".bs-text-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (ipAddress) {
      Swal.fire(`Your IP address is ` + String(ipAddress));
    }
  })();
});
document.querySelector(".bs-email-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (email) {
      Swal.fire(`Entered email: ` + String(email));
    }
  })();
});
document.querySelector(".bs-url-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (url) {
      Swal.fire(`Entered URL: ` + String(url));
    }
  })();
});
document.querySelector(".bs-password-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (password) {
      Swal.fire(`Entered password: ` + String(password));
    }
  })();
});
...
document.querySelector(".bs-select-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (fruit) {
      Swal.fire(`You selected: ` + String(fruit));
    }
  })();
});
document.querySelector(".bs-radio-input")?.addEventListener("click", function () {
  (async () => {
    ...
    if (color) {
      Swal.fire({ html: `You selected: ` + String(color) });
    }
  })();
});
...
document.querySelector(".bs-multiple-input")?.addEventListener("click", function () {
  (async () => {
    const { value: formValues } = await Swal.fire({
      ...
      focusConfirm: false,
      preConfirm: () => {
        return [(document.getElementById("swal-input1") as HTMLInputElement).value, (document.getElementById("swal-input2") as HTMLInputElement).value];
      },
    });
    if (formValues) {
