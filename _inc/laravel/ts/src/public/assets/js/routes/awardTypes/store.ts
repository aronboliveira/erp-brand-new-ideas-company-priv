/**
 * @fileoverview TypeScript version of public/assets/js/routes/awardTypes/store.js
 * @generated from original JavaScript - manual review recommended
 * @module store
 */

((): void => {
  const form = document.getElementById("awardtype-store-form");
  ...
  const observer = new MutationObserver((): void => {
    if (!document.getElementById("awardtype-store-form")) observer.disconnect();
  });
