(function () {
    ...
    const t = {
        ...
        de: {
            ...
            login_submit_unavailable: "Login-Schaltfläche konnte nicht deaktiviert werden.",
        },
        en: {
        ...
        es: {
            ...
            login_submit_unavailable: "No se pudo desactivar el botón de inicio de sesión.",
        },
        fr: {
            plugin_unavailable: "Une bibliothèque requise n’a pas été chargée.",
            login_submit_unavailable: "Impossible de désactiver le bouton de connexion.",
        },
        he: {
        ...
        it: {
            ...
            login_submit_unavailable: "Impossibile disabilitare il pulsante di accesso.",
        },
        ja: {
