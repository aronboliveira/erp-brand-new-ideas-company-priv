...
@php
    try {
        ...
        \Log::error('job_applications/template/offerletterpdf — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@push(StacksConstants::CTC_SCR_PG)
    ...
    <script async src="{{ asset('assets/js/routes/jobs/applications/lang/pdf.js') }}"></script>
    <script defer>
        (function () {
        const errFb = "# ERROR";
        ...
        const dataBound = "data-pdf-gen-bound";
