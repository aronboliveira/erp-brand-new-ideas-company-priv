/**
 * Auto-generated Playwright tests for custom_fields routes
...
test.describe('custom_fields.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/custom_fields-create.html');
...
test.describe('custom_fields.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/custom_fields-index.html');
    await page.waitForLoadState('networkidle');
