 ...
 */
const WASM_POLICY_HASH = new Uint8Array([0x00, 0x61, 0x73, 0x6d, 0x01, 0x00, 0x00, 0x00, 0x01, 0x07, 0x01, 0x60, 0x02, 0x7f, 0x7f, 0x01, 0x7f, 0x03, 0x02, 0x01, 0x00, 0x05, 0x03, 0x01, 0x00, 0x01, 0x07, 0x11, 0x02, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x02, 0x00, 0x07, 0x78, 0x6f, 0x72, 0x68, 0x61, 0x73, 0x68, 0x00, 0x00, 0x0a, 0x16, 0x01, 0x14, 0x02, 0x01, 0x7f, 0x01, 0x7f, 0x41, 0x00, 0x21, 0x02, 0x41, 0x00, 0x21, 0x03, 0x02, 0x40, 0x03, 0x40, 0x20, 0x03, 0x20, 0x01, 0x4d, 0x0d, 0x01, 0x20, 0x02, 0x20, 0x00, 0x20, 0x03, 0x6a, 0x2d, 0x00, 0x00, 0x73, 0x21, 0x02, 0x20, 0x03, 0x41, 0x01, 0x6a, 0x21, 0x03, 0x0c, 0x00, 0x0b, 0x0b, 0x20, 0x02, 0x0b]);
...
if (process.argv[1]?.endsWith("policy_hash.ts")) {
  (async () => {
...
export { WASM_POLICY_HASH, loadWasm, SECURITY_POLICIES, hashPolicy, auditPolicy };
// PULL REQUEST END
