    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(array('route' => array('EmployeeAttendance.bulkattendance'),'method'=>'get','id'=>'bulkattendance_filter')) }}
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header card-body table-border-style">
                    ...
                    {{ Form::open(['route' => ['EmployeeAttendance.bulkattendance'], 'method' => 'post']) }}
