...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/bank/accounts/edit.js
 * @generated from original JavaScript - manual review recommended
 * @module edit
 */
(() => {
    const form = document.getElementById("bank-account-update-form");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("bank-account-update-form"))
            observer.disconnect();
    });
