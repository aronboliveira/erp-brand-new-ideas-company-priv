/**
 * Auto-generated Playwright tests for job_applications routes
...
test.describe('job_applications.candidate', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-candidate.html');
...
test.describe('job_applications.convert', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-convert.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.onboard_create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-onboard_create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.onboard_edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-onboard_edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.show', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-show.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.template.offerletterdocx', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-template-offerletterdocx.html');
    await page.waitForLoadState('networkidle');
...
test.describe('job_applications.template.offerletterpdf', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/job_applications-template-offerletterpdf.html');
    await page.waitForLoadState('networkidle');
