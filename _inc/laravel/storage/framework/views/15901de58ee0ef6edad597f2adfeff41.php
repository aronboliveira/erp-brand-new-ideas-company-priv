...
<?php endif; ?>
        <div class="header-wrapper">
            <div class="me-auto dash-mob-drp">
                <ul class="list-unstyled">
                    <li class="<?php echo e(ViewClassNamesConstants::DSH_H); ?> mob-hamburger">
                        <a href="#" class="<?php echo e(ViewClassNamesConstants::DSH_HD_LK); ?>" id="mobile-collapse">
                    ...
                    <li class="<?php echo e(ViewClassNamesConstants::DRP_DSH); ?> drp-company">
                        ...
                        <div class="<?php echo e(ViewClassNamesConstants::DRP_DSH_MN); ?>">
                            ...
                            <a
                                id="<?php echo e($logoutLinkId); ?>"
                                href="<?php echo e($logoutRoute); ?>"
                            ...
                            <form id="frm-logout" action="<?php echo e($logoutRoute); ?>" method="POST" class="d-none">
            ...
            <div class="ms-auto" style="margin-right: 1rem;">
                <ul class="list-unstyled">
                    ...
                    <li class="<?php echo e(ViewClassNamesConstants::LNG_DD_IT); ?>">
                        <a
                            class="<?php echo e(ViewClassNamesConstants::DRP_NO_ARROW); ?>"
        ...
        <script defer>
            (() => {
                const ids = <?php echo json_encode($guardIds); ?>;
        ...
        <script defer>
            (() => {
                const ids = <?php echo json_encode($changeIds); ?>;
                const flagAttr = 'data-listener-active';
                ids.forEach(id => {
                    const el = document.getElementById(id);
                    if (!el || el.getAttribute(flagAttr) === 'true') return;
...
<?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>