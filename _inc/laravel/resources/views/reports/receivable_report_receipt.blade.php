...
$user = Auth::user();
        ...
        \Log::error('reports/receivable_report_receipt — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@endphp
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="4" class="{{ VC::TXCT }}">{{ __('No receivable customers available') }}</td>
                                                        </tr>
                                                    @endforelse
