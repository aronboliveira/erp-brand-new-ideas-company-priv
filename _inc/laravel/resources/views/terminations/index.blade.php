                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($terminations as $termination)
                                <tr>
                                    ...
                                    <td>{{ $user?->dateFormat($termination->notice_date) }}</td>
                                    <td>{{ $user?->dateFormat($termination->termination_date) }}</td>
                                    <td>
                                        ...
                                        <td>
                                            ...
                                            @can('delete termination')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Collective\Html\FormFacade::open(['method' => 'DELETE', 'route' => ['termination.destroy', $termination->id],'id'=>'delete-form-'.$termination->id]) !!}
