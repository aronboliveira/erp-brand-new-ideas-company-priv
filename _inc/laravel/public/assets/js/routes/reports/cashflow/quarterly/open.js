...
(() => {
    try {
        const host = document.documentElement, flag = "data-open-quarterly-cashflow-listener";
        ...
        document.addEventListener("click", function (e) {
            try {
                ...
                const msg = a.getAttribute("data-guard-msg") ??
                    "Quarterly cashflow report route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
