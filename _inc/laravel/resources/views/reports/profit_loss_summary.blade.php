    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
               href="{{ route(ViewsConstants::RPT . '.monthly.purchase') }}"
               onclick="window.location.href = '{{ route(ViewsConstants::RPT . '.monthly.purchase') }}'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                    {{ Collective\Html\FormFacade::open(array('route' => array(ViewsConstants::RPT . '.profit.loss.summary'),'method' => 'GET','id'=>'report_profit_loss_summary')) }}
                        <div class="row align-items-center justify-content-end">
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
{{--                                            {{ Collective\Html\FormFacade::label('period', __('Period'),['class'=>'form-label'])}}--}}
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="{{route(ViewsConstants::RPT . '.profit.loss.summary')}}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
