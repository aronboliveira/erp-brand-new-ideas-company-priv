...
(() => {
    try {
        const host = document.documentElement, flag = "data-reset-daily-purchase-listener";
        ...
        document.addEventListener("click", function (e) {
            try {
                ...
                const msg = a.getAttribute("data-guard-msg") ??
                    "Daily purchase reset route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
