/**
 * Auto-generated Playwright tests for documents routes
...
test.describe('documents.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/documents-create.html');
...
test.describe('documents.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/documents-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('documents.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/documents-index.html');
    await page.waitForLoadState('networkidle');
