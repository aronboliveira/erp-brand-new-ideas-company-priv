        ...
        <script defer>
            (() => {
                ...
                const renderCashFlow = () => {
                    ...
                    const options = {
                        series: [
                        { name: "<?php echo e(__('Income')); ?>", data: <?php echo !empty($incExpLineChartData['income']) ? json_encode($incExpLineChartData['income']) : '[]'; ?> },
                        { name: "<?php echo e(__('Expense')); ?>", data: <?php echo !empty($incExpLineChartData['expense']) ? json_encode($incExpLineChartData['expense']) : '[]'; ?> }
                        ],
                        chart: {
                        height: 250,
                        type: "area",
                        ...
                        xaxis: { categories: <?php echo json_encode($incExpLineChartData['day']); ?>, title: { text: "<?php echo e(__('Date')); ?>" } },
                        colors: ["#6fd944", "#ff3a6e"],
                        grid: { strokeDashArray: 4 },
                        legend: { show: false },
                        yaxis: { title: { text: "<?php echo e(__('Amount')); ?>" } }
                    };
                ...
                const renderIncExpBar = () => {
                    ...
                    const options = {
                        ...
                        stroke: { width: 2, curve: "smooth" },
                        series: [
                        { name: "<?php echo e(__('Income')); ?>", data: <?php echo !empty($incExpBarChartData['income']) ? json_encode($incExpBarChartData['income']) : '[]'; ?> },
                        { name: "<?php echo e(__('Expense')); ?>", data: <?php echo !empty($incExpBarChartData['expense']) ? json_encode($incExpBarChartData['expense']) : '[]'; ?> }
                        ],
                        xaxis: { categories: <?php echo json_encode($incExpBarChartData['month']); ?> },
                ...
                const renderIncomeByCategory = () => {
                    ...
                    const options = {
                        ...
                        dataLabels: { enabled: false },
                        plotOptions: { pie: { donut: { size: "70%" } } },
                        series: <?php echo !empty($incomeCatAmount) ? json_encode($incomeCatAmount) : '[]'; ?>,
                        colors: <?php echo !empty($incomeCategoryColor) ? json_encode($incomeCategoryColor) : '[]'; ?>,
                        labels: <?php echo !empty($incomeCategory) ? json_encode($incomeCategory) : '[]'; ?>,
                        legend: { show: true }
                    };
                    new ApexCharts(el, options).render();
                    } catch {
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="<?php echo e(VC::TB); ?>">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $bankAccountDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <?php
                                                ...
                                                <table class="<?php echo e(VC::TB_AL); ?> <?php echo e(VC::MB0); ?>">
                                                    <tbody class="list">
                                                        <tr>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($wTotal); ?></h4></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="<?php echo e(VC::MB0); ?>"><?php echo e(__('Total')); ?></h5>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($wPaid); ?></h4></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="<?php echo e(VC::MB0); ?>"><?php echo e(__('Total')); ?></h5>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($wDue); ?></h4></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="<?php echo e(VC::TB_AL); ?> <?php echo e(VC::MB0); ?>">
                                                    <tbody class="list">
                                                        <tr>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($mTotal); ?></h4></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="<?php echo e(VC::MB0); ?>"><?php echo e(__('Total')); ?></h5>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($mPaid); ?></h4></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h5 class="<?php echo e(VC::MB0); ?>"><?php echo e(__('Total')); ?></h5>
                                                            ...
                                                            <td><h4 class="text-muted"><?php echo e($mDue); ?></h4></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
