/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsPosVsPurchase.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsPosVsPurchase
 */
(() => {
    const listenerAttr = "data-pos-vs-purchase-listener-active", el = document.getElementById("pos-vs-purchase-report-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsPosVsPurchase] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsPosVsPurchase.js.map