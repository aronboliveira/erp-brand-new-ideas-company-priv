...
((): void => {
  try {
    ...
    const flag = "data-apply-expense-summary-listener";
      ...
      function (e) {
        try {
          ...
          const msg =
            ...
            a.getAttribute("data-guard-msg") ?? "Expense summary report route is unavailable. Please contact technical support or your domain administrator.";
