...
(() => {
    try {
        const host = document.documentElement, flag = "data-apply-monthly-attendance-listener";
        ...
        document.addEventListener("click", function (e) {
            try {
                const a = e.target &&
                    (e.target.closest
                        ? e.target.closest("a.apply-monthly-attendance")
                        : null);
                if (!a)
                    return;
                e.preventDefault();
                ...
                const msg = f.getAttribute("data-guard-msg") ??
                    "Monthly attendance apply route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
