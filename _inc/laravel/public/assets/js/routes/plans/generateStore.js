/**
 * @fileoverview TypeScript version of public/assets/js/routes/plans/generateStore.js
 * @generated from original JavaScript - manual review recommended
 * @module generateStore
 */
(() => {
    try {
        const anchors = Array.from(document.querySelectorAll("a.ai-btn[data-ajax-popup-over][data-url][data-guard-msg]"));
        if (anchors.length === 0)
            return;
        anchors.forEach(a => {
