...
@push(StacksConstants::ADM_SCR_PG)
    ...
    <script async>
        window.translations = {
            ...
            en:  { repeater_show_unavailable: 'Cannot show repeater', repeater_hide_unavailable: 'Cannot hide repeater', calc_unavailable: 'Calculation failed' },
            es:  { repeater_show_unavailable: 'Error al mostrar repetidor', repeater_hide_unavailable: 'Error al ocultar repetidor', calc_unavailable: 'Error en el cálculo' },
            fr:  { repeater_show_unavailable: 'Échec de l\'affichage du répéteur', repeater_hide_unavailable: 'Échec de la suppression du répéteur', calc_unavailable: 'Échec du calcul' },
            he:  { repeater_show_unavailable: 'הצגת החוזר נכשלה', repeater_hide_unavailable: 'הסתרת החוזר נכשלה', calc_unavailable: 'החישוב נכשל' },
            it:  { repeater_show_unavailable: 'Impossibile mostrare il ripetitore', repeater_hide_unavailable: 'Impossibile nascondere il ripetitore', calc_unavailable: 'Errore nel calcolo' },
            ja:  { repeater_show_unavailable: 'リピーターの表示に失敗しました', repeater_hide_unavailable: 'リピーターの非表示に失敗しました', calc_unavailable: '計算に失敗しました' },
            nl:  { repeater_show_unavailable: 'Herhaler weergeven mislukt', repeater_hide_unavailable: 'Herhaler verbergen mislukt', calc_unavailable: 'Berekening mislukt' },
            pl:  { repeater_show_unavailable: 'Nie można wyświetlić powtarzacza', repeater_hide_unavailable: 'Nie można ukryć powtarzacza', calc_unavailable: 'Błąd obliczeń' },
            pt:  { repeater_show_unavailable: 'Não foi possível exibir o repetidor', repeater_hide_unavailable: 'Não foi possível ocultar o repetidor', calc_unavailable: 'Falha no cálculo' },
            'pt-br': { repeater_show_unavailable: 'Não foi possível exibir o repetidor', repeater_hide_unavailable: 'Não foi possível ocultar o repetidor', calc_unavailable: 'Falha no cálculo' },
            ru:  { repeater_show_unavailable: 'Не удалось показать повторитель', repeater_hide_unavailable: 'Не удалось скрыть повторитель', calc_unavailable: 'Ошибка вычисления' },
...
@section(YieldingConstants::ADM_CTT)
    {{ Collective\Html\FormFacade::open(array('url' => 'journal-entry','class'=>'w-100')) }}
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="form-group">
                        ...
                        {{ Collective\Html\FormFacade::textarea('description', '', array('class' => 'form-control','rows'=>'2')) }}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0">
                                    {{ Collective\Html\FormFacade::select('account', $accounts,'', array('class' => 'form-control js-searchBox','required'=>'required')) }}
                                </td>

                                <td>
                                    <div class="form-group price-input">
                                        {{ Collective\Html\FormFacade::text('debit','', array('class' => 'form-control debit','required'=>'required','placeholder'=>__('Debit'),'required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input">
                                        {{ Collective\Html\FormFacade::text('credit','', array('class' => 'form-control credit','required'=>'required','placeholder'=>__('Credit'),'required'=>'required')) }}
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::text('description','', array('class' => 'form-control','placeholder'=>__('Description'))) }}
                                    </div>
                                </td>
