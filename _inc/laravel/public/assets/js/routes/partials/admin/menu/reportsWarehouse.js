/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsWarehouse.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsWarehouse
 */
(() => {
    const listenerAttr = "data-warehouse-listener-active", el = document.getElementById("warehouse-report-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsWarehouse] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsWarehouse.js.map