...
<html lang="<?php echo e($lang); ?>" dir="<?php echo e($siteRtl === 'on' ? 'rtl' : 'ltr'); ?>">
    <head>
        ...
        <?php if($colorSettings[SC::CST_DRK] ==='on' && is_file(asset('assets/css/custom-auth-dark.css'))): ?>
    ...
    <body class="<?php echo e($color); ?>">
        <div class="custom-login">
            ...
            <div class="bg-login <?php echo e(VC::BG_P); ?>"></div>
            <div class="custom-login-inner">
                <header class="<?php echo e(VC::DSH); ?>">
                    <nav class="<?php echo e(VC::NVB_DEF); ?>">
                        <div class="<?php echo e(VC::CT); ?>">
                            <div class="<?php echo e(VC::NVB_BR); ?>">
                            <a class="<?php echo e(VC::NVB_BR); ?>" href="#">
                                <?php
                                    $srcDark='';
                                    $srcLight='';
                                    $bgDark='';
                                ...
                                ?>
                                <?php if($colorSettings[SC::CST_DRK] === 'on'): ?>
                                    <img
                                        class="<?php echo e(VC::LOGO); ?>"
                            ...
                            <button class="<?php echo e(VC::NVB_TG); ?>" type="button" data-bs-toggle="collapse"
                                data-bs-target="#navbarlogin">
                                <span class="<?php echo e(VC::NVB_TG_IC); ?>"></span>
                            </button>
                            <div class="<?php echo e(VC::NVB_CLP); ?>" id="navbarlogin">
                                <ul class="<?php echo e(VC::NVB_NAV_LG); ?>">
                ...
                <footer>
                    <div class="<?php echo e(VC::AUT_FT); ?>">
                        <div class="<?php echo e(VC::CT); ?>">
                            <div class="<?php echo e(VC::RW); ?>">
                                <div class="col-12">
                                    <span>&copy; <?php echo e(date('Y')); ?>

                                        <?php echo e(Utility::getValByName(SC::FT_TXT) ?: config('app.name', 'Storego Saas')); ?>
