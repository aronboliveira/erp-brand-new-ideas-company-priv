/**
 * Auto-generated Playwright tests for award_types routes
...
test.describe('award_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/award_types-create.html');
...
test.describe('award_types.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/award_types-edit.html');
    await page.waitForLoadState('networkidle');
