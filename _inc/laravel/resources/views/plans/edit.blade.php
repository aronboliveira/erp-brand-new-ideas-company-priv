...
@if (isset($plan) && !empty($plan))
    {{Form::model($plan, array('route' => array(ViewsConstants::PLN.'.update', $plan->id), 'method' => 'PUT', 'enctype' => "multipart/form-data")) }}
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="{{ VC::FM_GCB6 }}">
                    {{Form::label('max_vendors',__('Maximum Vendors'),['class'=>'form-label'])}}
