...
/* eslint-disable @typescript-eslint/explicit-function-return-type, @typescript-eslint/no-base-to-string, @typescript-eslint/no-floating-promises, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unused-vars, @typescript-eslint/prefer-for-of, @typescript-eslint/restrict-plus-operands, no-console, no-var, prefer-const */
/* global ApexCharts, flatpickr, $, jQuery */
"use strict";
let Layout = (function () {
    function e(e) {
    ...
    const a = localStorage.getItem("sidenav-state")
    ...
    if (
      ...
      const n = $("[data-offset-top]"),
        o = $(n.data("offset-top")).height();
      n.css({ "padding-top": o + "px" });
    }
  })(),
  Popover = (function () {
    const e = $('[data-toggle="popover"]');
    e.length &&
      e.each(function () {
        !(function (e) {
          let t = "";
  ...
  PasswordText = (function () {
    const e = $('[data-toggle="password-text"]');
    e.length &&
    ...
    e.length &&
      t.on({
        click: function () {
          !(function (e) {
            e.data("pricing");
            const t = e.parents(".pricing-container"),
            ...
            e.hasClass("active") ||
              ...
              e.addClass("active"),
              a.each(function () {
                const e = $(this).data("pricing-value"),
  ...
  ScrollTo = (function () {
    const e = $(".scroll-me, [data-scroll-to], .toc-entry a"),
  ...
  SendEmail = (function () {
    ...
    e.length &&
      e.on("submit", function (e) {
        return (
          (function (e, a) {
            const n = e.find('button[type="submit"]').text();
            ...
            !(function (e) {
              ...
              if ("fullscreen" == e.data("spotlight")) {
                if (e.data("spotlight-offset")) {
                  const a = $("body").find(e.data("spotlight-offset")).height();
                  t = $(window).height() - a;
    ...
    void 0 !== n &&
      ...
      google.maps.event.addDomListener(
        ...
        (function (n) {
          ...
          const o = new google.maps.LatLng(e, t),
            i = {
              zoom: 12,
              scrollwheel: !1,
              center: o,
    ...
    void 0 !== a &&
      ...
      google.maps.event.addDomListener(
        ...
        (function (a) {
          ...
          const n = new google.maps.LatLng(e, t),
            o = {
              zoom: 12,
              scrollwheel: !1,
              center: n,
    ...
    return (
      ...
      e(this).each(function () {
        let a = e.extend(
          ...
          d = s.data("countTo") || {};
        function c(e) {
          const t = a.formatter.call(i, e, a);
          s.text(t);
        }
        (s.data("countTo", d),
...
(!(function (e) {
  ...
  ((t.prototype.init = function () {
    e('[data-toggle="dragula"]').each(function () {
      let t = e(this).data("containers"),
        a = [];
      if (t) for (let n = 0; n < t.length; n++) a.push(e("#" + t[n])[0]);
      else a = [e(this)[0]];
      const o = e(this).data("handle-class");
      o
        ? dragula(a, {
...
var Dropzones = (function () {
  ...
  Fullcalendar = (function () {
    ...
    a.length &&
      ...
      $("body").on("click", ".new-event--add", function () {
        const t = $(".new-event--title").val(),
          a = {
            Stored: [],
            Job: function () {
              const e = Date.now().toString().substr(6);
              return this.Check(e) ? this.Job() : (this.Stored.push(e), e);
            },
            Check: function (e) {
              for (let t = 0; t < this.Stored.length; t++)
      ...
      $("body").on("click", "[data-calendar-view]", function (t) {
        ...
        const a = $(this).attr("data-calendar-view");
  ...
  Highlight = (function () {
    $(".highlight").each(function (e, t) {
      !(function (e, t) {
        ...
        const a = new ClipboardJS(".btn-clipboard", {
          target: function (e) {
      ...
      e.each(function () {
        ...
        ((e = $(this)),
          ...
          (i = t.imagesLoaded(function () {
            ...
            const e = { itemSelector: ".masonry-item", filter: o };
            i.isotope(e);
          })),
  ...
  SingleSlider = (function () {
    const e = $(".input-slider-container");
    e.length &&
      e.each(function () {
        let e, t, a, n, o, i, s, r, l, d, c;
        ((e = $(this)),
  ...
  WpxSwiper = (function () {
    const e = $(".swiper-js-container");
    $(document).ready(function () {
      e.length &&
        e.each(function (e, t) {
          let a, n, o, i, s, r, l, d, c, u, p, g, f, h, m, v, y, b, w, C, k, x;
          ((a = $(t)),
  ...
  SparkChart = (function () {
    const e = $('[data-toggle="spark-chart"]');
    e.length &&
      e.each(function () {
        !(function (e) {
          const t = {
      ...
      e.each(function () {
        !(function (e) {
          const t = {
            ...
            n = e.data().height,
            o = e.data().type;
          ((t.colors = [SiteStyle.colors.theme[a]]),
            (t.markers.colors = [SiteStyle.colors.theme[a]]),
            (t.chart.height = n || 350),
            (t.chart.type = o || "line"));
          const i = new ApexCharts(e[0], t);
          setTimeout(function () {
    ...
    e.length &&
      e.each(function () {
        !(function (e) {
          ...
          ((t.series = [{ data: a }]),
            n && (t.labels = [n]),
            (t.colors = [SiteStyle.colors.theme[o]]),
            (t.chart.height = i || 35),
            (t.chart.type = s || "line"));
          const r = new ApexCharts(e[0], t);
          setTimeout(function () {
