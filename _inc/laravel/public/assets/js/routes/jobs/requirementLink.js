/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/requirementLink.js
 * @generated from original JavaScript - manual review recommended
 * @module requirementLink
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll("a.job-requirement-link[data-url][data-guard-msg]"));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[requirementLink] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=requirementLink.js.map