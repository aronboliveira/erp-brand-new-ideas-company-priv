/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/employee.js
 * @generated from original JavaScript - manual review recommended
 * @module employee
 */
(() => {
    const listenerAttr = "data-employee-listener-active", el = document.getElementById("employee-link");
