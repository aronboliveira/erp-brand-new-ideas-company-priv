...
((): void => {
  try {
    ...
    const flag = "data-reset-monthly-cashflow-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Monthly cashflow reset route is unavailable. Please contact technical support or your domain administrator.";
