/**
 * @fileoverview TypeScript version of public/assets/js/routes/bank/transfers/lang/payment.js
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      payment_popup_closed:
        "Sie haben das Fenster geschlossen, ohne die Zahlung abzuschließen.",
    ...
    fr: {
      ...
      payment_popup_closed:
        "Vous avez fermé la fenêtre avant de terminer le paiement.",
    ...
    it: {
      ...
      payment_popup_closed:
        "Hai chiuso il popup senza completare il pagamento.",
    ...
    nl: {
      ...
      payment_popup_closed:
        "Je hebt de popup gesloten zonder de betaling af te ronden.",
