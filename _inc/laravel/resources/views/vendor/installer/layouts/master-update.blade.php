...
<html lang="{{ $lang }}">
    <head>
        ...
        <title>@hasSection('template_title')@yield('template_title') | @endif{{ trans('installer_messages.updater.title') }}</title>
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header">
                    <h1 class="header__title">@yield('title', __('Could not find title'))</h1>
                </div>
                <ul class="step">
