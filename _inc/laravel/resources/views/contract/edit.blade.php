{{ Collective\Html\FormFacade::model($contract, array('route' => array('contract.update', $contract->id), 'method' => 'PUT')) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Collective\Html\FormFacade::label('project', __('Project'), ['class' => 'form-label']) }}
            <div class="project-div">
                {{ Collective\Html\FormFacade::select('project', $project, null, ['class' => 'form-control  project_select', 'id' => 'project_id', 'name' => 'project_id']) }}
            </div>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            {{ Collective\Html\FormFacade::number('value', null, array('class' => 'form-control','required'=>'required','stage'=>'0.01')) }}
        </div>
        <div class="form-group col-md-6">
