/**
 * @fileoverview TypeScript version of public/assets/js/routes/auth/passwords/email.js
    ...
    try {
        ...
        f.addEventListener("submit", (e) => {
            try {
                ...
                if (bsLink && window.bootstrap.Toast) {
                    ...
                    try {
                        ...
                        if (window.location.hostname === "localhost" ||
                            ...
                            console.error("[assets/js/routes/auth/passwordEmail.js] Bootstrap toast error:", 
                ...
                if (window.location.hostname === "localhost" ||
                    window.location.hostname === "127.0.0.1")
                    console.error("[assets/js/routes/auth/passwordEmail.js] Submit handler error:", 
                    err?.constructor?.name ?? "Error", 
                    err?.message ?? "Unknown error");
            }
        });
        ...
        if (window.location.hostname === "localhost" ||
            window.location.hostname === "127.0.0.1")
            console.error("[assets/js/routes/auth/passwordEmail.js] Initialization error:", 
