...
describe("arrayToJson", () => {
  test("is defined as a global function", () => {
    expect(typeof global.arrayToJson).toBe("function");
  });
  ...
  test("converts a simple form with text inputs", () => {
    ...
    const result = global.arrayToJson("#testForm");
  ...
  test("returns empty object for an empty form", () => {
    ...
    const result = global.arrayToJson("#emptyForm");
  ...
  test("handles select elements", () => {
    ...
    const result = global.arrayToJson("#selectForm");
  ...
  test("handles textarea elements", () => {
    ...
    const result = global.arrayToJson("#textareaForm");
  ...
  test("last value wins for duplicate field names", () => {
    ...
    const result = global.arrayToJson("#dupForm");
  ...
  test("handles checkbox (only checked ones serialize)", () => {
    ...
    const result = global.arrayToJson("#cbForm");
  ...
  test("handles hidden inputs", () => {
    ...
    const result = global.arrayToJson("#hiddenForm");
