/**
 * @fileoverview TypeScript version of public/assets/js/routes/leads/lang/order.js
...
(function (): void {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      leads_order_unavailable:
        "Lead-Reihenfolge konnte nicht aktualisiert werden.",
    ...
    es: {
      ...
      dragula_unavailable:
        "El complemento de arrastrar y soltar no está disponible.",
    ...
    fr: {
      ...
      leads_order_unavailable:
        "Impossible de mettre à jour l’ordre des prospects.",
