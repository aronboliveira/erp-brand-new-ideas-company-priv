(function () {
    ...
    const t = {
        ...
        da: {
            ...
            payment_redirect_unavailable: "Kunne ikke fortsætte med omdirigering efter betaling.",
        },
        de: {
            plugin_unavailable: "Erforderliche Bibliothek wurde nicht geladen.",
            route_unavailable: "Ungültige URL.",
            payment_init_unavailable: "Zahlungsformular konnte nicht initialisiert werden.",
            payment_redirect_unavailable: "Weiterleitung nach Zahlung fehlgeschlagen.",
        },
        en: {
            ...
            payment_redirect_unavailable: "Could not proceed with post-payment redirect.",
        },
        es: {
            ...
            payment_redirect_unavailable: "No se pudo continuar con la redirección después del pago.",
        },
        fr: {
            plugin_unavailable: "Une bibliothèque requise n’a pas été chargée.",
            route_unavailable: "URL non valide.",
            payment_init_unavailable: "Impossible d’initialiser le formulaire de paiement.",
        ...
        it: {
            ...
            payment_init_unavailable: "Impossibile inizializzare il modulo di pagamento.",
            payment_redirect_unavailable: "Impossibile procedere con il reindirizzamento post-pagamento.",
        },
        ja: {
            plugin_unavailable: "必要なライブラリが読み込まれていません。",
            route_unavailable: "無効なURLです。",
            payment_init_unavailable: "支払いフォームを初期化できませんでした。",
            payment_redirect_unavailable: "支払い後のリダイレクトを続行できませんでした。",
        },
        nl: {
            plugin_unavailable: "Een vereiste bibliotheek is niet geladen.",
            route_unavailable: "Ongeldige URL.",
            payment_init_unavailable: "Kon het betalingsformulier niet initialiseren.",
            payment_redirect_unavailable: "Kon doorgaan met doorverwijzing na betaling niet.",
        },
        pl: {
            plugin_unavailable: "Wymagana biblioteka nie została wczytana.",
            route_unavailable: "Nieprawidłowy adres URL.",
            payment_init_unavailable: "Nie udało się zainicjować formularza płatności.",
            payment_redirect_unavailable: "Nie można kontynuować przekierowania po płatności.",
        },
        pt: {
            plugin_unavailable: "Uma biblioteca necessária não foi carregada.",
            route_unavailable: "URL inválido.",
            payment_init_unavailable: "Não foi possível inicializar o formulário de pagamento.",
            payment_redirect_unavailable: "Não foi possível continuar o redirecionamento após o pagamento.",
        },
        "pt-br": {
            plugin_unavailable: "Uma biblioteca necessária não foi carregada.",
        ...
        ru: {
            ...
            payment_redirect_unavailable: "Не удалось выполнить перенаправление после оплаты.",
        },
        tr: {
