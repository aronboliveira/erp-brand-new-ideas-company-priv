    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for income vs expense summary is unavailable. Please contact technical support or your domain administrator.";
