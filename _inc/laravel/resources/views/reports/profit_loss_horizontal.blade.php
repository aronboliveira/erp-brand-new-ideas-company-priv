...
@section(YieldingConstants::ADM_ACT_BTN)
    ...
    <div class="float-end">
        {{ Collective\Html\FormFacade::open(['route' => ['profit.loss.print' , 'horizontal']]) }}
    ...
    <div class="float-end me-2">
        <a href="{{ route(ViewsConstants::RPT . '.profit.loss', 'vertical') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
