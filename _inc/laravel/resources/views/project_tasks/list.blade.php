                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="d-flex text-sm text-muted justify-content-between">
                                            ...
                                            <span class="me-5 badge p-2 px-3 rounded bg-{{ ($checkProject == 'Owner') ? ProjectsConstants::STT_SCS : ProjectsConstants::STT_WRN  }}">
                                                {{ __($checkProject) }}</span>
                                        </span>
                                    </td>
                                    <td>{{ $task->stage->name }}</td>
                                    <td>
                                        <span class="status_badge badge p-2 px-3 rounded bg-{{__(ProjectTask::$priority_color[$task->priority])}}">{{ __(ProjectTask::$priority[$task->priority]) }}</span>
                                    </td>
