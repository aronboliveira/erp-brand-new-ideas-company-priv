            ...
            <div class="col-sm-9 text-end me-2">
                ...
                @if((($user?->type =='company') && ($contract->company_signature == '')||($user?->type =='client') && ($contract->client_signature == ''))&&$contract->status == 'Start')
                        <a href="#" class="btn btn-sm btn-primary btn-icon m-" data-bs-toggle="modal"
                            ...
                            data-bs-whatever="{{__('signature')}}" > <span class="text-white"> 
                                <i
                                    class="{{ ViewClassNamesConstants::TI_PC_WT }}" data-bs-toggle="tooltip" data-bs-original-title="{{__('signature')}}">
                                </i>
                            </span>
                        </a>
                        @endif
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-sm-6 mb-3 mb-sm-0 mt-3">
                                ...
                                <div class="col-lg-6 col-md-8">
                                    ...
                                    <span class="col-md-8"><span class="text-md">{{ $user?->priceFormat($contract->value) }}</span></span>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div class="float-end">
                                        <div class="">
                                            ...
                                            <span class="col-md-8"><span class="text-md">{{ $user?->dateFormat($contract->start_date) }}</span></span>
                                        </div>
                                        <div class="mt-3">
                                            <h6 class="d-inline-block m-0 d-print-none">{{__('End Date   :')}}</h6>
                                            <span class="col-md-8"><span class="text-md">{{ $user?->dateFormat($contract->end_date)}}</span></span>
                                        </div>
                                    </div>
