                                ...
                                <div data-v-1ad6e3b9 class="d-inner d-no-pad" style="border-top:15px solid {{ $color }}; border-bottom:15px solid {{ $color }}">
                                            ...
                                            <table data-v-1ad6e3b9 class="summary-table">
                                                <tbody data-v-1ad6e3b9>
                                                    <tr data-v-1ad6e3b9>
                                                        ...
                                                        <td data-v-1ad6e3b9 class="{{ VC::TX_END }}">
                                    ...
                                    <div data-v-1ad6e3b9 class="d-inner-2">
                                        <div data-v-1ad6e3b9 class="row">
                                            <div data-v-1ad6e3b9 class="{{ VC::C2 }}">
                                        ...
                                        <div data-v-1ad6e3b9 class="d-table">
                                            <div data-v-1ad6e3b9 class="d-table">
                                                <div data-v-1ad6e3b9 class="tu d-table-tr" style="background: {{ $color }}; color: {{ $font_color }}">
                                                    ...
                                                    <div data-v-1ad6e3b9 class="d-table-th w-3 {{ VC::TX_END }}" style="padding:5px;">{{ __('Amount') }}</div>
                                                </div>
                                                        ...
                                                        @foreach($items as $key => $item)
                                                            @php
                                                                try {
                                                                    ...
                                                                    \Log::error('estimations/templates/template7 — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
                                                                }
@endphp
                                                            <div data-v-1ad6e3b9 class="d-table-tr">
                                                                ...
                                                                <div data-v-1ad6e3b9 class="d-table-td w-3 {{ VC::TX_END }}" style="border:1px solid {{ $color }}; padding:5px;">
                                                                    <span data-v-1ad6e3b9>
                                                                        @if(!is_null($lt))
                                                    ...
                                                    @else
                                                        <div data-v-1ad6e3b9 class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9 class="d-table-td w-3 {{ VC::TX_END }}" style="border:1px solid {{ $color }}; padding:5px;"><span data-v-1ad6e3b9>-</span></div>
                                                        </div>
                                                    @endif
                                                </div>
