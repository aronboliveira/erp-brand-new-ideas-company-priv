(function () {
    ...
    const t = {
        ...
        de: {
            env_toggle_unavailable: "Umgebungsansicht konnte nicht umgeschaltet werden.",
            tab_db_unavailable: "Datenbankeinstellungen konnten nicht geöffnet werden.",
            tab_app_unavailable: "Anwendungseinstellungen konnten nicht geöffnet werden.",
        ...
        fr: {
            ...
            tab_db_unavailable: "Impossible d’ouvrir les paramètres de base de données.",
            tab_app_unavailable: "Impossible d’ouvrir les paramètres de l’application.",
        ...
        pt: {
            ...
            tab_db_unavailable: "Não foi possível abrir as Definições de Base de Dados.",
        ...
        "pt-br": {
            ...
            tab_app_unavailable: "Não foi possível abrir as Configurações do Aplicativo.",
            plugin_unavailable: "Uma biblioteca necessária não foi carregada.",
        },
        ru: {
