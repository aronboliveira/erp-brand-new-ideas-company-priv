...
((): void => {
  try {
    ...
    const flag = "data-download-monthly-cashflow-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for monthly cashflow reports is unavailable. Please contact technical support or your domain administrator.";
