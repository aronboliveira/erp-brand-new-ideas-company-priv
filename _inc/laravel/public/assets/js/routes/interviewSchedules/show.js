 ...
 */
(() => {
    const DEFAULT_ROUTE_MSG = "Requested route is unavailable. Please contact technical support or your domain administrator.";
    const toast = (message) => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document
            .querySelectorAll(".modal-body a[data-guard-msg], .modal-body a[data-url]")
            .forEach(el => bindLinkGuard(el));
        document
            .querySelectorAll(".modal-body form[data-guard-msg], .modal-body form[data-url]")
