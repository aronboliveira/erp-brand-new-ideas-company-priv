/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/incomeSummary.js
 * @generated from original JavaScript - manual review recommended
 * @module incomeSummary
 */
(() => {
    const listenerAttr = "data-income-summary-listener-active", el = document.getElementById("income-summary-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[incomeSummary] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=incomeSummary.js.map