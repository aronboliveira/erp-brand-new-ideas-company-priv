(() => {
    ...
    const t = {
        ...
        fr: {
            zoom_users_unavailable: "Impossible de charger les utilisateurs du projet",
        },
        ...
        pt: {
            zoom_users_unavailable: "Não foi possível carregar os utilizadores do projeto",
        },
        "pt-br": {
            zoom_users_unavailable: "Não foi possível carregar os usuários do projeto",
        },
        ru: {
