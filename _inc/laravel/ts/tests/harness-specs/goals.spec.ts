/**
 * Auto-generated Playwright tests for goals routes
...
test.describe('goals.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/goals-create.html');
...
test.describe('goals.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/goals-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('goals.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/goals-index.html');
    await page.waitForLoadState('networkidle');
