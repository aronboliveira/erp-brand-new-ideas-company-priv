/**
 * Auto-generated Playwright tests for announcements routes
...
test.describe('announcements.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/announcements-create.html');
...
test.describe('announcements.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/announcements-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('announcements.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/announcements-index.html');
    await page.waitForLoadState('networkidle');
