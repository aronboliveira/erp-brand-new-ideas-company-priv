/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/delete.js
 * @generated from original JavaScript - manual review recommended
 * @module delete
 */
(() => {
    try {
        const selector = ".delete-invoice-link", alias = "data-listening-deleteinvoiceclick";
                ...
                el.addEventListener("click", event => {
                    ...
                    if ((!url || url === "#") && (!href || href === "#")) {
                        ...
                        const msg = el.getAttribute("data-guard-msg") ??
                            "Delete invoice route is unavailable. Please contact technical support or your domain administrator.";
                        if (hasBS) {
