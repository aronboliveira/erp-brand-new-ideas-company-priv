            ...
            <div class="row justify-content-between align-items-center mb-3">
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    <div class="all-button-box mx-2">
                        <a href="{{ route(ViewsConstants::BIL.'.pdf', Crypt::encrypt($bill->id))}}" target="_blank" class="btn btn-primary mt-3">
                            {{__('Download')}}
                        </a>
                    </div>
                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <small>
                                                ...
                                                @if($bill->status == 0)
                                                    <span class="badge bg-primary">{{ __(Bill::$statuses[$bill->status]) }}</span>
                                                @elseif($bill->status == 1)
                                                    <span class="badge bg-warning">{{ __(Bill::$statuses[$bill->status]) }}</span>
                                                @elseif($bill->status == 2)
                                                    <span class="badge bg-danger">{{ __(Bill::$statuses[$bill->status]) }}</span>
                                                @elseif($bill->status == 3)
                                                    <span class="badge bg-info">{{ __(Bill::$statuses[$bill->status]) }}</span>
