/**
 * Auto-generated Playwright tests for debit_notes routes
...
test.describe('debit_notes.custom_create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/debit_notes-custom_create.html');
...
test.describe('debit_notes.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/debit_notes-index.html');
    await page.waitForLoadState('networkidle');
