...
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="loan-delete-form-"][data-url][data-guard-msg]')) ?? [];
        forms.forEach(fm => {
            try {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="loan-delete-link-"][data-url][data-guard-msg]')) ?? [];
        links.forEach(l => {
            try {
