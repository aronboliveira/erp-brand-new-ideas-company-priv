...
((): void => {
  try {
    ...
    const flag = "data-download-expenses-summary-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for expenses summaries report is unavailable. Please contact technical support or your domain administrator.";
