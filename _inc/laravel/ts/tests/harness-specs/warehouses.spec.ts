/**
 * Auto-generated Playwright tests for warehouses routes
...
test.describe('warehouses.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/warehouses-create.html');
...
test.describe('warehouses.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/warehouses-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('warehouses.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/warehouses-index.html');
    await page.waitForLoadState('networkidle');
