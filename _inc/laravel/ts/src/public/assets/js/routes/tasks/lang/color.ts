/**
 * @fileoverview TypeScript version of public/assets/js/routes/tasks/lang/color.js
...
(function (): void {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      color_update_unavailable:
        "Prioritätsfarbe konnte nicht aktualisiert werden.",
    },
    en: {
    ...
    fr: {
      ...
      color_update_unavailable:
        "Impossible de mettre à jour la couleur de priorité.",
    },
    he: {
