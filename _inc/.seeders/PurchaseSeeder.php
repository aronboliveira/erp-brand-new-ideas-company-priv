...
class PurchaseSeeder extends Seeder
{
	 ...
	 */
	// private const HARD_CAP_ATTEMPTS = 512 * 6;
	private const HARD_CAP_ATTEMPTS = 2;
	...
	public function run(): void
	{
		...
		while ($created < $target) {
			...
			try {
				...
				// Ownership
				$this->setIfColumnExists($m, $purchasesTable, DC::COL_TABLE_CREATOR, DC::DEFAULT_UUID);
				$this->setIfColumnExists($m, $purchasesTable, DC::COL_TABLE_UPDATER, DC::DEFAULT_UUID);
