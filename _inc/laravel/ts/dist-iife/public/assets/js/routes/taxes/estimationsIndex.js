 ...
 * @module estimationsIndex
 */
(() => {
    try {
        const a = document.getElementById("tax-index-link");
        if (!a)
            return;
        ...
        a.addEventListener("click", (e) => {
            try {
                ...
                const msg = a.getAttribute("data-guard-msg") ??
                    "Tax index route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                    window.bootstrap);
