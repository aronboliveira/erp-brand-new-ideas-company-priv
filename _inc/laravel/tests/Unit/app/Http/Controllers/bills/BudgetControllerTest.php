...
use App\Http\Controllers\Bills\BudgetController;
 ...
 * 
 * @covers \App\Http\Controllers\Bills\BudgetController
 */
class BudgetControllerTest extends TestCase
{
    use ControllerTestHelper;

    public function test_constant_Y_M_equals_yearMonth_1(): void
    {
        $this->assertSame('yearMonth', BudgetController::Y_M);
    }

    public function test_constant_Y_L_equals_yearList_2(): void
    {
        $this->assertSame('yearList', BudgetController::Y_L);
    }

    public function test_constant_IDX_equals_index_3(): void
    {
        $this->assertSame('index', BudgetController::IDX);
    }

    public function test_constant_CRT_equals_create_4(): void
    {
        $this->assertSame('create', BudgetController::CRT);
    }

    public function test_constant_STR_equals_store_5(): void
    {
        $this->assertSame('store', BudgetController::STR);
    }

    public function test_constant_SHW_equals_show_6(): void
    {
        $this->assertSame('show', BudgetController::SHW);
    }

    public function test_constant_EDT_equals_edit_7(): void
    {
        $this->assertSame('edit', BudgetController::EDT);
    }

    public function test_constant_UPD_equals_update_8(): void
    {
        $this->assertSame('update', BudgetController::UPD);
    }

    public function test_constant_DEL_equals_destroy_9(): void
    {
        $this->assertSame('destroy', BudgetController::DEL);
    }
    ...
    public function test_show_empty_28(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
    ...
    public function test_show_special_29(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
    ...
    public function test_edit_empty_32(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
    ...
    public function test_edit_special_33(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
    ...
    public function test_yearMonth_36(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearMonth($this->makeRequest());
    ...
    public function test_yearMonth_empty_post_37(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearMonth($this->makeRequest('/', 'POST', []));
            $this->assertTrue(is_array($result), 'Expected array return type');
            } catch (\Symfony\Component\Routing\Exception\RouteNotFoundException $e) {
                $this->assertNotEmpty($e->getMessage());
                return;
    ...
    public function test_yearMonth_json_38(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearMonth($this->makeRequest('/', 'GET', [], true));
            $this->assertTrue(is_array($result), 'Expected array return type');
            } catch (\Symfony\Component\Routing\Exception\RouteNotFoundException $e) {
                $this->assertNotEmpty($e->getMessage());
                return;
     ...
     * @group performance
     */
    public function test_yearMonth_performance_39(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        ...
        try {
            for ($i = 0; $i < 3; $i++) {
                $ctrl->yearMonth($this->makeRequest());
            }
        } catch (\Throwable $e) {
            // Method may throw, that's OK for perf test
        }
    ...
    public function test_yearList_40(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearList($this->makeRequest());
            $this->assertTrue(is_array($result), 'Expected array return type');
            } catch (\Symfony\Component\Routing\Exception\RouteNotFoundException $e) {
                $this->assertNotEmpty($e->getMessage());
                return;
    ...
    public function test_yearList_empty_post_41(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearList($this->makeRequest('/', 'POST', []));
            $this->assertTrue(is_array($result), 'Expected array return type');
            } catch (\Symfony\Component\Routing\Exception\RouteNotFoundException $e) {
                $this->assertNotEmpty($e->getMessage());
                return;
    ...
    public function test_yearList_json_42(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        try {
            $result = $ctrl->yearList($this->makeRequest('/', 'GET', [], true));
            $this->assertTrue(is_array($result), 'Expected array return type');
            } catch (\Symfony\Component\Routing\Exception\RouteNotFoundException $e) {
                $this->assertNotEmpty($e->getMessage());
                return;
     ...
     * @group performance
     */
    public function test_yearList_performance_43(): void
    {
        $this->loginMockUser();
        $ctrl = new BudgetController();
        ...
        try {
            for ($i = 0; $i < 3; $i++) {
                $ctrl->yearList($this->makeRequest());
            }
        } catch (\Throwable $e) {
            // Method may throw, that's OK for perf test
        }
