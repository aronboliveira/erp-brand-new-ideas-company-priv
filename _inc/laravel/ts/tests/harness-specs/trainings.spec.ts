/**
 * Auto-generated Playwright tests for trainings routes
...
test.describe('trainings.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/trainings-create.html');
...
test.describe('trainings.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/trainings-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('trainings.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/trainings-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('trainings.show', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/trainings-show.html');
    await page.waitForLoadState('networkidle');
