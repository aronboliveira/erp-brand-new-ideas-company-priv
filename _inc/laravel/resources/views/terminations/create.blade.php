...
$lang ??= 'en';
	...
	$tmnBaseName ??= '';
	$tmnKebabBaseName ??= '';
	$terminationStoreResolved ??= null;
	$terminationStoreUrl ??= '#';
	$terminationStoreGuardMsg ??= '';
	...
	try {
		...
		$terminationStoreGuardMsg = Utility::fetchLinkMessage($lang, ViewsConstants::TMN, 'route_store_termination_unavailable')
		...
		$generateGuardMsg = Utility::fetchLinkMessage($lang, ViewsConstants::TMN, 'route_generate_termination_unavailable')
			?? 'Generate termination route is unavailable. Please contact technical support or your domain administrator.';
	} catch (\Error $e) {
		Log::error('Error in terminations/create.blade.php main @php block', [
		...
		Log::error('Exception in terminations/create.blade.php main @php block', [
			'exception_class' => get_class($e),
			'message' => $e->getMessage(),
			'file' => $e->getFile(),
			'line' => $e->getLine(),
		...
		Log::error('Throwable in terminations/create.blade.php main @php block', [
			'exception_class' => get_class($e),
			'message' => $e->getMessage(),
			'file' => $e->getFile(),
			'line' => $e->getLine(),
