...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/receipts.js
 * @generated from original JavaScript - manual review recommended
 * @module receipts
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="ibt-download-receipt-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
