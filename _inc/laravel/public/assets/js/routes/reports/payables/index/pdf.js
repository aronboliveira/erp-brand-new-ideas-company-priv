/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/payables/index/pdf.js
...
(function () {
    ...
    const showErrorNow = (message) => {
        ...
        if (hasBootstrap) {
            ...
            const body = t ? qs(".toast-body", t) : null;
            if (body)
    ...
    const syncDates = () => {
        try {
            const startVal = String($(".startDate").val() ?? ""), endVal = String($(".endDate").val() ?? "");
