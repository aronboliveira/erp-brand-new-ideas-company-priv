/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/otherPaymentStore.js
 * @generated from original JavaScript - manual review recommended
 * @module otherPaymentStore
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="other-payment-store-form-"][data-url][data-guard-msg]')) ?? [];
        if (forms.length === 0)
            return;
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[otherPaymentStore] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=otherPaymentStore.js.map