...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/companyPolicies/generate.js
            ...
            link.addEventListener("click", (e) => {
                try {
                    ...
                    const msg = link.getAttribute("data-guard-msg") ??
                        "Generate AI company policy route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
