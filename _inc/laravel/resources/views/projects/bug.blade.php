...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        @can('manage bug report')
            <a href="{{ route(ViewsConstants::PRJ_TSK_BUG . '.kanban',$project->id) }}" data-bs-toggle="tooltip" title="{{__('Kanban')}}" class="btn btn-sm btn-primary">
                                    ...
                                    <td class="Action" width="10%">
                                        @can('edit bug report')
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" data-size="lg" class="mx-3 btn btn-sm  align-items-center" data-url="{{ route(ViewsConstants::PRJ_TSK_BUG . '.edit',[$project->id,$bug->id]) }}" data-ajax-popup="true" data-size="xl" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-title="{{__('Edit Bug')}}">
