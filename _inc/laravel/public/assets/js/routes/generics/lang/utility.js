(() => {
    ...
    const t = {
        ar: {
            route_unavailable: "هذا المسار غير متاح في الوقت الحالي. يرجى المحاولة مرة أخرى لاحقًا.",
        },
        da: {
        ...
        en: {
            route_unavailable: "This route is unavailable at the moment. Please try again later.",
        },
        es: {
