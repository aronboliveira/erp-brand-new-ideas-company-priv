# Finance/Admin Learning ERP — Project Constraints & Coding Standards
...
- **NEVER** edit existing migration files. Add a new migration only when the
  current task explicitly requires schema expansion.
