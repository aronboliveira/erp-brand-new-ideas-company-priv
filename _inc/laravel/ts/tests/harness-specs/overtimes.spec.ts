/**
 * Auto-generated Playwright tests for overtimes routes
...
test.describe('overtimes.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/overtimes-create.html');
...
test.describe('overtimes.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/overtimes-edit.html');
    await page.waitForLoadState('networkidle');
