...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/routes/invoices/theme3.css') }}">
                        ...
                        @foreach($invoice->itemData as $key => $item)
                            @php
                                try {
                                    ...
                                    \Log::error('invoices/templates/template3 — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
                                }
@endphp
