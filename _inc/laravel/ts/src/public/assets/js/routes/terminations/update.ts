/**
 * @fileoverview TypeScript version of public/assets/js/routes/terminations/update.js
  ...
  try {
    ...
    f.addEventListener("submit", e => {
      try {
        ...
        const msg =
          f.getAttribute("data-guard-msg") ?? "Update termination route is unavailable. Please contact technical support or your domain administrator.";
