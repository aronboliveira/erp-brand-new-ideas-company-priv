                                ...
                                <div data-v-b8f60a0c class="d-inner">
                                    <div data-v-b8f60a0c class="row">
                                        <div data-v-b8f60a0c class="col-33">
                                            <h1 data-v-b8f60a0c class="fancy-title tu mb5" style="color: {{ $color === '#ffffff' ? 'black' : $color }}; border-top:15px solid {{ $color }}">{{ __('ESTIMATION') }}</h1>
                                        </div>
                                        <div data-v-b8f60a0c class="col-33"></div>
                                        <div data-v-b8f60a0c class="col-33">
                                            <img data-v-b8f60a0c style="max-width:200px;" class="d-logo" src="{{ $imgSrc }}">
                                        </div>
                                    </div>
                                    <div data-v-b8f60a0c class="break-50"></div>
                                    <div data-v-b8f60a0c class="row">
                                        <div data-v-b8f60a0c class="col-66">
                                            <strong data-v-b8f60a0c class="tu mb5" style="color: {{ $color === '#ffffff' ? 'black' : $color }};">{{ __('From') }}:</strong>
                                            <p data-v-b8f60a0c>{{ ($settings['company_name'] ?? '') !== '' ? $settings['company_name'] : __('No company name available') }}</p>
                                            <pre data-v-b8f60a0c>{{ ($settings['company_address'] ?? '') !== '' ? $settings['company_address'] : __('No address available for company') }}</pre>
                                            <p data-v-b8f60a0c>
                                            ...
                                            <p data-v-b8f60a0c>{{ (($settings['company_country'] ?? '') !== '') ? $settings['company_country'] : __('No country available for company') }}</p>
                                        </div>
                                        <div data-v-b8f60a0c class="col-33">
                                            <table data-v-b8f60a0c class="summary-table">
                                                <tbody data-v-b8f60a0c>
                                                    <tr data-v-b8f60a0c>
                                                        ...
                                                        <td data-v-b8f60a0c class="{{ VC::TX_END }}">
                                    ...
                                    <div data-v-b8f60a0c class="row">
                                        <div data-v-b8f60a0c class="{{ VC::C2 }}">
                                            <div data-v-b8f60a0c class="col-66">
                                                <strong data-v-b8f60a0c class="tu mb5" style="color: {{ $color === '#ffffff' ? 'black' : $color }};">{{ __('To') }}:</strong>
                                                <p data-v-b8f60a0c>{{ isset($client->name) && $client->name !== '' ? $client->name : __('No client name available') }}</p>
                                                <pre data-v-b8f60a0c>{{ isset($client->email) && $client->email !== '' ? $client->email : __('No client email available') }}</pre>
                                            </div>
                                        </div>
                                    </div>
                                    <div data-v-b8f60a0c class="break-25"></div>
                                    <div data-v-b8f60a0c class="d-table">
                                        <div data-v-b8f60a0c class="d-table">
                                            <div data-v-b8f60a0c class="tu d-table-tr" style="color: {{ $color === '#ffffff' ? 'black' : $color }}; border-bottom:1px solid {{ $color }}; border-top:1px solid {{ $color }}">
                                                ...
                                                <div data-v-b8f60a0c class="d-table-th w-3 {{ VC::TX_END }}">{{ __('Amount') }}</div>
                                            </div>
                                                    ...
                                                    @foreach($items as $key => $item)
                                                        @php
                                                            try {
                                                                ...
                                                                \Log::error('estimations/templates/template10 — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
                                                            }
@endphp
                                                        <div data-v-b8f60a0c class="d-table-tr" style="border-bottom:1px solid {{ $border_color }}">
                                                            <div data-v-b8f60a0c class="d-table-td w-2"><span data-v-b8f60a0c>{{ (int)$key + 1 }}</span></div>
                                                            <div data-v-b8f60a0c class="d-table-td w-13">
                                                                <pre data-v-b8f60a0c>{{ isset($item->name) && $item->name !== '' ? $item->name : __('No item name available') }}<br data-v-b8f60a0c></pre>
                                                            </div>
                                                            <div data-v-b8f60a0c class="d-table-td w-3">
                                                                <span data-v-b8f60a0c>
                                                                    @if(!is_null($p))
                                                            ...
                                                            <div data-v-b8f60a0c class="d-table-td w-2"><span data-v-b8f60a0c>{{ !is_null($q) ? $q : __('No quantity available') }}</span></div>
                                                            <div data-v-b8f60a0c class="d-table-td w-3 {{ VC::TX_END }}">
                                                                <span data-v-b8f60a0c>
                                                                    @if(!is_null($lt))
                                                ...
                                                @else
                                                    <div data-v-b8f60a0c class="d-table-tr" style="border-bottom:1px solid {{ $border_color }}">
                                                        ...
                                                        <div data-v-b8f60a0c class="d-table-td w-13"><pre data-v-b8f60a0c>-<br data-v-b8f60a0c></pre></div>
                                                        <div data-v-b8f60a0c class="d-table-td w-3"><span data-v-b8f60a0c>-</span></div>
                                                        <div data-v-b8f60a0c class="d-table-td w-2"><span data-v-b8f60a0c>-</span></div>
                                                        <div data-v-b8f60a0c class="d-table-td w-3 {{ VC::TX_END }}"><span data-v-b8f60a0c>-</span></div>
                                                    </div>
                                                @endif
                                            </div>
                                            <div data-v-b8f60a0c class="d-table-footer">
                                                ...
                                                <div data-v-b8f60a0c class="d-table-summary">
                                                    <div data-v-b8f60a0c class="d-table-summary-item">
                                                        ...
                                                        <div data-v-b8f60a0c class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($subTotalVal) : number_format($subTotalVal, 2) }}</div>
                                                    </div>
                                                    @if($discountVal > 0)
                                                        <div data-v-b8f60a0c class="d-table-summary-item">
                                                            <div data-v-b8f60a0c class="tu d-table-label">{{ __('Discount') }}:</div>
                                                            <div data-v-b8f60a0c class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($discountVal) : number_format($discountVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    @if($taxVal > 0)
                                                        <div data-v-b8f60a0c class="d-table-summary-item">
                                                            <div data-v-b8f60a0c class="tu d-table-label">{{ (data_get($estimation,'tax.name') ?: __('Tax')) }} ({{ (string)(data_get($estimation,'tax.rate') ?? '0') }}%):</div>
                                                            <div data-v-b8f60a0c class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($taxVal) : number_format($taxVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-b8f60a0c class="d-table-summary-item" style="color: {{ $font_color }}; background: {{ $color }}">
                                                        ...
                                                        <div data-v-b8f60a0c class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($totalVal) : number_format($totalVal, 2) }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
