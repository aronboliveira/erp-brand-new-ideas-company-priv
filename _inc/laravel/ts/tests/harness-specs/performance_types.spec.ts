/**
 * Auto-generated Playwright tests for performance_types routes
...
test.describe('performance_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/performance_types-create.html');
...
test.describe('performance_types.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/performance_types-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('performance_types.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/performance_types-index.html');
    await page.waitForLoadState('networkidle');
