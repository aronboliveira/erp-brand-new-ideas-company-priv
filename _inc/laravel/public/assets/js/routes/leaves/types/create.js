...
(() => {
    try {
        const selector = ".create-leavetype-link", alias = "data-listening-createleavetypeclick";
                ...
                el.addEventListener("click", event => {
                    ...
                    if ((!url || url === "#") && (!href || href === "#")) {
                        ...
                        const msg = el.getAttribute("data-guard-msg") ??
                            "Create leave type route is unavailable. Please contact technical support or your domain administrator.";
                        if (hasBS) {
