...
trait TracksFailures
{
	...
	protected static function bootTracksFailures(): void
	{
	    try {
	        ...
	        Log::error(static::class . '::bootTracksFailures — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected function addFailureTrackingColumns(Blueprint $table): void
	{
	    try {
	        ...
	        Log::error(static::class . '::addFailureTrackingColumns — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function alignFailureTrackingColumns(Model $model, string $table): void
	{
	    try {
	        ...
	        Log::error(static::class . '::alignFailureTrackingColumns — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function normalizeErrorLog(mixed $value): ?array
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeErrorLog — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
	...
	protected static function hasFailureColumnCached(string $table, string $column): bool
	{
	    try {
	        ...
	        Log::error(static::class . '::hasFailureColumnCached — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return false;
	    }
	}
}
