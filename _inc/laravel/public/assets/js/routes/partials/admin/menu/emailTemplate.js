/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/emailTemplate.js
 * @generated from original JavaScript - manual review recommended
 * @module emailTemplate
 */
(() => {
    const listenerAttr = "data-email-template-listener-active", el = document.getElementById("email-template-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("email-template-link"))
            observer.disconnect();
    });
