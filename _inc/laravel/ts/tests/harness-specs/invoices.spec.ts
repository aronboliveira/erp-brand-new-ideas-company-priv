/**
 * Auto-generated Playwright tests for invoices routes
...
test.describe('invoices.action', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-action.html');
...
test.describe('invoices.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/invoices-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.customer_invoice', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-customer_invoice.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.paymentwall', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-paymentwall.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.script', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/invoices-script.html');
    await page.waitForLoadState('networkidle');
...
test.describe('invoices.view', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/invoices-view.html');
    await page.waitForLoadState('networkidle');
