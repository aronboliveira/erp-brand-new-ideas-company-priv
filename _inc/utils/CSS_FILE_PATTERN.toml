...
- For styles that apply ONLY to specific elements (like toast and popups) that mount/unmount frequently, you can place them write them as .module.css and place into a dedicated folder for module styles;
