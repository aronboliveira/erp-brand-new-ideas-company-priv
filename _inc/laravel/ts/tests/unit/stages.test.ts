/**
 * Jest unit tests for stages routes
...
describe('stages.index', () => {
  // TypeScript sources: src/public/assets/js/routes/stages/reorder
  // Import would be: import * as module0 from 'src/public/assets/js/routes/stages/reorder';
