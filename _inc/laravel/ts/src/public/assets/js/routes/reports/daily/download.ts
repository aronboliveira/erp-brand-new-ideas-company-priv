/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/daily/download.js
...
((): void => {
  try {
    document.querySelectorAll(".download-pdf-link").forEach((el: Element): void => {
      try {
