/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/export.js
    ...
    if (!el.hasAttribute(alias)) {
      ...
      el.addEventListener("click", event => {
        ...
        if ((!url || url === "#") && (!href || href === "#")) {
          ...
          const msg =
            el.getAttribute("data-guard-msg") ?? "Export route is unavailable. Please contact technical support or your domain administrator.";
          if (hasBS) {
