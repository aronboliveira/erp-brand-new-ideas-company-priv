        ...
        f.addEventListener("submit", (e) => {
            try {
                ...
                const msgAttr = f.hasAttribute("data-guard-msg")
                    ...
                    : "", msg = (msgAttr ?? "").trim().length > 0
                    ? msgAttr
                    : "Update termination type route is unavailable. Please contact technical support or your domain administrator.", bootstrapLink = document.querySelector('link[href*="bootstrap"]'), hasBootstrap = bootstrapLink && typeof window.bootstrap.Toast !== "undefined";
