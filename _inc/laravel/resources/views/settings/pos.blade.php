                        ...
                        <div class="bg-none">
                            <div class="row company-setting">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="purchase_template">
                                                    @foreach(Utility::templateData()['templates'] as $key => $template)
                                                        <option value="{{$key}}" {{(isset($settings[BillsConstants::COL_PRC_TMP]) && $settings[BillsConstants::COL_PRC_TMP] == $key) ? 'selected' : ''}}>{{$template}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @else
                                        <iframe id="purchase_frame" class="w-100 h-100" frameborder="0" src="{{route(ViewsConstants::PRC.'.preview',['template1','fffff'])}}"></iframe>
                                    @endif
                                </div>
                            </div>
                        </div>
                                        ...
                                        <form id="setting-form" method="post" action="{{route(ViewsConstants::PRC_TMP . 'settings')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="pos_template">
                                                    @foreach(Utility::templateData()['templates'] as $key => $template)
                                                        <option value="{{$key}}" {{(isset($settings[BillsConstants::COL_BL_]) && $settings[BillsConstants::COL_BL_] == $key) ? 'selected' : ''}}>{{$template}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
