/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/selectItem.js
 * @generated from original JavaScript - manual review recommended
 * @module selectItem
 */

((): void => {
  const selectEl = document.querySelector<HTMLElement>(".item");
  ...
  if (!selectEl.getAttribute("data-listener-bound-change")) {
    ...
    selectEl.addEventListener("change", event => {
      try {
        ...
        console.error(`[selectItem] Error:`, e);
      }
    });
  }
})();
