/**
 * Auto-generated Playwright tests for allowance_options routes
 * Generated: 2026-03-08T23:55:10.517Z
 * 
...
test.describe('allowance_options.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/allowance_options-create.html');
...
test.describe('allowance_options.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/allowance_options-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('allowance_options.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/allowance_options-index.html');
    await page.waitForLoadState('networkidle');
