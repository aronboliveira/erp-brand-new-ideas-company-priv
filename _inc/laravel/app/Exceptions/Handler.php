        ...
        <html lang="' . $userLang . '" dir="' . (in_array($userLang, ['ar', 'he']) ? 'rtl' : 'ltr') . '">
            <head>
                ...
                <style>
                    ...
                    [dir="rtl"] .floating-element:nth-child(1) {
                        left: auto;
                        right: 10%;
                    }

                    [dir="rtl"] .floating-element:nth-child(2) {
                        right: auto;
                        left: 15%;
                    }

                    [dir="rtl"] .floating-element:nth-child(3) {
                        left: auto;
                        right: 20%;
                    }
                    
                    @keyframes float {
                        0%, 100% { transform: translateY(0-container">
                                ...
                                <div class="error-content">
                                    <div class="text-center mb-4">
                                        <p class="text-muted" id="error-description">We encountered a technical issue while processing your request. Don\'t worry, we\'re working to fix it!</p>
                                    </div>
