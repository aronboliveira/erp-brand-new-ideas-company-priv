                                ...
                                <div data-v-363339a0 class="d-inner">
                                    <div data-v-363339a0 class="row">
                                        <div data-v-363339a0 class="col-3">
                                            ...
                                            <p data-v-363339a0>{{ (($settings['company_country'] ?? '') !== '') ? $settings['company_country'] : __('No country available for company') }}</p>
                                        </div>
                                        <div data-v-363339a0 class="col-1">
                                            <img data-v-363339a0 src="{{ $imgSrc }}" style="max-width:150px" class="d-logo">
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-363339a0 class="row">
                                        <div data-v-363339a0 class="col-66">
                                            ...
                                            <p data-v-363339a0>{{ isset($client->name) && $client->name !== '' ? $client->name : __('No client name available') }}</p>
                                            <pre data-v-363339a0>{{ isset($client->email) && $client->email !== '' ? $client->email : __('No client email available') }}</pre>
                                        </div>
                                                    ...
                                                    @foreach($items as $key => $item)
                                                        ...
                                                        <div data-v-363339a0 class="d-table-tr">
                                                            ...
                                                            <div data-v-363339a0 class="d-table-td w-13">
                                                                <pre data-v-363339a0>{{ isset($item->name) && $item->name !== '' ? $item->name : __('No item name available') }}<br data-v-363339a0></pre>
                                                            </div>
                                                            <div data-v-363339a0 class="d-table-td w-3">
                                            ...
                                            <div data-v-363339a0 class="d-table-footer">
                                                ...
                                                <div data-v-363339a0 class="d-table-summary">
                                                    <div data-v-363339a0 class="d-table-summary-item">
                                                        ...
                                                        <div data-v-363339a0 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($subTotalVal) : number_format($subTotalVal, 2) }}</div>
                                                    </div>
                                                    @if($discountVal > 0)
                                                        <div data-v-363339a0 class="d-table-summary-item">
                                                            <div data-v-363339a0 class="tu d-table-label">{{ __('Discount') }}:</div>
                                                            <div data-v-363339a0 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($discountVal) : number_format($discountVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    @if($taxVal > 0)
                                                        <div data-v-363339a0 class="d-table-summary-item">
                                                            <div data-v-363339a0 class="tu d-table-label">{{ (data_get($estimation, 'tax.name') ?: __('Tax')) }} ({{ (string)(data_get($estimation, 'tax.rate') ?? '0') }}%):</div>
                                                            <div data-v-363339a0 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($taxVal) : number_format($taxVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-363339a0 class="d-table-summary-item" style="color: {{ $color === '#ffffff' ? 'black' : $color }};">
                                                        <div data-v-363339a0 class="fwb f-b tu d-table-label">{{ __('Total') }}:</div>
                                                        <div data-v-363339a0 class="fwb f-b d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($totalVal) : number_format($totalVal, 2) }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div data-v-363339a0 class="row">
                                        <div data-v-363339a0 class="col-66">
                                            <p data-v-363339a0 class="thank" style="color: {{ $color === '#ffffff' ? 'black' : $color }};">{{ __('Thank you') }}!</p>
                                        </div>
