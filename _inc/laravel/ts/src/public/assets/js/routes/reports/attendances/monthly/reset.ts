...
((): void => {
  try {
    ...
    const flag = "data-reset-monthly-attendance-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Monthly attendance reset route is unavailable. Please contact technical support or your domain administrator.";
