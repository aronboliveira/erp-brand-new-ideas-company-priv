...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/event.js
 * @generated from original JavaScript - manual review recommended
 * @module event
 */
(() => {
    const listenerAttr = "data-event-setup-listener-active", el = document.getElementById("event-setup-link");
