...
@endphp
{{ Collective\Html\FormFacade::model($task, ['route' => ['projects.tasks.update',[$project->id, $task->id]], 'id' => 'edit_task', 'method' => 'POST']) }}
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label(ProjectsConstants::COL_NM, 
                    __('Task name'),['class' => 'form-label']) }}<span class="text-danger">*</span>
                {{ Collective\Html\FormFacade::text(ProjectsConstants::COL_NM, 
        ...
        <div class="col-6">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label(ProjectsConstants::COL_E_HRS, __('Estimated Hours'),['class' => 'form-label']) }}<span class="text-danger">*</span>
