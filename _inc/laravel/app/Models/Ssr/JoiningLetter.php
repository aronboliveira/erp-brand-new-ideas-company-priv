...
{
    use UsesUuids;
    protected $table = DatabaseConstants::TABLE_JL;
    protected $fillable = [
    ...
    private const DEFAULT_JOINING_LETTER_REGISTER = [
    ...
    public static function replaceVariable(string $content, array $obj): string
    {
        ...
        $arrValue   = [
            ActivitiesConstants::COL_TSK_DATE          => date($settings['site_date_format'] . ' '
    ...
    public static function defaultJoiningLetter(?string $userId = null): void
    {
        ...
        foreach (self::DEFAULT_JOINING_LETTER as $lang => $content) {
            try {
                self::firstOrCreate(
                    [
