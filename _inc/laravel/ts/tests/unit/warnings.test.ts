/**
 * Jest unit tests for warnings routes
...
describe('warnings.create', () => {
  // TypeScript sources: src/public/assets/js/routes/warnings/store
  // Import would be: import * as module0 from 'src/public/assets/js/routes/warnings/store';
...
describe('warnings.edit', () => {
  // TypeScript sources: src/public/assets/js/routes/warnings/update
  // Import would be: import * as module0 from 'src/public/assets/js/routes/warnings/update';
