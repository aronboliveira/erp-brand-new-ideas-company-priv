/**
 * @fileoverview TypeScript version of public/assets/js/routes/loans/storeSalary.js
...
((): void => {
  ...
  attachGuard(document.getElementById("loan-store-form"), "submit");
  document
    .querySelectorAll('[id^="loan-edit-"]')
    .forEach((el: Element): void => { attachGuard(el, "click"); });
  document
    .querySelectorAll('[id^="loan-delete-"]')
    .forEach((el: Element): void => { attachGuard(el, "click"); });
})();
