...
trait HasInheritedRules
{
	protected static function mergeRulesRecursively(array $base, array $local): array
	{
	    try {
	        ...
	        Log::error(static::class . '::mergeRulesRecursively — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
	...
	protected static function isScalarList(array $value): bool
	{
	    try {
	        ...
	        Log::error(static::class . '::isScalarList — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return false;
	    }
	}
