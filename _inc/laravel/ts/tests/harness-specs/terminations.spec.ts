/**
 * Auto-generated Playwright tests for terminations routes
...
test.describe('terminations.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/terminations-create.html');
...
test.describe('terminations.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/terminations-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('terminations.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/terminations-index.html');
    await page.waitForLoadState('networkidle');
