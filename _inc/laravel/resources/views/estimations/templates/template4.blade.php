                                ...
                                <div data-v-363339a0="" class="d-inner">
                                    <div data-v-363339a0="" class="row">
                                        <div data-v-363339a0="" class="col-3">
                                            ...
                                            <p data-v-363339a0=""><?php if ($settings['company_name']) echo $settings['company_name']; ?></p>
                                            <pre data-v-363339a0=""><?php if ($settings['company_address']) echo $settings['company_address']; ?></pre>
                                            <p data-v-363339a0=""><?php if ($settings['company_city']) echo $settings['company_city'] . ', '; ?><?php if ($settings['company_state']) echo $settings['company_state']; ?><?php if ($settings['company_zipcode']) echo ' - ' . $settings['company_zipcode']; ?></p>
                                            <p data-v-363339a0=""><?php if ($settings['company_country']) echo $settings['company_country']; ?></p>
                                        </div>
