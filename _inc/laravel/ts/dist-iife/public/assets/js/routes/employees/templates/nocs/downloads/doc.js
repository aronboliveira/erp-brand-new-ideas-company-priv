...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/employees/templates/nocs/downloads/doc.js
 * @generated from original JavaScript - manual review recommended
 * @module doc
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="noc-download-doc-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
