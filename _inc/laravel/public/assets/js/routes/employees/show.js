/**
 * @fileoverview TypeScript version of public/assets/js/routes/employees/show.js
 * @generated from original JavaScript - manual review recommended
 * @module show
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="employee-show-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
