/**
 * @fileoverview TypeScript version of tests/e2e/i18n.spec.cjs
...
/* ================================================================== */
test.describe("Guest locale – login page with {lang} route param", (): void => {
...
/* ================================================================== */
test.describe("SetGuestLocale middleware – cookie behaviour", (): void => {
...
/* ================================================================== */
test.describe("RTL direction on login page", (): void => {
  test.use({ storageState: undefined });
...
/* ================================================================== */
test.describe("Unsupported locale fallback", (): void => {
  test.use({ storageState: undefined });
...
/* ================================================================== */
test.describe("Language dropdown – login page", (): void => {
  test.use({ storageState: undefined });
...
/* ================================================================== */
test.describe("Client-side locale state sync", (): void => {
  test.use({ storageState: undefined });
...
/* ================================================================== */
test.describe("Authenticated – change-language endpoint", (): void => {
...
/* ================================================================== */
test.describe("All supported locales – smoke test", (): void => {
  test.use({ storageState: undefined });
...
test.describe("Translation JSON files – integrity", (): void => {
  ...
  for (const locale of ["pt-br", "es", "fr", "de"]) {
    ...
    test(`${locale}.json — no empty-string translations`, (): void => {
