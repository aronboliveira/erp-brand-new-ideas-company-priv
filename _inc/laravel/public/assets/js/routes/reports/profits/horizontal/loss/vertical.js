            ...
            el.addEventListener("click", (e) => {
                try {
                    ...
                    const msg = el.getAttribute("data-guard-msg") ??
                        "Vertical profit & loss view route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
