/**
 * @fileoverview TypeScript version of public/assets/js/routes/documentUploads/edit.js
 * @generated from original JavaScript - manual review recommended
 * @module edit
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="document-edit-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
