/**
 * Auto-generated Playwright tests for loans routes
...
test.describe('loans.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/loans-create.html');
...
test.describe('loans.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/loans-edit.html');
    await page.waitForLoadState('networkidle');
