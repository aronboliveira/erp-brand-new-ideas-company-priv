/**
 * Jest unit tests for layouts routes
...
describe('layouts.admin', () => {
  // TypeScript sources: src/public/assets/js/routes/generics/utility
  // Import would be: import * as module0 from 'src/public/assets/js/routes/generics/utility';
