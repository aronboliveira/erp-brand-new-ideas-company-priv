...
class TravelController extends Controller
{
    ...
    public function index(Request $request): View|RedirectResponse|null
    {
        ...
        try {
            ...
            return view(ViewsConstants::TRV . '.' . __FUNCTION__, compact('travels'));
        } catch (\Throwable $e) {
    ...
    public function create(Request $request): View|RedirectResponse|null
    {
        ...
        return view(ViewsConstants::TRV . '.create', compact('employees'));
    }
    ...
    public function store(Request $request): RedirectResponse|null
    {
        ...
        try {
            ...
            if (!empty(Utility::settings()['trip_sent'])) {
                $employee = $travel->employee; // eager‐load or lookup
            ...
            return redirect()
                ->route(self::REDIRECT_INDEX)
                ->with('success', __('Travel successfully created.'));
        } catch (\Throwable $e) {
    ...
    public function edit(Request $request, Travel $travel): View|RedirectResponse|null
    {
        ...
        return view(ViewsConstants::TRV . '.edit', compact('travel', 'employees'));
    }
    ...
    public function update(Request $request, Travel $travel): RedirectResponse|null
    {
        ...
        try {
            ...
            return redirect()
                ->route(self::REDIRECT_INDEX)
                ->with('success', __('Travel successfully updated.'));
        } catch (\Throwable $e) {
            Log::error("$action failed", [
                'error' => $e->getMessage(),
            ]);
    ...
    public function destroy(Request $request, Travel $travel): RedirectResponse|null
    {
        ...
        try {
            ...
            return redirect()
                ->route(self::REDIRECT_INDEX)
                ->with('success', __('Travel successfully deleted.'));
        } catch (\Throwable $e) {
            Log::error("$action failed", [
                'error' => $e->getMessage(),
            ]);
