        ...
        f.addEventListener("submit", (e) => {
            try {
                ...
                const msgAttr = f.hasAttribute("data-guard-msg")
                    ...
                    ? msgAttr
                    : "Store termination route is unavailable. Please contact technical support or your domain administrator.", bootstrapLink = document.querySelector('link[href*="bootstrap"]'), hasBootstrap = !!(bootstrapLink && typeof window.bootstrap.Toast !== "undefined");
