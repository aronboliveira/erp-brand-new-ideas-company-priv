...
@push(StacksConstants::ADM_SCR_PG)
    ...
    <script>
        document.getElementById(SettingsConstants::CPN_LG_DK).onchange = function() {
        ...
        document.getElementById(SettingsConstants::CPN_FAVICON_K).onchange = function() {
            var src = URL.createObjectURL(this.files[0])
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div id="brand-settings" class="card">
                        {{ Collective\Html\FormFacade::model($setting, ['route' => 'business.setting', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    {{ Collective\Html\FormFacade::label('title_text', __('Title Text'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('title_text', null, ['class' => 'form-control', 'placeholder' => __('Title Text')]) }}
                                    @error('title_text')
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    {{ Collective\Html\FormFacade::text(SettingsConstants::FT_TXT, Utility::getValByName(SettingsConstants::FT_TXT), ['class' => 'form-control', 'placeholder' => __('Enter Footer Text')]) }}
                        ...
                        <div class="card-footer text-end">
                            <div class="form-group">
                                <input class="{{ ViewClassNamesConstants::BT_PR_PRM10 }}" type="submit"
                    ...
                    <div id="system-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => ViewsConstants::SYS.'.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('site_currency', __('Currency *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('site_currency', $setting['site_currency'], ['class' => 'form-control font-style', 'required', 'placeholder' => __('Enter Currency')]) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('site_currency_symbol', __('Currency Symbol *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('site_currency_symbol', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('decimal_number', __('Decimal Number Format'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::number('decimal_number', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('customer_prefix', __('Customer Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('customer_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('vendor_prefix', __('Vendor Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('vendor_prefix', null, ['class' => 'form-control']) }}
                                    @error('vendor_prefix')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('proposal_prefix', __('Proposal Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('proposal_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('invoice_prefix', __('Invoice Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('invoice_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('bill_prefix', __('Bill Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('bill_prefix', null, ['class' => 'form-control']) }}
                                    @error('bill_prefix')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('purchase_prefix', __('Purchase Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('purchase_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('pos_prefix', __('Pos Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('pos_prefix', null, ['class' => 'form-control']) }}
                                    @error('pos_prefix')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('journal_prefix', __('Journal Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('journal_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('expense_prefix', __('Expense Prefix'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('expense_prefix', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('shipping_display', __('Display Shipping in Proposal / Invoice / Bill'), ['class' => 'form-label']) }}
                                ...
                                <div class="form-group col-md-12">
                                    {{ Collective\Html\FormFacade::label('footer_title', __('Proposal/Invoice/Bill/Purchase/POS Footer Title'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('footer_title', null, ['class' => 'form-control']) }}
                                    @error('footer_title')
                                ...
                                <div class="form-group col-md-12">
                                    {{ Collective\Html\FormFacade::label('footer_notes', __('Proposal/Invoice/Bill/Purchase/POS Footer Note'), ['class' => 'form-label']) }}
                    ...
                    <div id="company-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => ViewsConstants::CP.'.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_name *', __('Company Name *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_name', null, ['class' => 'form-control font-style']) }}
                                    @error('company_name')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_address', __('Address'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_address', null, ['class' => 'form-control font-style']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_city', __('City'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_city', null, ['class' => 'form-control font-style']) }}
                                    @error('company_city')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_state', __('State'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_state', null, ['class' => 'form-control font-style']) }}
                                    @error('company_state')
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_zipcode', __('Zip/Post Code'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_zipcode', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group  col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_country', __('Country'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_country', null, ['class' => 'form-control font-style']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('company_telephone', __('Telephone'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('company_telephone', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-6">
                                    {{ Collective\Html\FormFacade::label('registration_number', __('Company Registration Number *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::text('registration_number', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-4">
                                    {{ Collective\Html\FormFacade::label('company_start_time', __('Company Start Time *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::time('company_start_time', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-4">
                                    {{ Collective\Html\FormFacade::label('company_end_time', __('Company End Time *'), ['class' => 'form-label']) }}
                                    {{ Collective\Html\FormFacade::time('company_end_time', null, ['class' => 'form-control']) }}
                                ...
                                <div class="form-group col-md-12 mt-2">
                                    {{ Collective\Html\FormFacade::label('timezone', __('Timezone'), ['class' => 'form-label']) }}
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="{{ ViewClassNamesConstants::FM_CHK_IL }} {{ ViewClassNamesConstants::FM_GB3 }}">
                                    ...
                                    {{ Collective\Html\FormFacade::text('vat_number', null, ['class' => 'form-control', 'placeholder' => __('Enter VAT / GST Number')]) }}
                                </div>
                    ...
                    <div id="email-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => ViewsConstants::CP.'email.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_driver', isset($emailSetting['mail_driver']) ? $emailSetting['mail_driver'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Driver')]) }}
                                        @error('mail_driver')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_host', isset($emailSetting['mail_host']) ? $emailSetting['mail_host'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Host')]) }}
                                        @error('mail_host')
                                            <span class="invalid-mail_driver" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_port', isset($emailSetting['mail_port']) ? $emailSetting['mail_port'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Port')]) }}
                                        @error('mail_port')
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_username', isset($emailSetting['mail_username']) ? $emailSetting['mail_username'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Username')]) }}
                                        @error('mail_username')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_password', isset($emailSetting['mail_password']) ? $emailSetting['mail_password'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Password')]) }}
                                        @error('mail_password')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_encryption', isset($emailSetting['mail_encryption']) ? $emailSetting['mail_encryption'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail Encryption')]) }}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_from_address', isset($emailSetting['mail_from_address']) ? $emailSetting['mail_from_address'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail From Address')]) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Collective\Html\FormFacade::text('mail_from_name', isset($emailSetting['mail_from_name']) ? $emailSetting['mail_from_name'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Mail From Name')]) }}
                    ...
                    <div id="tracker-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => 'tracker.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-control-label">{{ __('Application URL') }}</label> <br>
                                    <small>{{ __('Application URL to log into the app.') }}</small>
                                    {{ Collective\Html\FormFacade::text('apps_url', URL::to('/'), ['class' => 'form-control', 'placeholder' => __('Application URL'), 'readonly' => 'true']) }}
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-control-label">{{ __('Tracking Interval') }}</label> <br>
                                    <small>{{ __('Image Screenshot Take Interval time ( 1 = 1 min)') }}</small>
                                    {{ Collective\Html\FormFacade::number('interval_time', isset($setting['interval_time']) ? $setting['interval_time'] : '10', ['class' => 'form-control', 'placeholder' => __('Enter Tracking Interval Time')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-end">
                    ...
                    <div class="card" id="payment-settings">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => ViewsConstants::CP.'.payment.settings', 'method' => 'POST']) }}
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                ...
                                                                                {{ Collective\Html\FormFacade::textarea('bank_details', isset($company_payment_setting['bank_details']) ? $company_payment_setting['bank_details'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Your Bank Details'), 'rows' => 4]) }}
                                                                                <small class="text-xs">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                ...
                                                                                {{ Collective\Html\FormFacade::text('stripe_key', isset($company_payment_setting['stripe_key']) ? $company_payment_setting['stripe_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Stripe Key')]) }}
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                ...
                                                                                {{ Collective\Html\FormFacade::text('stripe_secret', isset($company_payment_setting['stripe_secret']) ? $company_payment_setting['stripe_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Stripe Secret')]) }}
                                                                ...
                                                                <div class="row gy-4">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('benefit_api_key', isset($company_payment_setting['benefit_api_key']) ? $company_payment_setting['benefit_api_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Benefit Key')]) }}
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('benefit_secret_key', isset($company_payment_setting['benefit_secret_key']) ? $company_payment_setting['benefit_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Benefit Secret key')]) }}
                                                                ...
                                                                <div class="row gy-4">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('cashfree_api_key', isset($company_payment_setting['cashfree_api_key']) ? $company_payment_setting['cashfree_api_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Cashfree Key')]) }}
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('cashfree_secret_key', isset($company_payment_setting['cashfree_secret_key']) ? $company_payment_setting['cashfree_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Cashfree Secret key')]) }}
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('aamarpay_store_id', isset($company_payment_setting['aamarpay_store_id']) ? $company_payment_setting['aamarpay_store_id'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Store Id')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('aamarpay_signature_key', isset($company_payment_setting['aamarpay_signature_key']) ? $company_payment_setting['aamarpay_signature_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Signature Key')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('aamarpay_description', isset($company_payment_setting['aamarpay_description']) ? $company_payment_setting['aamarpay_description'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}<br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('paytr_merchant_id', isset($company_payment_setting['paytr_merchant_id']) ? $company_payment_setting['paytr_merchant_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('paytr_merchant_key', isset($company_payment_setting['paytr_merchant_key']) ? $company_payment_setting['paytr_merchant_key'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Key')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('paytr_merchant_salt', isset($company_payment_setting['paytr_merchant_salt']) ? $company_payment_setting['paytr_merchant_salt'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Salt')]) }}<br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('yookassa_shop_id', isset($company_payment_setting['yookassa_shop_id']) ? $company_payment_setting['yookassa_shop_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('yookassa_secret', isset($company_payment_setting['yookassa_secret']) ? $company_payment_setting['yookassa_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Key')]) }}<br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('midtrans_secret', isset($company_payment_setting['midtrans_secret']) ? $company_payment_setting['midtrans_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Id')]) }}<br>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('xendit_api', isset($company_payment_setting['xendit_api']) ? $company_payment_setting['xendit_api'] : '', ['class' => 'form-control', 'placeholder' => __('API Key')]) }}<br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{ Collective\Html\FormFacade::text('xendit_token', isset($company_payment_setting['xendit_token']) ? $company_payment_setting['xendit_token'] : '', ['class' => 'form-control', 'placeholder' => __('Token')]) }}<br>
                    ...
                    <div id="zoom-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => 'zoom.settings', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-control-label">{{ __('Zoom Account ID') }}</label> <br>
                                    {{ Collective\Html\FormFacade::text('zoom_account_id', isset($setting['zoom_account_id']) ? $setting['zoom_account_id'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Zoom Accound Id')]) }}
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-control-label">{{ __('Zoom Client ID') }}</label> <br>
                                    {{ Collective\Html\FormFacade::text('zoom_client_id', isset($setting['zoom_client_id']) ? $setting['zoom_client_id'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Zoom Client Id')]) }}
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-control-label">{{ __('Zoom Client Secret Key') }}</label> <br>
                                    {{ Collective\Html\FormFacade::text('zoom_client_secret', isset($setting['zoom_client_secret']) ? $setting['zoom_client_secret'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Zoom Client Secret Key')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-end">
                    ...
                    <div id="slack-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::open(['route' => 'slack.settings', 'id' => 'slack-setting', 'method' => 'post', 'class' => 'd-contents']) }}
                        <div class="card-body">
                            <div class="form-group col-md-12">
                                <label class="form-label">{{ __('Slack Webhook URL') }}</label> <br>
                                {{ Collective\Html\FormFacade::text('slack_webhook', isset($setting['slack_webhook']) ? $setting['slack_webhook'] : '', ['class' => 'form-control w-100', 'placeholder' => __('Enter Slack Webhook URL'), 'required' => 'required']) }}
                            </div>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('lead_notification', '1', isset($setting['lead_notification']) && $setting['lead_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'lead_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('deal_notification', '1', isset($setting['deal_notification']) && $setting['deal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'deal_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('leadtodeal_notification', '1', isset($setting['leadtodeal_notification']) && $setting['leadtodeal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'leadtodeal_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('contract_notification', '1', isset($setting['contract_notification']) && $setting['contract_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'contract_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('project_notification', '1', isset($setting['project_notification']) && $setting['project_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'project_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('task_notification', '1', isset($setting['task_notification']) && $setting['task_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'task_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('taskmove_notification', '1', isset($setting['taskmove_notification']) && $setting['taskmove_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'taskmove_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('taskcomment_notification', '1', isset($setting['taskcomment_notification']) && $setting['taskcomment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'taskcomment_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('payslip_notification', '1', isset($setting['payslip_notification']) && $setting['payslip_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'payslip_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('award_notification', '1', isset($setting['award_notification']) && $setting['award_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'award_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('announcement_notification', '1', isset($setting['announcement_notification']) && $setting['announcement_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'announcement_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('holiday_notification', '1', isset($setting['holiday_notification']) && $setting['holiday_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'holiday_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('support_notification', '1', isset($setting['support_notification']) && $setting['support_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'support_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('event_notification', '1', isset($setting['event_notification']) && $setting['event_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'event_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('meeting_notification', '1', isset($setting['meeting_notification']) && $setting['meeting_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'meeting_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('policy_notification', '1', isset($setting['policy_notification']) && $setting['policy_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'policy_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('invoice_notification', '1', isset($setting['invoice_notification']) && $setting['invoice_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'invoice_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('revenue_notification', '1', isset($setting['revenue_notification']) && $setting['revenue_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'revenue_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('bill_notification', '1', isset($setting['bill_notification']) && $setting['bill_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'bill_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('payment_notification', '1', isset($setting['payment_notification']) && $setting['payment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'payment_notification']) }}
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('budget_notification', '1', isset($setting['budget_notification']) && $setting['budget_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'budget_notification']) }}
                    ...
                    <div id="telegram-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::open(['route' => 'telegram.settings', 'id' => 'telegram-setting', 'method' => 'post', 'class' => 'd-contents']) }}

                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label">{{ __('Telegram AccessToken') }}</label> <br>
                                    {{ Collective\Html\FormFacade::text('telegram_accestoken', isset($setting['telegram_accestoken']) ? $setting['telegram_accestoken'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Telegram AccessToken')]) }}
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label ">{{ __('Telegram ChatID') }}</label> <br>
                                    {{ Collective\Html\FormFacade::text('telegram_chatid', isset($setting['telegram_chatid']) ? $setting['telegram_chatid'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Telegram ChatID')]) }}
                                </div>
                            </div>
                            <div class="col-md-12 mt-5 mb-2">
                                <h5 class="small-title">{{ __('Module Settings') }}</h5>
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Lead') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_lead_notification', '1', isset($setting['telegram_lead_notification']) && $setting['telegram_lead_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_lead_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Deal') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_deal_notification', '1', isset($setting['telegram_deal_notification']) && $setting['telegram_deal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_deal_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('Lead to Deal Conversion') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_leadtodeal_notification', '1', isset($setting['telegram_leadtodeal_notification']) && $setting['telegram_leadtodeal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_leadtodeal_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Contract') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_contract_notification', '1', isset($setting['telegram_contract_notification']) && $setting['telegram_contract_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_contract_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Project') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_project_notification', '1', isset($setting['telegram_project_notification']) && $setting['telegram_project_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_project_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Task') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_task_notification', '1', isset($setting['telegram_task_notification']) && $setting['telegram_task_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_task_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('Task Stage Updated') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_taskmove_notification', '1', isset($setting['telegram_taskmove_notification']) && $setting['telegram_taskmove_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_taskmove_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Task Comment') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_taskcomment_notification', '1', isset($setting['telegram_taskcomment_notification']) && $setting['telegram_taskcomment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_taskcomment_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Monthly Payslip') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_payslip_notification', '1', isset($setting['telegram_payslip_notification']) && $setting['telegram_payslip_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_payslip_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Award') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_award_notification', '1', isset($setting['telegram_award_notification']) && $setting['telegram_award_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_award_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Announcement') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_announcement_notification', '1', isset($setting['telegram_announcement_notification']) && $setting['telegram_announcement_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_announcement_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Holiday') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_holiday_notification', '1', isset($setting['telegram_holiday_notification']) && $setting['telegram_holiday_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_holiday_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Support Ticket') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_support_notification', '1', isset($setting['telegram_support_notification']) && $setting['telegram_support_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_support_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Event') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_event_notification', '1', isset($setting['telegram_event_notification']) && $setting['telegram_event_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_event_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Meeting') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_meeting_notification', '1', isset($setting['telegram_meeting_notification']) && $setting['telegram_meeting_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_meeting_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Company Policy') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_policy_notification', '1', isset($setting['telegram_policy_notification']) && $setting['telegram_policy_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_policy_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Invoice') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_invoice_notification', '1', isset($setting['telegram_invoice_notification']) && $setting['telegram_invoice_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_invoice_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Revenue') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_revenue_notification', '1', isset($setting['telegram_revenue_notification']) && $setting['telegram_revenue_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_revenue_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Bill') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_bill_notification', '1', isset($setting['telegram_bill_notification']) && $setting['telegram_bill_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_bill_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Invoice Payment') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_payment_notification', '1', isset($setting['telegram_payment_notification']) && $setting['telegram_payment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_payment_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Budget') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('telegram_budget_notification', '1', isset($setting['telegram_budget_notification']) && $setting['telegram_budget_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'telegram_budget_notification']) }}
                                                <label class="form-check-label"
                    ...
                    <div id="twilio-settings" class="card">
                        ...
                        {{ Collective\Html\FormFacade::model($setting, ['route' => 'twilio.setting', 'method' => 'post']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::label('twilio_sid', __('Twilio SID '), ['class' => 'form-label']) }}
                                        {{ Collective\Html\FormFacade::text('twilio_sid', isset($setting['twilio_sid']) ? $setting['twilio_sid'] : '', ['class' => 'form-control w-100', 'placeholder' => __('Enter Twilio SID'), 'required' => 'required']) }}
                                        @error('twilio_sid')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::label('twilio_token', __('Twilio Token'), ['class' => 'form-label']) }}
                                        {{ Collective\Html\FormFacade::text('twilio_token', isset($setting['twilio_token']) ? $setting['twilio_token'] : '', ['class' => 'form-control w-100', 'placeholder' => __('Enter Twilio Token'), 'required' => 'required']) }}
                                        @error('twilio_token')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::label('twilio_from', __('Twilio From'), ['class' => 'form-label']) }}
                                        {{ Collective\Html\FormFacade::text('twilio_from', isset($setting['twilio_from']) ? $setting['twilio_from'] : '', ['class' => 'form-control w-100', 'placeholder' => __('Enter Twilio From'), 'required' => 'required']) }}
                                        @error('twilio_from')
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('twilio_customer_notification', '1', isset($setting['twilio_customer_notification']) && $setting['twilio_customer_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_customer_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('twilio_vendor_notification', '1', isset($setting['twilio_vendor_notification']) && $setting['twilio_vendor_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_vendor_notification']) }}
                                                <label class="form-check-label"
                                                    for="twilio_vendor_notification"></label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Invoice') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('twilio_invoice_notification', '1', isset($setting['twilio_invoice_notification']) && $setting['twilio_invoice_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_invoice_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Revenue') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('twilio_revenue_notification', '1', isset($setting['twilio_revenue_notification']) && $setting['twilio_revenue_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_revenue_notification']) }}
                                                <label class="form-check-label"
                                ...
                                <div class="col-md-4 mb-2">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span>{{ __('New Bill') }}</span>
                                                {{ Collective\Html\FormFacade::checkbox('twilio_bill_notification', '1', isset($setting['twilio_bill_notification']) && $setting['twilio_bill_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_bill_notification']) }}
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('twilio_proposal_notification', '1', isset($setting['twilio_proposal_notification']) && $setting['twilio_proposal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_proposal_notification']) }}
                                                <label class="form-check-label"
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('twilio_payment_notification', '1', isset($setting['twilio_payment_notification']) && $setting['twilio_payment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_payment_notification']) }}
                                                <label class="form-check-label"
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                {{ Collective\Html\FormFacade::checkbox('twilio_reminder_notification', '1', isset($setting['twilio_reminder_notification']) && $setting['twilio_reminder_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'twilio_reminder_notification']) }}
                                                <label class="form-check-label"
                    ...
                    <div id="email-notification-settings" class="card">
                        <div class="col-md-12">
                            ...
                            {{ Collective\Html\FormFacade::model($setting, ['route' => ['status.email.language'], 'method' => 'post']) }}
                            @csrf
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div id="offer-letter-settings" class="card">
                        <div class="col-md-12">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-end drp-languages">
                                    <ul class="list-unstyled mb-0 m-2">
                                        <li class="{{ ViewClassNamesConstants::LNG_DD_IT }}" style="margin-top: -7px;">
                                            <a class="{{ ViewClassNamesConstants::DRP_NO_ARROW }}"
                            ...
                            <div class="card-body table-border-style ">
                                ...
                                {{ Collective\Html\FormFacade::open(['route' => ['offerlatter.update', $offerlang], 'method' => 'post']) }}
                                <div class="form-group col-12">
                                    {{ Collective\Html\FormFacade::label('content', __(' Format'), ['class' => 'form-label text-dark']) }}
                                ...
                                {{--                                <div class="card-footer text-end"> --}}
                                {{--                                    {{ Collective\Html\FormFacade::submit(__('Save Changes'), ['class' => 'btn  btn-primary']) }} --}}
                                {{--                                </div> --}}
                    ...
                    <div id="joining-letter-settings" class="card">
                        <div class="col-md-12">
                            ...
                            <div class="card-body table-border-style ">
                                ...
                                {{ Collective\Html\FormFacade::open(['route' => ['joiningletter.update', $joininglang], 'method' => 'post']) }}
                                <div class="form-group col-12">
                                    {{ Collective\Html\FormFacade::label('content', __(' Format'), ['class' => 'form-label text-dark']) }}
                    ...
                    <div id="experience-certificate-settings" class="card">
                        <div class="col-md-12">
                            ...
                            <div class="card-body table-border-style ">
                                ...
                                {{ Collective\Html\FormFacade::open(['route' => ['experiencecertificate.update', $explang], 'method' => 'post']) }}
                                <div class="form-group col-12">
                                    {{ Collective\Html\FormFacade::label('content', __(' Format'), ['class' => 'form-label text-dark']) }}
                    ...
                    <div id="noc-settings" class="card">
                        <div class="col-md-12">
                            ...
                            <div class="card-body table-border-style ">
                                {{ Collective\Html\FormFacade::open(['route' => ['noc.update', $noclang], 'method' => 'post']) }}
                                <div class="form-group col-12">
                                    {{ Collective\Html\FormFacade::label('content', __(' Format'), ['class' => 'form-label text-dark']) }}
                    ...
                    <div id="google-calendar" class="card">
                        <div class="col-md-12">
                            {{ Collective\Html\FormFacade::open(['url' => route('google.calendar.settings'), 'enctype' => 'multipart/form-data']) }}
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        {{ Collective\Html\FormFacade::label('Google calendar id', __('Google Calendar Id'), ['class' => 'col-form-label']) }}
                                        {{ Collective\Html\FormFacade::text('google_clender_id', !empty($setting['google_clender_id']) ? $setting['google_clender_id'] : '', ['class' => 'form-control', 'placeholder' => 'Google Calendar Id', 'required' => 'required']) }}
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        {{ Collective\Html\FormFacade::label('Google calendar json file', __('Google Calendar json File'), ['class' => 'col-form-label']) }}
                                        <input type="file" class="form-control" name="google_calendar_json_file"
                                            id="file">
                                        {{-- {{Collective\Html\FormFacade::text('zoom_secret_key', !empty($setting['zoom_secret_key']) ? $setting['zoom_secret_key'] : '' ,array('class'=>'form-control', 'placeholder'=>'Google Calendar json File'))}} --}}
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-end">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="Action">
                                                        <span>
                                                            ...
                                                            @can(PermissionsConstants::DEL_WHK)
                                                                <div class="action-btn bg-danger ms-2">
                                                                    {!! Collective\Html\FormFacade::open(['method' => 'DELETE', 'route' => ['destroy.ip', $ip->id], 'id' => 'delete-form-' . $ip->id]) !!}
