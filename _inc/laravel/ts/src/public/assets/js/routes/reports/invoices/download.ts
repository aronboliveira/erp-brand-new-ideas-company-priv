        ...
        try {
          const a =
            ...
            ((e.target as Element).closest
              ? (e.target as Element).closest("a.download-invoice-reports")
              : null);
          if (!a) return;
          ...
          const msg =
            ...
            "Download function for invoice reports is unavailable. Please contact technical support or your domain administrator.";
