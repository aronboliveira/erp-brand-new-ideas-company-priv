...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/invoices/edit.js
...
(() => {
    try {
        const selector = ".edit-invoice-link", alias = "data-listening-editinvoiceclick";
                ...
                el.addEventListener("click", event => {
                    ...
                    if ((!url || url === "#") && (!href || href === "#")) {
                        ...
                        const msg = el.getAttribute("data-guard-msg") ??
                            "Edit invoice route is unavailable. Please contact technical support or your domain administrator.";
                        if (hasBS) {
