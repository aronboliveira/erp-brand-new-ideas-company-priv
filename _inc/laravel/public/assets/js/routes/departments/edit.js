/**
 * @fileoverview TypeScript version of public/assets/js/routes/departments/edit.js
 * @generated from original JavaScript - manual review recommended
 * @module edit
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="department-edit-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
