/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/tracker.js
 * @generated from original JavaScript - manual review recommended
 * @module tracker
 */
(() => {
    const listenerAttr = "data-tracker-listener-active", el = document.getElementById("tracker-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("tracker-link"))
            observer.disconnect();
    });
