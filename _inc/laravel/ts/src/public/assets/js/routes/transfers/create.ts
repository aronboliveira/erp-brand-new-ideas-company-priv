/**
 * @fileoverview TypeScript version of public/assets/js/routes/transfers/create.js
  ...
  try {
    ...
    a.addEventListener("click", function (e: Event) {
      try {
        ...
        e.preventDefault();
        const msg =
          a.getAttribute("data-guard-msg") ?? "Create transfer route is unavailable. Please contact technical support or your domain administrator.";
