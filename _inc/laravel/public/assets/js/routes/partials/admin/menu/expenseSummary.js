/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/expenseSummary.js
 * @generated from original JavaScript - manual review recommended
 * @module expenseSummary
 */
(() => {
    const listenerAttr = "data-expense-summary-listener-active", el = document.getElementById("expense-summary-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[expenseSummary] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=expenseSummary.js.map