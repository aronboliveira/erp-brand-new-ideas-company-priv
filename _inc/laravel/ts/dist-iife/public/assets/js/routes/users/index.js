...
(() => {
    try {
        ...
        attach("users-log-link", "User logs route is unavailable. Please contact technical support or your domain administrator.");
        attach("user-create-link", "Create user route is unavailable. Please contact technical support or your domain administrator.");
    }
    catch (__err) {
