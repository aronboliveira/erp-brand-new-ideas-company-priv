...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/companyPolicy.js
 * @generated from original JavaScript - manual review recommended
 * @module companyPolicy
 */
(() => {
    const listenerAttr = "data-company-policy-listener-active", el = document.getElementById("company-policy-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[companyPolicy] Error:`, error);
            }
        });
    }
