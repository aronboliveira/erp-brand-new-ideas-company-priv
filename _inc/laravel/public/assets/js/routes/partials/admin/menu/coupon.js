/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/coupon.js
 * @generated from original JavaScript - manual review recommended
 * @module coupon
 */
(() => {
    const listenerAttr = "data-coupon-listener-active", el = document.getElementById("coupon-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("coupon-index-link"))
            observer.disconnect();
    });
