...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/purchases/store.js
        ...
        f.addEventListener("submit", function (e) {
            try {
                ...
                const msg = f.getAttribute("data-guard-msg") ??
                    "Store purchase route is unavailable. Please contact technical support or your domain administrator.", linkEl = document.querySelector('link[href*="bootstrap"]'), hasBootstrapToast = window.bootstrap && typeof window.bootstrap.Toast === "function";
