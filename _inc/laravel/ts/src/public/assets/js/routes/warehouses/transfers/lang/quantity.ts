/**
 * @fileoverview TypeScript version of public/assets/js/routes/warehouses/transfers/lang/quantity.js
...
(function (): void {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      ...
      warehouse_products_unavailable:
    ...
    it: {
      ...
      warehouse_products_unavailable:
        "Impossibile recuperare l’elenco prodotti.",
    ...
    pt: {
      ...
      warehouse_products_unavailable:
        "Não foi possível buscar a lista de produtos.",
