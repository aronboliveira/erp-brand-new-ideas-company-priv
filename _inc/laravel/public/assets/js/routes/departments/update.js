/**
 * @fileoverview TypeScript version of public/assets/js/routes/departments/update.js
 * @generated from original JavaScript - manual review recommended
 * @module update
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="department-update-form-"][data-url][data-guard-msg]'));
        if (forms.length === 0)
            return;
        forms.forEach(fm => {
            try {
