...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/purchase.js
 * @generated from original JavaScript - manual review recommended
 * @module purchase
 */
(() => {
    const listenerAttr = "data-purchase-index-listener-active", el = document.getElementById("purchase-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("purchase-index-link"))
            observer.disconnect();
    });
