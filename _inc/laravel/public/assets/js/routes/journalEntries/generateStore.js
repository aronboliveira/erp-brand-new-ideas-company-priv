/**
 * @fileoverview TypeScript version of public/assets/js/routes/journalEntries/generateStore.js
 * @generated from original JavaScript - manual review recommended
 * @module generateStore
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll("a.ai-btn[data-ajax-popup-over][data-url][data-guard-msg]"));
        if (links.length === 0)
            return;
        links.forEach(a => {
...
//# sourceMappingURL=generateStore.js.map