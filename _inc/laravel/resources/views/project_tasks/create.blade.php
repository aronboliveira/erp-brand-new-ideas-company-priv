...
@endphp
{{ Form::open(['route' => [ViewsConstants::PRJ_TSK_C . '.store',$project_id,$stage_id],'id' => 'create_task']) }}
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                {{ Form::label(ProjectsConstants::COL_NM, __('Task name'),['class' => 'form-label']) }}
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                {{ Form::textarea(ActivitiesConstants::COL_DESC, null, 
                    ['class' => 'form-control','rows'=>'1','data-toggle' => 'autosize']) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                {{ Form::label(ProjectsConstants::COL_E_HRS, __('Estimated Hours'),['class' => 'form-label']) }}
                    <span class="text-danger">*</span>
