/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/allowanceEdit.js
 * @generated from original JavaScript - manual review recommended
 * @module allowanceEdit
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="allowance-edit-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[allowanceEdit] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=allowanceEdit.js.map