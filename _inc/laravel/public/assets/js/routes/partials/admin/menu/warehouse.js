 ...
 */
(() => {
    const listenerAttr = "data-warehouse-index-listener-active", el = document.getElementById("warehouse-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("warehouse-index-link"))
            observer.disconnect();
    });
