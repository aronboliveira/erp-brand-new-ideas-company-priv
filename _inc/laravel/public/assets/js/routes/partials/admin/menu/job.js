...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/job.js
 * @generated from original JavaScript - manual review recommended
 * @module job
 */
(() => {
    const listenerAttr = "data-job-index-listener-active", el = document.getElementById("job-index-link");
