...
/* eslint-disable @typescript-eslint/explicit-function-return-type, @typescript-eslint/no-floating-promises, @typescript-eslint/no-implied-eval, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unused-vars, @typescript-eslint/prefer-optional-chain, @typescript-eslint/restrict-plus-operands, no-cond-assign, no-fallthrough, no-prototype-builtins, no-unsafe-finally, no-useless-escape, no-var, prefer-const, prefer-rest-params */
/* global $, jQuery */
/*==============================
		popover js
============================== */
    ...
    Q = {
      ...
      fn: function (e) {
        ...
        let f = t.placement.split("-")[1],
          ...
          p = M(a);
        a = "x" === p ? "y" : "x";
        let l = t.modifiersData.popperOffsets,
          d = t.rects.reference,
          m = t.rects.popper,
          h =
            "function" == typeof s
    ...
    Z = {
      ...
      fn: function (e) {
        ...
        if (
          ...
          let s = n.modifiersData[e + "#persistent"].padding,
            f = u(r),
            c = "y" === a ? "top" : "left",
            p = "y" === a ? "bottom" : "right",
            l =
...
!(function (t, e) {
  ...
  let r,
    ...
    R = function (t, e) {
      return arguments.length < 2 ? L(o[t]) : o[t]?.[e];
    },
    _ = R("navigator", "userAgent") || "",
    j = o.process,
    z = o.Deno,
    M = j?.versions || z?.version,
    C = M?.v8;
  ...
  let Tt,
    ...
    It = o.WeakMap;
  if (zt || c.state) {
    const Pt = c.state || (c.state = new It()),
      Bt = g(Pt.get),
      Dt = g(Pt.has),
      Ft = g(Pt.set);
    ((Tt = function (t, e) {
  ...
  for (const We in te) te[We] && Ne(o[We]?.prototype);
  Ne(ne);
  var Ie = !("undefined" == typeof window || !window.document.createElement),
    ...
    nr = function (t, e, r) {
      for (let n = rr(e), i = mt.f, o = $e.f, s = 0; s < n.length; s++) {
        const a = n[s];
    ...
    hr = function (t, e) {
      ...
      if ((r = u ? o : f ? o[l] || a(l, {}) : (o[l] || {}).prototype))
        for (n in e) {
          ...
          ((t.sham || i?.sham) && Et(s, "sham", !0), Ht(r, n, s, t));
        }
    },
    dr = o.String,
    pr = function (t) {
        ...
        "undefined" != typeof document
          ? document.domain && Ir
            ...
            : (((e = U("iframe")).style.display = "none"),
              ...
              t.F)
          : $r(Ir);
      for (let r = Je.length; r--; ) delete Xr.prototype[Je[r]];
      return Xr();
    };
  Nt[Dr] = !0;
  const Hr =
  ...
  const cn = { IteratorPrototype: Ur, BUGGY_SAFARI_ITERATORS: an },
    ln = mt.f,
    un = V("toStringTag"),
    fn = function (t, e, r) {
      (t && !r && (t = t.prototype),
  ...
  let In = function (t, e, r) {
      for (const n in e) Ht(t, n, e[n], r);
      return t;
    },
    Pn = o.Array,
    Bn = Math.max,
    ...
    ii = function (t, e, r) {
      ...
      if (d) n = t;
        ...
        n = (function (t, e) {
          const r = arguments.length < 2 ? Qn(t) : e;
  ...
  mi.prototype = {
    ...
    delete: function (t) {
      const e = vi(this.entries, function (e) {
        return e[0] === t;
      });
  ...
  for (const Wi in te) Ni(o[Wi]?.prototype, Wi);
  Ni(ne, "DOMTokenList");
  const Ii = /^\s+|\s+$/g,
    Pi = /^[-+]0x[0-9a-f]+$/i,
    Bi = /^0b[01]+$/i,
  ...
  let Xo,
    ...
    Zo = /auto|scroll/,
    ts = /^tb|vertical/,
    es = /msie|trident/i.test(Jo.navigator?.userAgent),
    rs = function (t) {
    ...
    ds = function (t) {
      if (!Xo) {
        ...
        (new MutationObserver(function () {
          hs.splice(0).forEach(function (t) {
            return t();
          });
    ...
    ms = new ((function () {
      ...
      return (
        ...
        (t.prototype.observe = function () {
          const t = this,
            e = function () {
              return t.observer?.observe(document.body, vs);
            };
    ...
    Os = new WeakMap(),
    Ss = function (t, e) {
      for (let r = 0; r < t.length; r += 1) if (t[r].target === e) return r;
      return -1;
    },
    As = (function () {
      function t() {}
      return (
        ...
        (t.observe = function (t, e, r) {
          ...
          Ss(n.observationTargets, e) < 0 &&
            (i && Vo.push(n),
            n.observationTargets.push(new Es(e, r?.box)),
            xs(1),
            ms.schedule());
        }),
  ...
  const Na = function (t) {
    return Array.prototype.reduce.call(
      t,
      function (t, e) {
        const r = e.name.match(/data-simplebar-(.+)/);
        if (r) {
          const n = r[1].replace(/\W+(.)/g, function (t, e) {
  ...
  function Ia(t) {
    return t?.ownerDocument ? t.ownerDocument : document;
  }
  let Pa = null,
    Ba = null;
  function Da(t) {
    if (null === Pa) {
      ...
      const i = n.getBoundingClientRect().right;
  ...
  const Fa = (function () {
    function t(e, r) {
      ...
      ((this.onScroll = function () {
        ...
        (this.drag = function (e) {
          const r = n.axis[n.draggedAxis].track,
    ...
    ((t.getRtlHelpers = function () {
      ...
      r.scrollLeft = 0;
      const i = t.getOffset(r),
        o = t.getOffset(n);
      r.scrollLeft = 999;
      const s = t.getOffset(n);
      return {
    ...
    return (
      ...
      (e.setAccessibilityAttributes = function () {
        const t = this.options.ariaLabel || "scrollable content";
      ...
      (e.recalculate = function () {
        ...
        ((this.contentEl.style.padding =
          ...
          (this.wrapperEl.style.margin =
            ...
            " -" +
            this.elStyles.paddingLeft));
        const a = this.contentEl.scrollHeight,
          c = this.contentEl.scrollWidth;
        ((this.contentWrapperEl.style.height = e ? "auto" : "100%"),
          (this.placeholderEl.style.width = r ? n + "px" : "auto"),
          (this.placeholderEl.style.height = a + "px"));
        const l = this.contentWrapperEl.offsetHeight;
        ...
        const u = this.axis.x.isOverflowing ? this.scrollbarWidth : 0,
      ...
      (e.positionScrollbar = function (e) {
        if ((void 0 === e && (e = "y"), this.axis[e].isOverflowing)) {
          let r = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
      ...
      (e.showScrollbar = function (t) {
        void 0 === t && (t = "y");
        const e = this.axis[t].scrollbar.el;
      ...
      (e.onTrackClick = function (t, e) {
        ...
        if ((void 0 === e && (e = "y"), this.options.clickOnTrack)) {
          ...
          let i = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr],
