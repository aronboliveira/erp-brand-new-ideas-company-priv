...
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="overtime-delete-form-"][data-url][data-guard-msg]')) ?? [];
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[overtimeDestroy] Error:`, err);
                    }
                });
            }
            catch (err) {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="overtime-delete-link-"][data-url][data-guard-msg]')) ?? [];
        links.forEach(l => {
            try {
...
//# sourceMappingURL=overtimeDestroy.js.map