/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/loanStore.js
 * @generated from original JavaScript - manual review recommended
 * @module loanStore
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="loan-store-form-"][data-url][data-guard-msg]')) ?? [];
        if (forms.length === 0)
            return;
        forms.forEach(fm => {
            try {
                ...
                fm.addEventListener("submit", (e) => {
                    try {
                        ...
                        console.error(`[loanStore] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=loanStore.js.map