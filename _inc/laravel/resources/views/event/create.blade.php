{{ Collective\Html\FormFacade::open(['url' => 'event', 'method' => 'post']) }}
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('branch_id', __('Branch'), ['class' => 'col-form-label']) }}
        ...
        <div class="col-md-4">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('department_id', __('Department'), ['class' => 'col-form-label']) }}
        ...
        <div class="col-md-4">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('employee_id', __('Employee'), ['class' => 'col-form-label']) }}
        ...
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('title', __('Event Title'), ['class' => 'col-form-label']) }}
                {{ Collective\Html\FormFacade::text('title', null, ['class' => 'form-control', 'placeholder' => __('Enter Event Title')]) }}
            </div>
        </div>
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('start_date', __('Event start Date'), ['class' => 'col-form-label']) }}
                {{ Collective\Html\FormFacade::date('start_date', null, ['class' => 'form-control datetime-local', 'autocomplete'=>'off']) }}
            </div>
        </div>
        <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6">
            <div class="form-group">
                {{ Collective\Html\FormFacade::label('end_date', __('Event End Date'), ['class' => 'col-form-label']) }}
                {{ Collective\Html\FormFacade::date('end_date', null, ['class' => 'form-control datetime-local','autocomplete'=>'off' ]) }}
            </div>
        </div>
        <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
            <div class="form-group">
        ...
        <div class="form-group">
            {{ Collective\Html\FormFacade::label('description', __('Event Description'), ['class' => 'col-form-label']) }}
            {{ Collective\Html\FormFacade::textarea('description', null, ['class' => 'form-control', 'placeholder' => __('Enter Event Description'),'rows'=>'5']) }}
        </div>
