/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/receivables/pdf.js
...
(function () {
    ...
    const saveAsPDF = () => {
        ...
        const rawName = $("#filename").val(), name = (typeof rawName === "string" ? rawName : String(rawName ?? "")).trim(), opt = {
            margin: 0.3,
            filename: name,
    ...
    const syncDates = () => {
        try {
            const startRaw = $(".startDate").val(), endRaw = $(".endDate").val(), startVal = typeof startRaw === "string" ? startRaw : "", endVal = typeof endRaw === "string" ? endRaw : "";
