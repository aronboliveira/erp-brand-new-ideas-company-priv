<?php
return [
    'password' => 'Пароли должны быть не менее восьми символов и совпадать с подтверждением.',
    ...
    'throttled' => 'Вы недавно запросили сброс пароля. Пожалуйста, проверьте вашу почту.',
];
