/**
 * Auto-generated Playwright tests for plans routes
...
test.describe('plans.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/plans-create.html');
...
test.describe('plans.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/plans-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('plans.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/plans-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('plans.paymentwall', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/plans-paymentwall.html');
    await page.waitForLoadState('networkidle');
