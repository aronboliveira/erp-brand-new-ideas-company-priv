...
{{ Collective\Html\FormFacade::model($milestone, array('route' => array('project.milestone.update', $milestone->id), 'method' => 'POST')) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {!! Collective\Html\FormFacade::select('status',\App\Models\Project::$project_status, null,array('class' => 'form-control selectric select','required'=>'required')) !!}
            @error('client')
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Collective\Html\FormFacade::date('due_date', null, array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group  col-md-12">
            {{ Collective\Html\FormFacade::label('cost', __('Cost'),['class' => 'col-form-label']) }}
            {{ Collective\Html\FormFacade::number('cost', null, array('class' => 'form-control','required'=>'required','stage'=>'0.01')) }}
        </div>
    </div>
    <div class="row">
        <div class="form-group  col-md-12">
