...
?>
<!DOCTYPE html>
<html lang="<?php echo e($lang ?? str_replace('_', '-', is_string(app()->getLocale()) ? app()->getLocale() : DatabaseConstants::DEFAULT_LANG)); ?>" dir="<?php echo e($siteRtl == 'on' ? 'rtl' : ''); ?>">
    ...
    <body class="<?php echo e($color); ?>">
        ...
        <?php echo $__env->make('Chatify::layouts.footer_links', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <script async src="<?php echo e(asset('assets/js/routes/generics/lang/utility.js')); ?>"></script>
        <script defer src="<?php echo e(asset('assets/js/routes/generics/utility.js')); ?>"></script>
        <script>
...
<?php /**PATH /home/aronboliveira/Desktop/programming/Prestech/erp/erpgo-fork/erp_prestech/_inc/laravel/resources/views/layouts/admin.blade.php ENDPATH**/ ?>