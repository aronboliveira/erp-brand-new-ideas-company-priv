...
@section('content')
    <div class="row">
        {{ Collective\Html\FormFacade::model($bill, array('route' => array(ViewsConstants::BIL.'.update', $bill->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vendor-box">
                                ...
                                {{ Collective\Html\FormFacade::select('vendor_id', $vendors,null, array('class' => 'form-control select','id'=>'vendor','data-url'=>route(ViewsConstants::BIL.'.vendor'),'required'=>'required')) }}
                            </div>
                                ...
                                @foreach($fields as $f)
                                    <div class="col-md-{{ $f['cols'] }}">
                                        <div class="form-group">
                                            ...
                                            @php
                                                $attrs = array_merge(['class' => 'form-control'], $f['attrs'] ?? []);
                                            @endphp
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0">
                                        {{ Collective\Html\FormFacade::select('items', $product_services,null, array('class' => 'form-control select item','data-url'=>route(ViewsConstants::BIL.'.product'))) }}
                                    </td>
                                    <td>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route(ViewsConstants::BIL.'.index')}}';" class="btn btn-light me-3">
