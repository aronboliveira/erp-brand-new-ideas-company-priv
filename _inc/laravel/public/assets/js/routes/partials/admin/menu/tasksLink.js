/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/tasksLink.js
 * @generated from original JavaScript - manual review recommended
 * @module tasksLink
 */
(() => {
    const listenerAttr = "data-tasks-listener-active", el = document.getElementById("tasks-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[tasksLink] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("tasks-link"))
            observer.disconnect();
    });
    observer.observe(document.body, { childList: true, subtree: true });
})();
//# sourceMappingURL=tasksLink.js.map