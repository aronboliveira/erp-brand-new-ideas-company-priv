                        ...
                        <div class="row ">
                            <div class="col-6">
                                <ul class="list-unstyled my-5">
                                    ...
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i class="text-primary ti ti-circle-plus"></i></span>{{($plan->max_vendors==-1)?__('Unlimited'):$plan->max_vendors}} {{__('Vendors')}}</li>
