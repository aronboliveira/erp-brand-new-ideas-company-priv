...
- `_inc/laravel/utils/.llms/landingpage/` — Documentation updates
...
1. Read `_inc/laravel/utils/.llms/landingpage/CONTEXT.md` for architecture overview
2. Read `_inc/laravel/utils/.llms/landingpage/CHANGELOG.md` for recent fixes
...
5. Run validation: `bash _inc/laravel/utils/.llms/landingpage/operations.sh validate`
...
bash _inc/laravel/utils/.llms/landingpage/operations.sh validate

# Individual commands
bash _inc/laravel/utils/.llms/landingpage/operations.sh syntax
bash _inc/laravel/utils/.llms/landingpage/operations.sh test
bash _inc/laravel/utils/.llms/landingpage/operations.sh curl
bash _inc/laravel/utils/.llms/landingpage/operations.sh routes
bash _inc/laravel/utils/.llms/landingpage/operations.sh db:check
```
