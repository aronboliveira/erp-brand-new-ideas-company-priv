...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        @can('create goal type')
            <a href="#" data-url="{{ route('goal_types.create') }}" data-ajax-popup="true" data-title="{{__('Create New Goal Type')}}" data-bs-toggle="tooltip" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        ...
                                        @can('delete goal type')
                                            <div class="action-btn bg-danger ms-2">
                                                {!! Collective\Html\FormFacade::open(['method' => 'DELETE', 'route' => ['goal_types.destroy', $goaltype->id],'id'=>'delete-form-'.$goaltype->id]) !!}
