...
class BillsConstants
{
	...
	public const COL_BL_NAME = 'billing_name';
	public const COL_BL_EMAIL = 'billing_email';
	public const COL_BL_ADR = 'billing_address';
	public const COL_BL_TEL = 'billing_phone';
	public const COL_BL_ZIP = 'billing_zip';
	public const COL_BL_CTY = 'billing_city';
	public const COL_BL_ST = 'billing_state';
