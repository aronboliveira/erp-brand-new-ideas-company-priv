/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/userLink.js
 * @generated from original JavaScript - manual review recommended
 * @module userLink
 */
(() => {
    const listenerAttr = "data-user-index-listener-active", el = document.getElementById("user-index-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[userLink] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("user-index-link"))
            observer.disconnect();
    });
