...
@endphp
{{ Collective\Html\FormFacade::model($category, array('route' => array(ViewsConstants::PRD_SV_CAT.'.update', $category->id), 'method' => 'PUT')) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Collective\Html\FormFacade::text('color', null, array('class' => 'form-control jscolor','required'=>'required')) }}
