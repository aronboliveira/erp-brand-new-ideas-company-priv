...
$user = Auth::user();
        ...
        \Log::error('reports/receivable_report — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@section(YieldingConstants::ADM_BDC)
    ...
    <li class="{{ VC::BCI }}">{{ __('Receivable Reports') }}</li>
@endsection
...
@endphp
                                <div class="{{ VC::TAB_FD_SH }} active" id="customer_balance" role="tabpanel" aria-labelledby="receivable-tab1">
                                    <table class="{{ VC::TB }} table-flush" id="report-customer-balance">
                                        ...
                                        <tr>
                                            ...
                                            <th class="{{ VC::TX_END }}">{{ __('Balance') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @php
...
@endphp
                                        ...
                                        @empty
                                            <tr><td colspan="4" class="{{ VC::TXCT_MT }}">{{ __('No data found') }}</td></tr>
                                        @endforelse
                                        ...
                                        @if(($receivableCustomers ?? []) !== [])
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <th class="{{ VC::TX_END }}">{{ $user?->priceFormat($grandTotal) }}</th>
                                            </tr>
                                        @endif
                                        </tbody>
                                    </table>
...
@endphp
                                        ...
                                        @empty
                                            <tr><td colspan="7" class="{{ VC::TXCT_MT }}">{{ __('No data found') }}</td></tr>
                                        @endforelse
...
@endphp
                                        ...
                                        @empty
                                            <tr><td colspan="9" class="{{ VC::TXCT_MT }}">{{ __('No data found') }}</td></tr>
                                        @endforelse
