...
//            }
            ...
            return view('payment.index', compact('payments', 'account', 'category', 'vendor'));
        }
        else
        {
...
//            $categories = ProductServiceCategory::where('created_by', '=', \Auth::user()->creatorId())->where('type', '=', 2)->get()->pluck('name', 'id');
            ...
            return view('payment.create', compact('vendors', 'categories', 'accounts','chartAccounts'));
        }
        else
        {
...
//            dd($chartAccountId);
    ...
    public function edit(Payment $payment)
    {
        ...
        if(\Auth::user()->can('edit payment'))
        {
            ...
            return view('payment.edit', compact('vendors', 'categories', 'accounts', 'payment','chartAccounts'));
        }
        else
        {
            return response()->json(['error' => __('Permission denied.')], 401);
