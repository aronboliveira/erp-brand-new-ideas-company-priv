...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/leads/users.js
...
(() => {
    ...
    if (!$) {
        try {
            ...
            console.error(`[users] Error:`, _);
        }
        return;
    }
    const ERR_FB = "# ERROR", DCL = "data-client-localized", DGM = "data-guard-msg", DSL = "data-sv-localized", DPL = "data-pointer-listener", FORM_ID = "leads-users-form", MSG_KEY = "leads_users_update_route_unavailable";
    ...
    const showError = (el) => {
        ...
        if (hasBootstrapCss() && window.bootstrap) {
            let wrap = document.getElementById("toast-wrap-leads-users");
            if (!wrap) {
                wrap = document.createElement("div");
                wrap.id = "toast-wrap-leads-users";
