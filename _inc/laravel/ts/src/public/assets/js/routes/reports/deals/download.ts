...
((): void => {
  try {
    ...
    const flag = "data-download-deals-report-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for deals report is unavailable. Please contact technical support or your domain administrator.";
