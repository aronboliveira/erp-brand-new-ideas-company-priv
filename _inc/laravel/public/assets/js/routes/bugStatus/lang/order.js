(() => {
    ...
    const t = {
        ...
        de: {
            bugstatus_order_failed: "Aktualisierung der Statusreihenfolge fehlgeschlagen.",
        },
        ...
        it: {
            bugstatus_order_failed: "Aggiornamento dell’ordine di stato non riuscito.",
        },
        ja: { bugstatus_order_failed: "ステータス順序の更新に失敗しました。" },
        nl: { bugstatus_order_failed: "Bijwerken van statusvolgorde mislukt." },
        pl: {
            bugstatus_order_failed: "Aktualizacja kolejności statusu nie powiodła się.",
        },
