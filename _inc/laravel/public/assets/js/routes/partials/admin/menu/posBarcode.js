/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/posBarcode.js
 * @generated from original JavaScript - manual review recommended
 * @module posBarcode
 */
(() => {
    const listenerAttr = "data-pos-barcode-listener-active", el = document.getElementById("pos-barcode-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[posBarcode] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("pos-barcode-link"))
            observer.disconnect();
    });
    observer.observe(document.body, { childList: true, subtree: true });
})();
//# sourceMappingURL=posBarcode.js.map