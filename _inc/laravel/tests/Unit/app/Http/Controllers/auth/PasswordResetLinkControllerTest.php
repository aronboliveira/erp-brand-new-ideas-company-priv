...
/**
 * Comprehensive tests for PasswordResetLinkController
...
class PasswordResetLinkControllerTest extends TestCase
{
    ...
    public function test_constant_CRT_equals_create_1(): void
    {
        $this->assertSame('create', PasswordResetLinkController::CRT);
    }

    public function test_constant_STR_equals_store_2(): void
    {
        $this->assertSame('store', PasswordResetLinkController::STR);
    }

    public function test_create_3(): void
    {
        $this->loginMockUser();
        $ctrl = new PasswordResetLinkController();
        try {
    ...
    public function test_create_empty_post_4(): void
    {
        $this->loginMockUser();
        $ctrl = new PasswordResetLinkController();
        try {
    ...
    public function test_create_json_5(): void
    {
        $this->loginMockUser();
        $ctrl = new PasswordResetLinkController();
        try {
     ...
     * @group performance
     */
    public function test_create_performance_6(): void
    {
        $this->loginMockUser();
        $ctrl = new PasswordResetLinkController();
