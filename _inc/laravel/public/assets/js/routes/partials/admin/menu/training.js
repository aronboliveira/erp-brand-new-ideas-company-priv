/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/training.js
 * @generated from original JavaScript - manual review recommended
 * @module training
 */
(() => {
    const listenerAttr = "data-training-listener-active", el = document.getElementById("training-index-link");
