/**
 * Auto-generated Playwright tests for purchases routes
...
test.describe('purchases.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/purchases-create.html');
...
test.describe('purchases.customer_bill', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/purchases-customer_bill.html');
    await page.waitForLoadState('networkidle');
...
test.describe('purchases.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/purchases-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('purchases.payment', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/purchases-payment.html');
    await page.waitForLoadState('networkidle');
...
test.describe('purchases.view', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/purchases-view.html');
    await page.waitForLoadState('networkidle');
