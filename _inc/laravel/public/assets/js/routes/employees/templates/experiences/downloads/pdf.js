...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/employees/templates/experiences/downloads/pdf.js
 * @generated from original JavaScript - manual review recommended
 * @module pdf
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="experience-certificate-download-pdf-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
