...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/transactions.js
 * @generated from original JavaScript - manual review recommended
 * @module transactions
 */
(() => {
    const listenerAttr = "data-transaction-listener-active", el = document.getElementById("cashflow-link");
