/**
 * Auto-generated Playwright tests for training_types routes
...
test.describe('training_types.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/training_types-create.html');
...
test.describe('training_types.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/training_types-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('training_types.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/training_types-index.html');
    await page.waitForLoadState('networkidle');
