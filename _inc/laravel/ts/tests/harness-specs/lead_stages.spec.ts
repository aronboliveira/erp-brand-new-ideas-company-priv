/**
 * Auto-generated Playwright tests for lead_stages routes
...
test.describe('lead_stages.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/lead_stages-create.html');
...
test.describe('lead_stages.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/lead_stages-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('lead_stages.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/lead_stages-index.html');
    await page.waitForLoadState('networkidle');
