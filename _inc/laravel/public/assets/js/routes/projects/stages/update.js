        ...
        f.addEventListener("submit", function (e) {
            try {
                ...
                const msg = f.getAttribute("data-guard-msg") ??
                    "Update project stage route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = document.querySelector('link[href*="bootstrap"]') &&
