...
<head>
    ...
    <style type="text/css">
        ...
        * {margin: 0;
        ...
        .purchase-footer h6 {font-size: 45px;
            line-height: 1.2em;
            font-weight: 400;
            margin-top: 15px;
        ...
        <div class="purchase-header">
            <table>
                <tbody>
                    <tr>
                        <td>
                            <h3 style="text-transform:uppercase;font-size:40px;font-weight:bold;color:var(--theme-color);margin-bottom:10px;"><?= e(__('PURCHASE')) ?></h3>
