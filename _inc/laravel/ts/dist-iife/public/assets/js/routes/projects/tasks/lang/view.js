(() => {
    ...
    const t = {
        ...
        de: {
            ...
            color_change_unavailable: "Aktualisierung der Aufgabenprioritätsfarbe fehlgeschlagen",
        },
        en: {
        ...
        es: {
            ...
            color_change_unavailable: "No se puede actualizar el color de prioridad de la tarea",
        },
        fr: {
            color_picker_unavailable: "Impossible d’initialiser le sélecteur de couleur",
            color_change_unavailable: "Impossible de mettre à jour la couleur de priorité de la tâche",
        },
        he: {
        ...
        it: {
            ...
            color_change_unavailable: "Impossibile aggiornare il colore di priorità del task",
        },
        ja: {
        ...
        pl: {
            ...
            color_change_unavailable: "Nie można zaktualizować koloru priorytetu zadania",
        },
        pt: {
            color_picker_unavailable: "Não foi possível iniciar o seletor de cores",
            color_change_unavailable: "Não foi possível atualizar a cor de prioridade da tarefa",
        },
        "pt-br": {
            color_picker_unavailable: "Não foi possível iniciar o seletor de cores",
            color_change_unavailable: "Não foi possível atualizar a cor de prioridade da tarefa",
