...
//        if($user->type =='employee')
    ...
    public function showVendorLoginForm($lang = '')
    {
        if($lang == '')
        {
            $lang = Utility::getValByName('default_language');
        ...
        return view('auth.vendor_login', compact('lang'));
    }
    ...
    public function vendorLogin(Request $request)
    {
        ...
        {
            if(\Auth::guard('vendor')->user()->is_active == 0)
            {
    ...
    public function showVendorLoginLang($lang = '')
    {
        if($lang == '')
        {
            $lang = Utility::getValByName('default_language');
    ...
    public function updateVendorPassword(Request $request)
    {
        ...
        $user = Vendor::where('email', $request->email)->update(['password' => Hash::make($request->password)]);
