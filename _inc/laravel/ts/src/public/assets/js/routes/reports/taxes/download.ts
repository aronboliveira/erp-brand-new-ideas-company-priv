...
((): void => {
  try {
    ...
    const flag = "data-download-tax-reports-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for Tax Reports is unavailable. Please contact technical support or your domain administrator.";
