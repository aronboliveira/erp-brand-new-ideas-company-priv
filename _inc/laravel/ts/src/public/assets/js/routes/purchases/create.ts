...
((): void => {
  try {
    ...
    const flag = "data-create-purchase-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          const a =
            e.target &&
            (e.target.closest ? e.target.closest("a.create-purchase") : null);
          if (!a) return;
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Create purchase route is unavailable. Please contact technical support or your domain administrator.";
