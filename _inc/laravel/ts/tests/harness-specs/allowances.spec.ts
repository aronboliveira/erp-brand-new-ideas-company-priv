/**
 * Auto-generated Playwright tests for allowances routes
...
test.describe('allowances.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/allowances-create.html');
...
test.describe('allowances.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/allowances-edit.html');
    await page.waitForLoadState('networkidle');
