/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/accountStatement.js
 * @generated from original JavaScript - manual review recommended
 * @module accountStatement
 */
(() => {
    const listenerAttr = "data-account-statement-listener-active", el = document.getElementById("account-statement-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[accountStatement] Error:`, error);
            }
        });
    }
