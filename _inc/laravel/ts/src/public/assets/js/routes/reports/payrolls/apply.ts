...
((): void => {
  try {
    ...
    const flag = "data-apply-payroll-report-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            f.getAttribute("data-guard-msg") ?? "Payroll apply route is unavailable. Please contact technical support or your domain administrator.";
