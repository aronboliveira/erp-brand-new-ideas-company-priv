                                ...
                                <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid <?= $color ?>">
                                    <div data-v-7d9d14b5="" class=" row">
                                        <div data-v-7d9d14b5="" class="col-3">
                                            <h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: <?php echo ($color == '#ffffff') ? 'black' : $color; ?>;"><?php echo __('ESTIMATION'); ?></h1>
                                            <h3 data-v-7d9d14b5=""><?php echo $usr->estimateNumberFormat($estimation->estimation_id); ?></h3>
                                            <p data-v-7d9d14b5=""><?php echo $usr->dateFormat($estimation->issue_date); ?></p>
                                        </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="break-25"></div>
                                    <div data-v-7d9d14b5="">
                                        <h1 data-v-7d9d14b5="" style="color: <?php echo ($color == '#ffffff') ? 'black' : $color; ?>;"><?php echo __('Thank you!'); ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
