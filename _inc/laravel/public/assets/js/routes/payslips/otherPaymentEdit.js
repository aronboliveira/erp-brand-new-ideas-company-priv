...
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="other-payment-edit-link-"][data-url][data-guard-msg]')) ?? [];
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
                ...
                l.addEventListener("click", (e) => {
                    try {
                        ...
                        console.error(`[otherPaymentEdit] Error:`, err);
                    }
                });
            }
            catch (err) {
...
//# sourceMappingURL=otherPaymentEdit.js.map