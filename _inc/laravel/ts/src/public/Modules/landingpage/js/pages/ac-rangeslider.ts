/**
 * @fileoverview TypeScript version of public/Modules/landingpage/js/pages/ac-rangeslider.js
...
(() => {
  try {
    ...
    let r: Slider, g: Slider, b: Slider;
    ...
    r = new Slider("#R", { reversed: true }).on("slide", RGBChange);
    g = new Slider("#G", { reversed: true }).on("slide", RGBChange);
    b = new Slider("#B", { reversed: true }).on("slide", RGBChange);
    ...
    // [ Precision-slider ]
    const sliderEx9 = new Slider("#ex9", {
      precision: 2,
      value: 8.115,
    });
    ...
    // [ step-slider ]
    const sliderEx11 = new Slider("#ex11", {
      step: 20000,
      min: 0,
      max: 200000,
    });
    ...
    // [ low & high-slider ]
    const sliderA12 = new Slider("#ex12a", {
      id: "slider12a",
      min: 0,
      max: 10,
      value: 5,
    });
    const sliderB12 = new Slider("#ex12b", {
      id: "slider12b",
      min: 0,
      max: 10,
      range: true,
    ...
    const sliderC12 = new Slider("#ex12c", {
      id: "slider12c",
      min: 0,
      max: 10,
      range: true,
    ...
    // [ logarithmic-slider ]
    const sliderEx15 = new Slider("#ex15", {
      min: 1000,
      max: 10000000,
      scale: "logarithmic",
      step: 10,
    ...
    // [ Focus-slider ]
    const sliderA16 = new Slider("#ex16a", {
      min: 0,
      max: 10,
      value: 0,
      focus: true,
    });
    const sliderB16 = new Slider("#ex16b", {
      min: 0,
      max: 10,
      value: [0, 10],
      focus: true,
    ...
    // [ Unusual-slider ]
    const sliderA17 = new Slider("#ex17a", {
      min: 0,
      max: 10,
      value: 0,
      tooltip_position: "bottom",
    });
    const sliderB17 = new Slider("#ex17b", {
      min: 0,
      max: 10,
      value: 0,
    ...
    const sliderA18 = new Slider("#ex18a", {
      min: 0,
      max: 10,
      value: 5,
      labelledby: "ex18-label-1",
    });
    const sliderB18 = new Slider("#ex18b", {
      min: 0,
      max: 10,
      value: [3, 6],
