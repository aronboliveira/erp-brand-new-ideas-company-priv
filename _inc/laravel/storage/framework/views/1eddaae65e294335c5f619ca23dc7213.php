        ...
        <div class="m-header main-logo">
            <a href="#" class="b-brand">
                ...
                <?php if($colorSettings[SC::CST_DRK] && $colorSettings[SC::CST_DRK] == 'on'): ?>
                    <img src="<?php echo e((isset($company_logos) && !empty($company_logos) ? asset($company_logos) : asset(SC::CPN_LG_DK_DEF))); ?>"
                        alt="<?php echo e(config('app.name', 'ERPNovaPrestech')); ?>" class="<?php echo e(VC::LOGO_LG); ?>">
                <?php else: ?>
                    <img src="<?php echo e((isset($company_logo) && !empty($company_logo) ? asset($company_logo) : asset(SC::CPN_LG_LT_DEF))); ?>"
                        alt="<?php echo e(config('app.name', 'ERPNovaPrestech')); ?>" class="<?php echo e(VC::LOGO_LG); ?>">
                <?php endif; ?>
            </a>
        </div>
            ...
            <?php if($user instanceof User): ?>
                <?php if($user[UsersConstants::COL_TP] !== PMC::CL): ?>
                    <ul class="dash-navbar">
                        <?php if(Gate::check(PMC::SHW_HRM_DSB) ||
                            ...
                            <li class="<?php echo e(VC::DSH_IT_MN); ?> <?php echo e($isIncomeMatch ? 'active dash-trigger' : ''); ?>">
                                ...
                                <ul class="dash-submenu">
                                    <?php if(($userPlan?->{PLC::COL_ACC} == 1 && Gate::check(PMC::SHW_ACC_DSB)) || $isSa): ?>
                                        <?php
                                            $segments = [
                                                null,
                                                VW::ACC_DSB,
                                    ...
                                    <?php endif; ?>
                                    <?php if((!empty($userPlan) && $userPlan?->{PLC::COL_HRM} == 1) || $isSa): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if((!empty($userPlan) && $userPlan?->{PLC::COL_CRM} == 1) || $isSa): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if($userPlan?->{PLC::COL_PJ} == 1 || $isSa): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if((!empty($userPlan) && $userPlan?->{PLC::COL_POS} == 1) || $isSa): ?>
                        ...
                        <?php endif; ?>
                        <?php if((!empty($userPlan) && $userPlan?->{PLC::COL_HRM} == 1) || $isSa): ?>
                            <?php if(Gate::check(PMC::MNG_EMP) || Gate::check(PMC::MNG_SSL) || $isSa): ?>
                                <?php
                                    $segments = [
                                        VW::ALW_OPT,
                                        VW::ANC,
                                ...
                                <li
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        <?php $__env->stopPush(); ?>
                                        <?php if(Gate::check(PMC::MNG_SSL) || Gate::check(PMC::MNG_PSL) || $isSa): ?>
                                            <?php
                                                $segments = [
                                                    VW::PY_SLP,
                                                    VW::S_SLR
                                        ...
                                        <?php endif; ?>
                                        <?php if(Gate::check(PMC::MNG_LV) || Gate::check(PMC::MNG_ATD) || $isSa): ?>
                                            <?php
                                                $segments = [
                                                    VW::EMP_ATD,
                                                    VW::LV
                                            ...
                                            ?>
                                            <li
                                                class="<?php echo e(VC::DSH_IT_MN); ?>  <?php echo e($isAttendanceLeave ? 'active dash-trigger' : ''); ?>">
                                        ...
                                        <?php endif; ?>
                                        <?php if(Gate::check(PMC::MNG_IND) || Gate::check(PMC::MNG_APR) || Gate::check(PMC::MNG_GTR) || $isSa): ?>
                                            <?php
                                                $segments = [
                                                    VW::APR,
                                                    VW::GL_TRC,
                                        ...
                                        <?php endif; ?>
                                        <?php if(Gate::check(PMC::MNG_TNG) || Gate::check(PMC::MNG_TNR) || Gate::check(PMC::SHW_TNG) || $isSa): ?>
                                            <?php
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if((!empty($userPlan) &&  $userPlan?->{PLC::COL_ACC} == 1) || $isSa): ?>
                            <?php
                                $permissions = [
                                    PMC::MNG_CST,
                                    PMC::MNG_VD,
                ...
                <?php if((!empty($userPlan) && $userPlan?->{PLC::COL_PJ} == 1) || $isSa): ?>
                ...
                ?>
                <?php if($hasUserAdminPermission || $isSa): ?>
                    <?php
                       $segments = [
                            VW::CLT,
                            VW::RL,
                ...
                <?php if(Gate::check(PMC::MNG_PRD_SV) || $isSa): ?>
                ...
                <?php if(($user[UsersConstants::COL_TP] != PMC::ADM) || $isSa): ?>
                    <?php
                    ...
                    <?php $__env->stopPush(); ?>
                <?php endif; ?>
                <?php if($user[UsersConstants::COL_TP] == PMC::CPN || $user[UsersConstants::COL_TP] == PMC::SA): ?>
                    <?php
                ...
                <?php if($user[UsersConstants::COL_TP] === PMC::CL || $isSa): ?>
                    <ul class="dash-navbar">
