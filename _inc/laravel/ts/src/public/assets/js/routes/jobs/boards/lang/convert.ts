/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/boards/lang/convert.js
...
declare global {
  interface Window {
    ...
    __APP_LANG__?: string | Record<string, unknown>;
  }
}

((): void => {
  window.__APP_LANG__ = Object.assign({}, (window.__APP_LANG__ || {}) as Record<string, unknown>, {
