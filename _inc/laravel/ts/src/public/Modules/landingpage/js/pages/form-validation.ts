/**
 * @fileoverview TypeScript version of public/Modules/landingpage/js/pages/form-validation.js
...
import type { BouncerConstructor as BouncerConstructorLp } from "../../../../../declarations/pages/form-validation";

const _bouncerLp = new Bouncer("[data-validate]", {
  disableSubmit: true,
  customValidations: {
