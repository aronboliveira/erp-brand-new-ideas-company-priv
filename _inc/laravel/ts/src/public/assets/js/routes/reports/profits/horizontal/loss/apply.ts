/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/profits/horizontal/loss/apply.js
...
((): void => {
  try {
    const btn = document.getElementById("apply-profit-loss-horizontal");
    if (!btn) {
      return;
    }
