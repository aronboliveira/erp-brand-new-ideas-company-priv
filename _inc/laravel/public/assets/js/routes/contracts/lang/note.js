(function () {
    ...
    const t = {
        ...
        de: {
            ...
            contract_desc_save_unavailable: "Vertragsbeschreibung konnte nicht gespeichert werden.",
        },
        en: {
            plugin_unavailable: "A required library failed to load.",
            route_unavailable: "Invalid URL.",
            contract_desc_save_unavailable: "Could not save the contract description.",
        },
        es: {
            plugin_unavailable: "No se cargó una biblioteca requerida.",
            route_unavailable: "URL no válida.",
            contract_desc_save_unavailable: "No se pudo guardar la descripción del contrato.",
        },
        fr: {
            plugin_unavailable: "Une bibliothèque requise n’a pas été chargée.",
            route_unavailable: "URL non valide.",
            contract_desc_save_unavailable: "Impossible d’enregistrer la description du contrat.",
        },
        he: {
        ...
        it: {
            ...
            contract_desc_save_unavailable: "Impossibile salvare la descrizione del contratto.",
        },
        ja: {
        ...
        pt: {
            ...
            contract_desc_save_unavailable: "Não foi possível salvar a descrição do contrato.",
        },
        "pt-br": {
            plugin_unavailable: "Uma biblioteca necessária não foi carregada.",
