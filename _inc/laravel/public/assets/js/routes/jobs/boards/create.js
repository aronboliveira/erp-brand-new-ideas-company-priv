/**
 * @fileoverview TypeScript version of public/assets/js/routes/jobs/boards/create.js
 * @generated from original JavaScript - manual review recommended
 * @module create
 */
(() => {
    try {
        const links = Array.from(document.querySelectorAll('a[id^="job-onboard-create-btn-"][data-url][data-guard-msg]'));
        if (links.length === 0)
            return;
        links.forEach(l => {
            try {
