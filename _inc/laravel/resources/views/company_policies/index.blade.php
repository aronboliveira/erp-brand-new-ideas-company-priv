...
$lang = Utility::fetchUserLang();
        ...
        \Log::error('company_policies/index — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@section(YieldingConstants::ADM_BDC)
    ...
    <li class="{{ VC::BCI }}">{{ __('Company Policy') }}</li>
@endsection
...
@endphp
                                                    <div class="{{ VC::ACT_BTN_PRIM }}">
                                                        <a href="#" class="{{ VC::BT_SM }} {{ VC::AL_IT_CT }}" id="editPolicyBtn_{{ $pid }}" data-url="{{ $editRoute }}" data-guard-msg="{{ base64_encode($editGuardMsg) }}" data-listener-alias="edit-policy" data-ajax-popup="true" data-title="{{ __('Edit Company Policy') }}" data-bs-toggle="tooltip" title="{{ __('Edit') }}"><i class="ti ti-pencil {{ VC::TXT_WT }}"></i></a>
                                                    </div>
                                                @endcan
