        ...
        l.addEventListener("click", (e) => {
            try {
                ...
                const msg = l.getAttribute("data-guard-msg") ??
                    "POS barcode setting route is unavailable. Please contact technical support or your domain administrator.", hasBs = !!(document.querySelector('link[href*="bootstrap"]') &&
                    window.bootstrap);
