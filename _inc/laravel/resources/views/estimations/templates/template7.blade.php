                                ...
                                <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid <?= $color ?>">
                                    <div data-v-1ad6e3b9="" class=" row grey-box">
                                        ...
                                        <div data-v-1ad6e3b9="" class="col-33">
                                            <h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('ESTIMATION')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        ...
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="d-table">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-body">
                                                    ...
                                                    @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-3" style="border: 1px solid <?php echo $color; ?>; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-13" style="border: 1px solid <?php echo $color; ?>; padding: 5px;">
                                                            <pre data-v-1ad6e3b9="">-<br data-v-1ad6e3b9=""></pre>
                                                        </div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-3" style="border: 1px solid <?php echo $color; ?>; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-2" style="border: 1px solid <?php echo $color; ?>; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-3 text-end" style="border: 1px solid <?php echo $color; ?>; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                    </div>
                                                    @endif
                                                </div>
