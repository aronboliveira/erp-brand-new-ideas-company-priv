...
((): void => {
  try {
    ...
    const flag = "data-download-pos-vs-purchase-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for POS vs Purchase report is unavailable. Please contact technical support or your domain administrator.";
