/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/notificationTemplate.js
 * @generated from original JavaScript - manual review recommended
 * @module notificationTemplate
 */
(() => {
    const listenerAttr = "data-notification-template-listener-active", el = document.getElementById("notification-template-index-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[notificationTemplate] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("notification-template-index-link"))
            observer.disconnect();
    });
