/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/bug.js
 * @generated from original JavaScript - manual review recommended
 * @module bug
 */
(() => {
    const listenerAttr = "data-bug-view-list-listener-active", el = document.getElementById("bug-view-list-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("bug-view-list-link"))
            observer.disconnect();
    });
