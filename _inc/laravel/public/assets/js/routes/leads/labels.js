/**
 * @file Leads Labels Route Guard
 * @description Guards the leads labels form with MutationObserver support
 * @requires ERPGuard
 * @requires ERPUtils
 * @requires jQuery
 */
(() => {
  ...
  const FALLBACK_MSG =
    "Leads labels route is unavailable. Please contact technical support.";
