(() => {
    ...
    const t = {
        ...
        de: {
            ...
            purchase_preview_unavailable: "Bestellvorschau konnte nicht geladen werden",
        ...
        es: {
            ...
            purchase_preview_unavailable: "No se puede cargar la vista previa de compra",
        ...
        fr: {
            ...
            purchase_logo_unavailable: "Impossible d’afficher l’aperçu du logo d’achat",
        ...
        pt: {
            ...
            purchase_preview_unavailable: "Não foi possível carregar a pré-visualização de compra",
            purchase_logo_unavailable: "Não foi possível pré-visualizar o logotipo da compra",
            pos_preview_unavailable: "Não foi possível carregar a pré-visualização do POS",
            pos_logo_unavailable: "Não foi possível pré-visualizar o logotipo do POS",
        },
        "pt-br": {
            scrollspy_unavailable: "Não foi possível ativar o ScrollSpy",
            purchase_preview_unavailable: "Não foi possível carregar a prévia da compra",
        ...
        ru: {
            ...
            purchase_preview_unavailable: "Не удалось загрузить предварительный просмотр закупки",
            purchase_logo_unavailable: "Не удалось показать логотип закупки",
            pos_preview_unavailable: "Не удалось загрузить предварительный просмотр POS",
