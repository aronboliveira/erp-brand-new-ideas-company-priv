...
<html lang="{{ str_replace('_', '-', is_string(app()->getLocale()) ? app()->getLocale() : DatabaseConstants::DEFAULT_LANG) }}" dir="{{ $siteRtl === 'on' ? 'rtl' : 'ltr' }}">
    ...
    <body class="{{ $color }}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mt-2 pos-top-bar bg-color d-flex justify-content-between bg-primary">
                            ...
                            <a  href="{{ Route::has('dashboard') ? route('dashboard') : '#' }}" class="text-white"><i class="ti ti-home" style="font-size: 20px;"></i> </a>
                        </div>
                    </div>
                </div>
                <div class="mt-2 row">
                        ...
                        <div class="col-lg-5 ps-lg-0">
                            <div class="card m-0">
                                <div class="card-header p-2">
                                    <div class="row">
                                        <div class="col-md-6">
                                            {{ Collective\Html\FormFacade::select('customer_id', $customers,'', array('class' => 'form-control select customer_select','id'=>'customer','required'=>'required')) }}
                                            {{ Collective\Html\FormFacade::hidden('vc_name_hidden', '',['id' => 'vc_name_hidden']) }}

                                        </div>
                                        <div class="col-md-6">
                                            {{ Collective\Html\FormFacade::select('warehouse_id', $warehouses,'', array('class' => 'form-control select warehouse_select ','id'=>'warehouse','required'=>'required')) }}
                                            {{ Collective\Html\FormFacade::hidden('warehouse_name_hidden', '',['id' => 'warehouse_name_hidden']) }}
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                @foreach(session($lastsegment) as $id => $details)
                                                    ...
                                                    <tr data-product-id="{{$id}}" id="product-id-{{$id}}">
                                                        ...
                                                        <td class="col-sm-2 mt-2">
                                                            ...
                                                            {!! Collective\Html\FormFacade::open(['method' => 'delete', 'url' => ['remove-from-cart'],'id' => 'delete-form-'.$id]) !!}
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-6">
                                                    <div class="d-flex text-end justify-content-end align-items-center">
                                                        ...
                                                        {{ Collective\Html\FormFacade::number('discount',null, array('class' => ' form-control discount','required'=>'required','placeholder'=>__('Discount'))) }}
                                                        {{ Collective\Html\FormFacade::hidden('discount_hidden', '',['id' => 'discount_hidden']) }}
                                                    </div>
                                                </div>
                                                <div class="col-6">
        ...
        <div class="{{ ViewClassNamesConstants::MD_FD }}" id="commonModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
