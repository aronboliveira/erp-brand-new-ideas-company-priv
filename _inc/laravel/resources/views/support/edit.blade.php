...
@endphp
{{ Collective\Html\FormFacade::model($support,array('route' => array('support.update',$support->id),'method'=>'PUT','enctype'=>"multipart/form-data")) }}
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {{ Collective\Html\FormFacade::text(SupportsConstants::COL_SBJ, null, array('class' => 'form-control','required'=>'required')) }}
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            {{ Collective\Html\FormFacade::date(ProjectsConstants::COL_E_DT, null, array('class' => 'form-control','required'=>'required')) }}
        </div>
