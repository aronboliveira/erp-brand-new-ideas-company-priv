/**
 * Auto-generated Playwright tests for payments routes
...
test.describe('payments.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/payments-create.html');
...
test.describe('payments.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/payments-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('payments.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/payments-index.html');
    await page.waitForLoadState('networkidle');
