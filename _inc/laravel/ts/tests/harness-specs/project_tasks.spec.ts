/**
 * Auto-generated Playwright tests for project_tasks routes
 * Generated: 2026-03-08T23:55:10.530Z
 * 
 * Routes covered: project_tasks.create, project_tasks.edit, project_tasks.grid, project_tasks.list, project_tasks.taskboard, project_tasks.view
 */
import { test, expect } from '@playwright/test';


test.describe('project_tasks.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-create.html');
...
test.describe('project_tasks.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('project_tasks.grid', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-grid.html');
    await page.waitForLoadState('networkidle');
...
test.describe('project_tasks.list', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-list.html');
    await page.waitForLoadState('networkidle');
...
test.describe('project_tasks.taskboard', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-taskboard.html');
    await page.waitForLoadState('networkidle');
...
test.describe('project_tasks.view', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/project_tasks-view.html');
    await page.waitForLoadState('networkidle');
