...
((): void => {
  try {
    ...
    const flag = "data-apply-bill-summary-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            f.getAttribute("data-guard-msg") ?? "Bill summary report route is unavailable. Please contact technical support or your domain administrator.";
