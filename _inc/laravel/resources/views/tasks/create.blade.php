...
@endphp
{{ Collective\Html\FormFacade::open(['route' => ['projects.tasks.create',$project_id,$stage_id],'id' => 'create_task']) }}
<div class="row">
    <div class="col-8">
...
<div class="text-end">
    {{ Collective\Html\FormFacade::button(__('Save'), ['type' => 'submit','class' => 'btn btn-sm btn-primary rounded-pill']) }}
</div>
