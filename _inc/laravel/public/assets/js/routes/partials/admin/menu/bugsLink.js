/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/bugsLink.js
 * @generated from original JavaScript - manual review recommended
 * @module bugsLink
 */
(() => {
    const listenerAttr = "data-bugs-listener-active", el = document.getElementById("bugs-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[bugsLink] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("bugs-link"))
            observer.disconnect();
    });
    observer.observe(document.body, { childList: true, subtree: true });
})();
//# sourceMappingURL=bugsLink.js.map