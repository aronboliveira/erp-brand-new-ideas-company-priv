...
class Noc extends Model
{
    ...
    protected $table = DatabaseConstants::TABLE_NOC;
    ...
    protected $attributes = [
        TemplatesConstants::COL_LG => DatabaseConstants::DEFAULT_LANG,
    ];

    private const DEFAULT_NOC_CERTIFICATE = [
    ...
    private const DEFAULT_NOC_CERTIFICATE_REGISTER = [
    ...
    public static function defaultNocCertificate(?string $userId = null): void
    {
        ...
        foreach (self::DEFAULT_NOC_CERTIFICATE as $lang => $content) {
            try {
                self::firstOrCreate(
                    [
