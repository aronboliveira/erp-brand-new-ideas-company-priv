...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/cashflow/monthly/open.js
            ...
            el.addEventListener("click", (e) => {
                try {
                    ...
                    const msg = el.getAttribute("data-guard-msg") ??
                        "Monthly cashflow route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
