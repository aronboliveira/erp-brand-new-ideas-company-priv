...
@section('content')
    ...
    <div class="card bg-none card-box mt-3">
        <div class="card-body">
            {{ Collective\Html\FormFacade::model($budget, array('route' => array('budget.update', $budget->id), 'method' => 'PUT')) }}
            <div class="row">
            ...
            <div class="card-body table-border-style">
                ...
                <div class="table-responsive budget_plan d-block"  id="monthly">
                    ...
                    <div class="modal-footer">
                        <input type="button" value="{{__('Cancel')}}" onclick="
                            location.href = '{{ route("budget.index") }}' class="btn btn-light">
