                                ...
                                <div data-v-b8f60a0c="" class="d-inner">
                                    ...
                                    <div data-v-b8f60a0c="" class="row">
                                        <div data-v-b8f60a0c="" class="col-66">
                                            ...
                                            <p data-v-b8f60a0c=""><?php if ($settings['company_name']) echo $settings['company_name']; ?></p>
                                            <pre data-v-b8f60a0c=""><?php if ($settings['company_address']) echo $settings['company_address']; ?></pre>
                                            <p data-v-b8f60a0c=""><?php if ($settings['company_city']) echo $settings['company_city'] . ', '; ?><?php if ($settings['company_state']) echo $settings['company_state']; ?><?php if ($settings['company_zipcode']) echo ' - ' . $settings['company_zipcode']; ?></p>
                                            <p data-v-b8f60a0c=""><?php if ($settings['company_country']) echo $settings['company_country']; ?></p>
                                        </div>
                                        <div data-v-b8f60a0c="" class="col-33">
