...
@section(YieldingConstants::ADM_CTT)
    {{Collective\Html\FormFacade::model($job,array('route' => array('job.update', $job->id), 'method' => 'PUT')) }}
    <div class="row mt-3">
        <div class="col-md-6 ">
                ...
                <div class="card-body job-create ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            {!! Collective\Html\FormFacade::text('title', null, ['class' => 'form-control','required' => 'required']) !!}
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Collective\Html\FormFacade::text('position', null, ['class' => 'form-control','required' => 'required']) !!}
                        </div>
                        <div class="form-group col-md-6">
