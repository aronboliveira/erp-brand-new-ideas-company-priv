...
?>
<html lang="<?php echo e(str_replace('_', '-', is_string(app()->getLocale()) ? app()->getLocale() : DatabaseConstants::DEFAULT_LANG)); ?>" dir="<?php echo e($siteRtl === 'on' ? 'rtl' : 'ltr'); ?>">
    <head>
        <title>
...
<?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\resources\views/layouts/auth.blade.php ENDPATH**/ ?>