/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/budgetPlanner.js
 * @generated from original JavaScript - manual review recommended
 * @module budgetPlanner
 */
(() => {
    const listenerAttr = "data-budget-planner-listener-active", el = document.getElementById("budget-planner-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[budgetPlanner] Error:`, error);
            }
        });
    }
    const observer = new MutationObserver(() => {
        if (!document.getElementById("budget-planner-link"))
            observer.disconnect();
    });
    observer.observe(document.body, { childList: true, subtree: true });
})();
//# sourceMappingURL=budgetPlanner.js.map