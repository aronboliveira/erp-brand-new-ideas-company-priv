...
@section(YieldingConstants::ADM_ACT_BTN)
    <div class="float-end">
        {{ Collective\Html\FormFacade::open(['route' => ['profit.loss.print']]) }}
    ...
    <div class="float-end me-2">
        {{ Collective\Html\FormFacade::open(['route' => ['profit.loss.export']]) }}
        <input type="hidden" name="start_date" class="start_date">
        <input type="hidden" name="end_date" class="end_date">
    ...
    <div class="float-end me-2">
        <a href="{{ route(ViewsConstants::RPT . '.profit.loss' , 'horizontal')}}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Horizontal View') }}"
        ...
        <div class="col-sm-8">
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card" id="show_filter" style="display:none;">
                    <div class="card-body">
                        {{ Collective\Html\FormFacade::open(['route' => [ViewsConstants::RPT . '.profit.loss'], 'method' => 'GET', 'id' => 'report_trial_balance']) }}
