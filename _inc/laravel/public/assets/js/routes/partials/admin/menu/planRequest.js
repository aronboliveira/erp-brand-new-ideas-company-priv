/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/planRequest.js
 * @generated from original JavaScript - manual review recommended
 * @module planRequest
 */
(() => {
    const listenerAttr = "data-plan-request-listener-active", el = document.getElementById("plan-request-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("plan-request-index-link"))
            observer.disconnect();
    });
