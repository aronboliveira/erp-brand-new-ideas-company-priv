...
@section(YieldingConstants::ADM_CTT)
    {{ Collective\Html\FormFacade::model($journalEntry, array('route' => array('journal-entry.update', $journalEntry->id), 'method' => 'PUT','class'=>'w-100')) }}
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="form-group">
                        ...
                        {{ Collective\Html\FormFacade::textarea('description', null, array('class' => 'form-control','rows'=>'2')) }}
                    </div>
                </div>
            </div>
        </div>
...
{{--                                </td>--}}
                                ...
                                <td>
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::text('description',null, array('class' => 'form-control','placeholder'=>__('Description'))) }}
                                    </div>
                                </td>
