...
$user ??= null;
	...
	try {
		...
		Log::error('Error in loan_options/edit.blade.php main @php block', [
		...
		Log::error('Exception in loan_options/edit.blade.php main @php block', [
			'exception_class' => get_class($e),
			'message' => $e->getMessage(),
			'file' => $e->getFile(),
			'line' => $e->getLine(),
		...
		Log::error('Throwable in loan_options/edit.blade.php main @php block', [
			'exception_class' => get_class($e),
			'message' => $e->getMessage(),
			'file' => $e->getFile(),
			'line' => $e->getLine(),
