/**
 * @fileoverview TypeScript version of public/assets/js/routes/complaints/index.js
...
(() => {
    ...
    document
        .querySelectorAll('[data-listener-alias="edit-complaint"]')
        .forEach((el) => {
        bindGuard(el, "click");
    });
    document
        .querySelectorAll('[data-listener-alias="delete-complaint"]')
        .forEach((el) => {
        bindGuard(el, "click");
    });
})();
