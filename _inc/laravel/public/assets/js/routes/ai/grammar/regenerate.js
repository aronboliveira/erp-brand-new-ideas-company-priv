...
(() => {
    try {
        const out = document.getElementById("ai-description"), copy = document.getElementById("grammar-copy-btn");
        if (!out || !copy)
            return;
        ...
        if (!copy.getAttribute("data-listener-bound-click")) {
            ...
            copy.addEventListener("click", (e) => {
                try {
                    e.preventDefault();
                    const ok = out.getAttribute("data-copy-ok-msg") ??
                        "Text copied to clipboard.", err = out.getAttribute("data-copy-err-msg") ??
