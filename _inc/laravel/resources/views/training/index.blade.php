                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($trainings as $training)
                                <tr>
                                    ...
                                    @if( Gate::check('edit training') ||Gate::check('delete training') || Gate::check(PermissionsConstants::SHW_TNG))
                                        <td>
                                            ...
                                            @can('delete training')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Collective\Html\FormFacade::open(['method' => 'DELETE', 'route' => ['training.destroy', $training->id],'id'=>'delete-form-'.$training->id]) !!}
