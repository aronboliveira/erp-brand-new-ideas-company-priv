/**
 * Jest unit tests for restrict_ip routes
...
describe('restrict_ip.create', () => {
  // TypeScript sources: src/public/assets/js/routes/ips/create
  // Import would be: import * as module0 from 'src/public/assets/js/routes/ips/create';
