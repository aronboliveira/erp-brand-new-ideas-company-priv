/**
 * Auto-generated Playwright tests for partials routes
...
test.describe('partials.admin.footer', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/partials-admin-footer.html');
...
test.describe('partials.admin.header', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/partials-admin-header.html');
    await page.waitForLoadState('networkidle');
...
test.describe('partials.admin.menu', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/partials-admin-menu.html');
    await page.waitForLoadState('networkidle');
