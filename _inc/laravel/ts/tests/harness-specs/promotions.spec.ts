/**
 * Auto-generated Playwright tests for promotions routes
 * Generated: 2026-03-08T23:55:10.530Z
 * 
 * Routes covered: promotions.index
 */
import { test, expect } from '@playwright/test';


test.describe('promotions.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/promotions-index.html');
