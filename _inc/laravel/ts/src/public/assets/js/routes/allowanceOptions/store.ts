/**
 * @fileoverview TypeScript version of public/assets/js/routes/allowanceOptions/store.js
 * @generated from original JavaScript - manual review recommended
 * @module store
 */

((): void => {
  const form = document.getElementById("allowance-option-store-form");
  ...
  const observer = new MutationObserver((): void => {
    if (!document.getElementById("allowance-option-store-form"))
      observer.disconnect();
  });
