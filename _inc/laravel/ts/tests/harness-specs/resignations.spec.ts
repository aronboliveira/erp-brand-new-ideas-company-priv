/**
 * Auto-generated Playwright tests for resignations routes
...
test.describe('resignations.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/resignations-create.html');
...
test.describe('resignations.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/resignations-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('resignations.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/resignations-index.html');
    await page.waitForLoadState('networkidle');
