/**
 * @fileoverview TypeScript version of public/assets/js/routes/supports/lang/attachmentEdit.js
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    de: {
      attachment_preview_unavailable:
        "Anhang kann nicht in der Vorschau angezeigt werden",
    },
    ...
    fr: {
      attachment_preview_unavailable:
        "Impossible d’afficher l’aperçu de la pièce jointe",
    },
    he: {
    ...
    it: {
      attachment_preview_unavailable:
        "Impossibile visualizzare l’anteprima dell’allegato",
    },
    ja: {
    ...
    pl: {
      attachment_preview_unavailable:
        "Nie można wyświetlić podglądu załącznika",
    },
    pt: {
    ...
    ru: {
      attachment_preview_unavailable:
        "Не удаётся показать предварительный просмотр вложения",
    },
