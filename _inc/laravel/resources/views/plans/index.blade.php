...
@section(YD::ADM_CTT)
    <div class="{{ VC::RW }}">
        @forelse($plansList as $plan)
            ...
            <div class="plan_card">
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s" style="visibility:visible;animation-delay:0.2s;animation-name:fadeInUp;">
                    <div class="card-body">
                        <span class="price-badge bg-primary">{{ $pName }}</span>
                        ...
                        <h1 class="mb-4 f-w-600">
                            ...
                            <small class="text-sm">/{{ __($pDurText) }}</small>
                        </h1>
        ...
        @empty
            <div class="{{ VC::C12 }}">
                <div class="text-center text-muted py-4">{{ __('No plans found.') }}</div>
            </div>
        @endforelse
    </div>
@endsection
