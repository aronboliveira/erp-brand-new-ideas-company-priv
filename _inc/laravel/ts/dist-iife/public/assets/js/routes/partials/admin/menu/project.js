...
"use strict";
/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/project.js
 * @generated from original JavaScript - manual review recommended
 * @module project
 */
(() => {
    const listenerAttr = "data-projects-index-listener-active", el = document.getElementById("projects-index-link");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("projects-index-link"))
            observer.disconnect();
    });
