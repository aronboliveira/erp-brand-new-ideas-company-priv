        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <?php echo e(Collective\Html\FormFacade::model(null, array('route' => array('join_us.store'), 'method' => 'POST'))); ?>
                                    ...
                                    <div class="form-group mb-0">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="joinus_status"
                                                id="joinus_status"  <?php echo e($lpSettings[LandingPageSettingsConstants::JU_STT_K] == 'on' ? 'checked="checked"' : ''); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::JU_HDG_K, $lpSettings[LandingPageSettingsConstants::JU_HDG_K], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Collective\Html\FormFacade::text(LandingPageSettingsConstants::JU_DESC_K, $lpSettings[LandingPageSettingsConstants::JU_DESC_K], ['class' => 'form-control', 'placeholder' => __('Enter Description')])); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                                ...
                                                                <?php echo Collective\Html\FormFacade::open(['method' => 'DELETE', 'route' => ['join_us.destroy', $value->id],'id'=>'delete-form-'.$value->id]); ?>


                                                                    <a href="#" class="<?php echo e(ViewClassNamesConstants::BT_SM_CT_PR); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__(Utility::fetchLinkMessage($lang, 'generics', 'are_you_sure') ?? 'Are You Sure?')); ?>|<?php echo e(__(Utility::fetchLinkMessage($lang, 'generics', 'irreversible_action') ?? 'This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-form-<?php echo e($value->id); ?>').submit();">
...
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\Modules/LandingPage\Resources/views/landingpage/join_us.blade.php ENDPATH**/ ?>