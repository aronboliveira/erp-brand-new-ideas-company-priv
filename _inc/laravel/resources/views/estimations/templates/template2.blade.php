                                            ...
                                            <table data-v-37eeda86="" class="summary-table">
                                                <tbody data-v-37eeda86="">
                                                    <tr data-v-37eeda86="">
                                                        ...
                                                        <td data-v-37eeda86="" class="text-end"><?= $usr->estimateNumberFormat($estimation->estimation_id) ?></td>
                                                    </tr>
                                                    <tr data-v-37eeda86="">
                                                        <td data-v-37eeda86="" class="tu"><?= __('Issue Date') ?>:</td>
                                                        <td data-v-37eeda86="" class="text-end"><?= $usr->dateFormat($estimation->issue_date) ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <div data-v-37eeda86="" class="d-table-footer">
                                                ...
                                                <div class="d-table-summary">
                                                    <div class="d-table-summary-item">
                                                        ...
                                                        <div class="d-table-value">{{$usr->priceFormat($estimation->getSubTotal())}}</div>
                                                    </div>
                                                    @if($estimation->discount)
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">{{__('Discount')}}:</div>
                                                        <div class="d-table-value">{{$usr->priceFormat($estimation->discount)}}</div>
                                                    </div>
                                                    @endif
