/**
 * @fileoverview TypeScript version of public/assets/js/routes/creditNotes/lang/index.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    fr: {
      invoice_fetch_unavailable:
        "Échec de la récupération des données de la facture.",
    },
    he: {
