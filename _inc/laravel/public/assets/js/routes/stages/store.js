/**
 * @fileoverview TypeScript version of public/assets/js/routes/stages/store.js
        ...
        f.addEventListener("submit", (e) => {
            try {
                ...
                const msg = f.getAttribute("data-guard-msg") ??
                    "Store stage route is unavailable. Please contact technical support or your domain administrator.", bsLink = document.querySelector('link[href*="bootstrap"]');
