/**
 * @fileoverview TypeScript version of public/assets/js/routes/attendances/edit.js
...
((): void => {
  try {
    document.querySelectorAll('[id^="edit-attendance-link-"]').forEach((el: Element): void => {
      try {
          ...
          el.addEventListener("click", event => {
            try {
              ...
              const msg =
                ...
                "Edit attendance route is unavailable. Please contact technical support or your domain administrator.";
