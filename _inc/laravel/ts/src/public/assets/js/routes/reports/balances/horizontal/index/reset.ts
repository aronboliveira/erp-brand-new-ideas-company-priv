...
((): void => {
  try {
    ...
    const flag = "data-balance-sheet-reset-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "View balance sheet route is unavailable. Please contact technical support or your domain administrator.";
