@php
    use App\Config\Constants\ProjectsConstants;
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="d-block text-sm text-muted">{{ $task->project->name }}
                                    <span class="badge badge-xs badge-{{ (\Auth::user()->checkProject($task->project_id) == 'Owner') ? ProjectsConstants::STT_SCS : ProjectsConstants::STT_WRN  }}">{{ __(\Auth::user()->checkProject($task->project_id)) }}</span>
                                </span>
                            </td>
                            <td>{{ $task->stage->name }}</td>
                            <td>
                                <span class="badge badge-pill badge-sm badge-{{__(ProjectTask::$priority_color[$task->priority])}}">{{ __(ProjectTask::$priority[$task->priority]) }}</span>
                            </td>
