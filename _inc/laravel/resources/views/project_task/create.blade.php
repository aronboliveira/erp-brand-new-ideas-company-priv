...
@endphp
{{ Collective\Html\FormFacade::open(['route' => [ViewsConstants::PRJ.'.tasks.store',$project_id,$stage_id],'id' => 'create_task']) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                {{ Collective\Html\FormFacade::textarea(ActivitiesConstants::COL_DESC, null, 
    ...
    <div class="{{ ViewClassNamesConstants::LG_FLSH }} mb-4">
        <div class="row">
