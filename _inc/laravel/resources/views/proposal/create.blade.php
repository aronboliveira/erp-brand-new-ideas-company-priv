...
@section('content')
    <div class="row">
        {{ Collective\Html\FormFacade::open(array('url' => 'proposal','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Collective\Html\FormFacade::select('customer_id', $customers,$customer_id, array('class' => 'form-control select','id'=>'customer','data-url'=>route(ViewsConstants::PPS . '.customer'),'required'=>'required')) }}
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{Collective\Html\FormFacade::date('issue_date',null,array('class'=>'form-control','required'=>'required'))}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Collective\Html\FormFacade::label('proposal_number', __('Proposal Number'),['class'=>'form-label']) }}
                                        <div class="form-icon-user">
                                    ...
                                    {{--                                <div class="col-md-6">--}}
                                    {{--                                    <div class="form-group">--}}
                                    {{--                                        {{Collective\Html\FormFacade::label('sku',__('SKU')) }}--}}
                                    {{--                                        {!!Collective\Html\FormFacade::text('sku', null,array('class' => 'form-control','required'=>'required')) !!}--}}
                                    {{--                                    </div>--}}
                                    {{--                                </div>--}}
        ...
        <div class="col-12">
                        ...
                        <table class="table mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0">
                                    {{ Collective\Html\FormFacade::select('item', $product_services,'', array('class' => 'form-control item'  ,'data-url'=>route(ViewsConstants::PPS . '.product'),'required'=>'required')) }}
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Collective\Html\FormFacade::text('quantity','', array('class' => 'form-control quantity','required'=>'required','placeholder'=>__('Qty'),'required'=>'required')) }}
                                        <span class="unit input-group-text bg-transparent"></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Collective\Html\FormFacade::text('price','', array('class' => 'form-control price','required'=>'required','placeholder'=>__('Price'),'required'=>'required')) }}
                                        <span class="input-group-text bg-transparent">{{\Auth::user()->currencySymbol()}}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group price-input input-group search-form">
                                        {{ Collective\Html\FormFacade::text('discount','', array('class' => 'form-control discount','required'=>'required','placeholder'=>__('Discount'))) }}
                                        <span class="input-group-text bg-transparent">{{\Auth::user()->currencySymbol()}}</span>
                                    </div>
                                </td>
                                <td>
            ...
            <div class="modal-footer">
                <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{ route(ViewsConstants::PPS . '.index') }}'" class="btn btn-light">
