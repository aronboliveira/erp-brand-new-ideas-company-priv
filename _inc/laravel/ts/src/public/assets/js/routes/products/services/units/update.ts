/**
 * @fileoverview TypeScript version of public/assets/js/routes/products/services/units/update.js
  ...
  form.addEventListener(
    ...
    e => {
      ...
      if (!url || url === "#") {
        e.preventDefault();
        const msg =
          form.getAttribute("data-guard-msg") ?? "Update Product/Service Unit route is unavailable. Please contact technical support or your domain administrator.";
        toast(msg);
      }
    },
    { passive: false }
