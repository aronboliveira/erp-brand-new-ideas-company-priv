            ...
            fm.addEventListener("submit", (e) => {
                try {
                    ...
                    const msg = (fm.getAttribute("data-guard-msg") ??
                        "Store feature route is unavailable. Please contact technical support or your domain administrator.").trim(), hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
