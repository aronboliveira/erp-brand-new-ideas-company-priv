@if(isset($call))
    {{ Collective\Html\FormFacade::model($call, array('route' => array('leads.calls.update', $lead->id, $call->id), 'method' => 'PUT')) }}
@else
    {{ Collective\Html\FormFacade::open(array('route' => ['leads.calls.store',$lead->id])) }}
@endif
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-6 form-group">
            {{ Collective\Html\FormFacade::label('call_type', __('Call Type'),['class'=>'form-label']) }}
        ...
        <div class="col-12 form-group">
            {{ Collective\Html\FormFacade::label('duration', __('Duration'),['class'=>'form-label']) }} <small class="font-weight-bold">{{ __(' (Format h:m:s i.e 00:35:20 means 35 Minutes and 20 Sec)') }}</small>
            {{ Collective\Html\FormFacade::time('duration', null, array('class' => 'form-control','placeholder'=>'00:35:20','step'=>'2')) }}
        </div>
        <div class="col-12 form-group">
            {{ Collective\Html\FormFacade::label('user_id', __('Assignee'),['class'=>'form-label']) }}
        ...
        <div class="col-12 form-group">
            {{ Collective\Html\FormFacade::label('call_result', __('Call Result'),['class'=>'form-label']) }}
            {{ Collective\Html\FormFacade::textarea('call_result', null, array('class' => 'summernote-simple','id'=>'summernote')) }}
