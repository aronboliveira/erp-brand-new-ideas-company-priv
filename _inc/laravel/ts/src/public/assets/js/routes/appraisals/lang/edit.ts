/**
 * @fileoverview TypeScript version of public/assets/js/routes/appraisals/lang/edit.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    da: {
      ...
      emp_by_star1_unavailable:
        "Kunne ikke hente stjernedata for evalueringen.",
    ...
    de: {
      ...
      emp_by_star1_unavailable:
        "Fehler beim Laden der Stern-Daten für die Bewertung.",
    ...
    es: {
      ...
      emp_by_star1_unavailable:
        "Error al cargar los datos de estrellas para la evaluación.",
    ...
    fr: {
      ...
      emp_by_star1_unavailable:
        "Échec du chargement des données d’étoiles pour l’évaluation.",
    ...
    it: {
      ...
      emp_by_star1_unavailable:
        "Impossibile caricare i dati delle stelle per la valutazione.",
      employee_fetch_unavailable:
    ...
    nl: {
      ...
      emp_by_star1_unavailable:
        "Kan stergegevens voor de beoordeling niet laden.",
    ...
    pl: {
      ...
      emp_by_star1_unavailable:
        "Nie udało się załadować danych gwiazdek dla oceny.",
    ...
    pt: {
      ...
      emp_by_star1_unavailable:
        "Falha ao carregar dados de estrelas da avaliação.",
    ...
    tr: {
      ...
      emp_by_star1_unavailable:
        "Değerlendirme için yıldız verileri yüklenemedi.",
