...
use App\Traits\{DescribesCompanyBranch, FiltersSecureAttachments, HasAuditFields, NormalizesArrays, StoresManyRefJson, UsesUuids};
...
{
    use UsesUuids, HasAuditFields, NormalizesArrays, DescribesCompanyBranch, FiltersSecureAttachments, StoresManyRefJson, SoftDeletes;
