...
$user = Auth::user();
        ...
        \Log::error('complaints/index — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
...
@section(YieldingConstants::ADM_BDC)
    ...
    <li class="{{ VC::BCI }}">{{ __('Complain') }}</li>
@endsection
...
@endphp
                                                    <div class="{{ VC::ACT_BTN_PRIM }}">
                                                        <a href="#" id="editComplaintBtn_{{ $cid ?: 'na' }}" data-url="{{ $editRoute }}" data-guard-msg="{{ base64_encode($editGuardMsg) }}" data-listener-alias="edit-complaint" data-ajax-popup="true" data-title="{{ __('Edit Complaint') }}" data-bs-toggle="tooltip" title="{{ __('Edit') }}" class="{{ VC::DFL_IL_VC }}"><i class="{{ VC::TI_PC_WT }}"></i></a>
                                                    </div>
                                                @endcan
