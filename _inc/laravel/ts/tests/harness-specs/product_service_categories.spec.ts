/**
 * Auto-generated Playwright tests for product_service_categories routes
 * Generated: 2026-03-08T23:55:10.530Z
 * 
 * Routes covered: product_service_categories.create, product_service_categories.edit, product_service_categories.index
 */
import { test, expect } from '@playwright/test';


test.describe('product_service_categories.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_categories-create.html');
...
test.describe('product_service_categories.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_categories-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('product_service_categories.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/product_service_categories-index.html');
    await page.waitForLoadState('networkidle');
