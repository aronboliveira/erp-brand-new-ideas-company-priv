...
(() => {
    try {
        const form = document.getElementById("employeeAttendance_filter"), alias = "data-listening-employeeattendancefilter";
        if (form && !form.hasAttribute(alias)) {
            ...
            if (!form.getAttribute("data-listener-bound-submit")) {
                ...
                form.addEventListener("submit", event => {
                    try {
                        const url = form.getAttribute("data-url") ?? form.getAttribute("data-url");
                        if (url !== "#" || form.action !== "#")
                            return;
    ...
    try {
        const selector = ".reset-employee-attendance-link", alias2 = "data-listening-resetemployeeattendanceclick";
