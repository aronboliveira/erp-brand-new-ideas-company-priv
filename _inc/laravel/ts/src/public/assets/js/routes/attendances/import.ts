/**
 * @fileoverview TypeScript version of public/assets/js/routes/attendances/import.js
...
((): void => {
  try {
    document.querySelectorAll(".import-attendance-link").forEach((el: Element): void => {
      try {
