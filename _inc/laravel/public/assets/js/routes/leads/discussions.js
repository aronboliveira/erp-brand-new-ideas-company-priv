/**
 * @fileoverview TypeScript version of public/assets/js/routes/leads/discussions.js
...
(() => {
    ...
    if (!$) {
        try {
            ...
            console.error(`[discussions] Error:`, _);
        }
        return;
    }
    const ERR_FB = "# ERROR", DCL = "data-client-localized", DGM = "data-guard-msg", DSL = "data-sv-localized", DPL = "data-pointer-listener", FORM_ID = "leads-discussion-form", MSG_KEY = "leads_discussion_route_unavailable";
    // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
