/**
 * @fileoverview TypeScript version of public/assets/js/routes/payslips/allowanceDestroy.js
 * @generated from original JavaScript - manual review recommended
 * @module allowanceDestroy
 */
(() => {
    try {
        const forms = Array.from(document.querySelectorAll('form[id^="allowance-delete-form-"][data-url][data-guard-msg]'));
        forms.forEach(fm => {
            try {
        ...
        const links = Array.from(document.querySelectorAll('a[id^="allowance-delete-link-"][data-url][data-guard-msg]'));
        links.forEach(l => {
            try {
...
//# sourceMappingURL=allowanceDestroy.js.map