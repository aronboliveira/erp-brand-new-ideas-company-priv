/**
 * Auto-generated Playwright tests for holidays routes
 * Generated: 2026-03-08T23:55:10.526Z
 * 
 * Routes covered: holidays.calendar, holidays.create, holidays.edit
 */
import { test, expect } from '@playwright/test';


test.describe('holidays.calendar', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/holidays-calendar.html');
...
test.describe('holidays.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/holidays-create.html');
    await page.waitForLoadState('networkidle');
...
test.describe('holidays.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/holidays-edit.html');
    await page.waitForLoadState('networkidle');
