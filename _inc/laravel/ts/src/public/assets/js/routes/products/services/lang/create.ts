/**
 * @fileoverview TypeScript version of public/assets/js/routes/products/services/lang/create.js
...
((): void => {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    fr: {
      ...
      toggle_quantity_unavailable:
        "Impossible d’activer/désactiver le champ quantité",
    },
    he: {
    ...
    it: {
      ...
      toggle_quantity_unavailable:
        "Impossibile attivare/disattivare il campo quantità",
    },
    ja: {
    ...
    pt: {
      ...
      toggle_quantity_unavailable:
        "Não é possível alternar o campo de quantidade",
    },
    "pt-br": {
      image_preview_unavailable: "Não é possível pré-visualizar a imagem",
      toggle_quantity_unavailable:
