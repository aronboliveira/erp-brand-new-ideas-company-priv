...
@section('action-btn')
    @can('create holiday')
        <div class="float-end">
            <a href="{{ route('holiday.calendar') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{__('calendar View')}}" data-original-title="{{__('calendar View')}}">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class=" mt-2 " id="multiCollapseExample1">
                    <div class="card">
                        <div class="card-body">
                            {{ Form::open(array('route' => array('holiday.calendar'),'method'=>'get','id'=>'holiday_filter')) }}
