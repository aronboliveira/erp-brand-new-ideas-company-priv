...
((): void => {
  try {
    ...
    const flag = "data-delete-purchase-payment-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Destroy purchase payment route is unavailable. Please contact technical support or your domain administrator.";
