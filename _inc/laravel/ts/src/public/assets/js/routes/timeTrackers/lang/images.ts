/**
 * @fileoverview TypeScript version of public/assets/js/routes/timeTrackers/lang/images.js
...
(function (): void {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    pt: {
      ...
      img_preview_unavailable:
        "Não foi possível abrir a pré-visualização das imagens.",
    ...
    "pt-br": {
      ...
      img_preview_unavailable:
        "Não foi possível abrir a visualização de imagens.",
      img_remove_unavailable: "Não foi possível remover a imagem.",
      slider_unavailable: "Slider indisponível.",
      images_empty_label: "Imagens indisponíveis.",
    },
