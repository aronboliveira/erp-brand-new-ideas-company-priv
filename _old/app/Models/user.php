...

{
    ...
    {
        return $this->belongsTo(Plan::class, 'plan', 'id'); // Explicitly specify foreign key
    }
    ...
    {
        return Vendor::where('created_by', '=', $this->creatorId())->count();
    }
    ...
    {
        return Vendor::where('created_by', '=', $id)->count();
    }
    ...
    public static function defaultEmail()
    {
        ...
        $defaultTemplate = $EMAIL_DEFAULT_TEMPLATES // imported from ..ssr/EmailDefaultTemplates
        $defaultTemplate = [
            'new_user' => [
                'subject' => 'New User',
                'lang' => [
