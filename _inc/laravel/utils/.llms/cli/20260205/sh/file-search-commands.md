...
```bash
find /workspace/erp/_inc/laravel/public/assets/js -name "route-guard.js" -type f
```

Result: `/workspace/erp/_inc/laravel/public/assets/js/core/route-guard.js`

### Find frontend test directory

```bash
find /workspace/erp/_inc/laravel/tests/Unit -type d -name "frontend"
```

Result: `/workspace/erp/_inc/laravel/tests/Unit/frontend`

### List frontend test directory contents

```bash
ls -la /workspace/erp/_inc/laravel/tests/Unit/frontend/
```

### Find PHP and TypeScript files in test directory

```bash
find /workspace/erp/_inc/laravel/tests/Unit/frontend/js -name "*.php" -o -name "*.ts" | head -20
```
...
```bash
find /workspace/erp/_inc/laravel/public/assets/js/generic -name "*.js" -type f
```

Result: `/workspace/erp/_inc/laravel/public/assets/js/generic/checkMounted.js`

### List core JavaScript files

```bash
ls -lh /workspace/erp/_inc/laravel/public/assets/js/core/
```
