...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/routes/invoices/theme7.css') }}" />
                    ...
                    <tr>
                        <td>
                            <p>
                                ...
                                {{ ($settings['company_city'] ?? '') !== '' ? $settings['company_city'] : __('No city') }}
                                {{ ($settings['company_city'] ?? '') !== '' ? ',' : '' }}
                                {{ $settings['company_state'] ?? '' }}
                                {{ ($settings['company_zipcode'] ?? '') !== '' ? ' - '.$settings['company_zipcode'] : '' }}<br>
