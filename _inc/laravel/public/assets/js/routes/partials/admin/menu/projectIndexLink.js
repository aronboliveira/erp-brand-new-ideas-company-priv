/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/projectIndexLink.js
 * @generated from original JavaScript - manual review recommended
 * @module projectIndexLink
 */
(() => {
    const listenerAttr = "data-projects-listener-active", el = document.getElementById("projects-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[projectIndexLink] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=projectIndexLink.js.map