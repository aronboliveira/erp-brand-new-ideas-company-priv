 ...
 */
(() => {
    const listenerAttr = "data-language-create-listener-active", form = document.getElementById("language-create-form");
    ...
    const observer = new MutationObserver(() => {
        if (!document.getElementById("language-create-form"))
            observer.disconnect();
    });
