                            ...
                            <div class="{{ VC::R_FLX_ALC_JCE }}">
                                <div class="{{ VC::CL_POS3 }}">
                                    <div class="btn-box">
                                        ...
                                        {{ Collective\Html\FormFacade::date('issue_date', isset($_GET['issue_date'])?$_GET['issue_date']:'', array('class' => 'form-control month-btn','id'=>'pc-daterangepicker-1')) }}
                                    </div>
                                </div>
                                <div class="{{ VC::CL_POS3 }}">
                                        <div class="btn-box">
                                ...
                                <div class="{{ VC::C_AT_FEND }}">
                                    ...
                                    <a
                                        id="{{ 'invoice-reset-link-' . $invoice->id }}"
                                        href="{{ $submitUrl }}"
                                        class="{{ VC::BT_SM_DG }}"
                                        data-toggle="tooltip"
                                        title="{{ __('Reset') }}"
                                    ...
                                    <td>
                                        @if ($invoice->due_date < date('Y-m-d'))
                                            <p class="text-danger mt-3">
                                                {{ $user?->dateFormat($invoice->due_date) }}</p>
                                        @else
