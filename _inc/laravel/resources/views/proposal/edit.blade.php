...
@section('content')
    <div class="row">
        {{ Collective\Html\FormFacade::model($proposal, array('route' => array(ViewsConstants::PPS . '.update', $proposal->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                    ...
                                    {{ Collective\Html\FormFacade::select('customer_id', $customers,null, array('class' => 'form-control select ','id'=>'customer','data-url'=>route(ViewsConstants::PPS . '.customer'),'required'=>'required')) }}
                            </div>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    {{ Collective\Html\FormFacade::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>route(ViewsConstants::PPS . '.product'))) }}
                                </td>
                                <td>
