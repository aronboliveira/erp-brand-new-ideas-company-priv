/**
 * Auto-generated Playwright tests for permissions routes
...
test.describe('permissions.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/permissions-create.html');
...
test.describe('permissions.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/permissions-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('permissions.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/permissions-index.html');
    await page.waitForLoadState('networkidle');
