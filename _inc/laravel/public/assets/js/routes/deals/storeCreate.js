/**
 * @fileoverview TypeScript version of public/assets/js/routes/deals/storeCreate.js
 * @generated from original JavaScript - manual review recommended
 * @module storeCreate
 */
(() => {
    try {
        const fm = document.getElementById("deal-store-form");
        if (!fm)
            return;
            ...
            fm.addEventListener("submit", (e) => {
                try {
                    ...
                    const msg = fm.getAttribute("data-guard-msg") ??
                        "Store Deal route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
...
//# sourceMappingURL=storeCreate.js.map