/**
 * Auto-generated Playwright tests for customers routes
...
test.describe('customers.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/customers-create.html');
...
test.describe('customers.dashboard', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/customers-dashboard.html');
    await page.waitForLoadState('networkidle');
...
test.describe('customers.import', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    ...
    await page.goto('/harness/pages/customers-import.html');
    await page.waitForLoadState('networkidle');
...
test.describe('customers.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/customers-index.html');
    await page.waitForLoadState('networkidle');
...
test.describe('customers.payment', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/customers-payment.html');
    await page.waitForLoadState('networkidle');
...
test.describe('customers.show', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/customers-show.html');
    await page.waitForLoadState('networkidle');
...
test.describe('customers.transaction', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/customers-transaction.html');
    await page.waitForLoadState('networkidle');
