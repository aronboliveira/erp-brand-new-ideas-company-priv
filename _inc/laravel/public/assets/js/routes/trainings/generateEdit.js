/**
 * @fileoverview TypeScript version of public/assets/js/routes/trainings/generateEdit.js
...
(() => {
    try {
        ...
        a.addEventListener("click", (e) => {
            try {
                ...
                if (window.location.hostname === "localhost" ||
                    ...
                    console.error("[assets/js/routes/trainings/generateEdit.js] Click handler error:", 
        ...
        if (window.location.hostname === "localhost" ||
            window.location.hostname === "127.0.0.1")
            console.error("[assets/js/routes/trainings/generateEdit.js] Initialization error:", 
