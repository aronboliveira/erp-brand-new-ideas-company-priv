{{ Collective\Html\FormFacade::open(array('url' => 'plans', 'enctype' => "multipart/form-data")) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{Collective\Html\FormFacade::number('price',null,array('class'=>'form-control','placeholder'=>__('Enter Plan Price')))}}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group">
                {{ Collective\Html\FormFacade::number('storage_limit', null, ['class' => 'form-control','required'=>'required']) }}
