        ...
        try {
          const a =
            ...
            ((e.target as Element).closest
              ? (e.target as Element).closest("a.download-monthly-cashflow")
              : null);
          if (!a) return;
          ...
          const msg =
            ...
            "Download function for monthly cashflow reports is unavailable. Please contact technical support or your domain administrator.";
