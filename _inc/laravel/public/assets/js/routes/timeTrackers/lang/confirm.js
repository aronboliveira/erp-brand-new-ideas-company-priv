(function () {
    ...
    const t = {
        ...
        es: {
            ...
            confirm_unavailable: "No se pudo abrir el cuadro de confirmación de eliminación.",
        },
        fr: {
            plugin_unavailable: "Une bibliothèque requise n’a pas été chargée.",
            confirm_unavailable: "Impossible d’ouvrir la boîte de confirmation de suppression.",
        },
        he: {
        ...
        it: {
            ...
            confirm_unavailable: "Impossibile aprire la finestra di conferma eliminazione.",
        },
        ja: {
