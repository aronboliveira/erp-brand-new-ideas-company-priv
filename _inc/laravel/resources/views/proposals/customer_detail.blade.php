...
@endphp
                        ...
                        @php
                            try {
                                ...
                                \Log::error('proposals/customer_detail — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
                            }
@endphp
...
@endphp
                ...
                @else
                    <small class="{{ VC::TXT_MT }}">{{ __('No billing information available') }}</small>
                @endif
            </div>
        </div>
        <div class="col-md-5">
...
@endphp
                ...
                @else
                    <small class="{{ VC::TXT_MT }}">{{ __('No shipping information available') }}</small>
                @endif
            </div>
        </div>
        <div class="{{ VC::CM2 }}">
...
@else
    <div class="row">
        <div class="{{ VC::CM12 }}">
            <small class="{{ VC::TXT_MT }}">{{ __('Customer information is not available') }}</small>
        </div>
    </div>
@endif
