            ...
            btn.addEventListener("click", (e) => {
                try {
                    ...
                    const msg = btn.getAttribute("data-guard-msg") ??
                        "Reset tax summary route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
