    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for monthly attendance reports is unavailable. Please contact technical support or your domain administrator.";
