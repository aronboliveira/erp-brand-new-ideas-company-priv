...
class LandingPageDataTableSeeder extends Seeder
{
    public const DEFAULT_DATA_ARR = [
        ...
        LPSC::TB_NTF_MSG_K => 'Technology assistance and support with over 30 years of tradition. Talk to Nova Prestech and protect your data and devices today.',
        ...
        LPSC::HM_DEMO_LNK_K => 'https://prestech.com.br/services/',
        LPSC::HM_BUY_LNK_K  => 'https://prestech.com.br/site/contact/',
        LPSC::HM_BNR_K      => 'home_banner.png',
        LPSC::HM_LGO_K      => 'home_logo.png',
        LPSC::FT_STT_K      => LPSC::FT_STT_DEF,
        LPSC::FT_TTL_K      => LPSC::FT_TTL_DEF,
        LPSC::FT_HDG_K      => 'Why choose Nova Prestech assistance?',
        ...
        LPSC::FT_BUY_LNK_K  => 'https://prestech.com.br/site/contact/',
        ...
        LPSC::DC_DEMO_LNK_K => 'https://prestech.com.br/services/',
        LPSC::DC_BUY_LNK_K  => 'https://prestech.com.br/site/contact/',
        ...
        LPSC::TM_HDG_K       => 'Success stories with Prestech',
        ...
        LPSC::JU_HDG_K   => 'Talk to Nova Prestech',
