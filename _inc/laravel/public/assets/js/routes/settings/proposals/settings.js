            ...
            formEl.addEventListener("submit", (e) => {
                try {
                    ...
                    const guardMsg = formEl.getAttribute("data-guard-msg") ??
                        "Proposal template settings route is unavailable. Please contact technical support or your domain administrator.", hasBootstrap = !!(document.querySelector('link[href*="bootstrap"]') &&
                        window.bootstrap);
