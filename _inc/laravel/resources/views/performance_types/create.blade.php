@php
    ...
    $guardMsg  = Utility::fetchLinkMessage($lang, VW::PFM_TP, 'store_route_unavailable') ?? __('Performance type route is unavailable. Please contact technical support or your domain administrator.');
