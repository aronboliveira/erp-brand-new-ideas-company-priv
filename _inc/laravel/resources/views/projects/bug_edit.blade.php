...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Collective\Html\FormFacade::text(ActivitiesConstants::COL_TT, null, array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Collective\Html\FormFacade::date(ProjectsConstants::COL_S_DT, null, array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group  col-md-6">
            {{ Collective\Html\FormFacade::label(ProjectsConstants::COL_D_DATE, __('Due Date'),['class'=>'form-label']) }}
            {{ Collective\Html\FormFacade::date(ProjectsConstants::COL_D_DATE, null, array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
