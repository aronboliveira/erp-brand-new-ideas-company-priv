/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/dashboardViewLink.js
 * @generated from original JavaScript - manual review recommended
 * @module dashboardViewLink
 */

((): void => {
  const listenerAttr = "data-dashboard-listener-active",
    el = document.getElementById("dashboard-link");
  ...
  if (!el.getAttribute("data-listener-bound-click")) {
    ...
    el.addEventListener("click", event => {
      try {
        ...
        console.error(`[dashboardViewLink] Error:`, error);
      }
    });
  }
