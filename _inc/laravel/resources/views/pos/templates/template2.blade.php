...
try {
    ...
    Log::error('posNumber Throwable: ' . $e->getMessage());
...
try {
    ...
    Log::error('issueDate Throwable: ' . $e->getMessage());
...
<body>
                                    ...
                                    <?php if (!empty(data_get($item, 'itemTax'))): ?>
                                        <?php foreach ((array) data_get($item, 'itemTax', []) as $taxes): ?>
                                            ...
                                            try {
                                                ...
                                                Log::error('Tax calc Throwable: ' . $e->getMessage());
                                            }
                                            ?>
    ...
    <?php if (!isset($preview)): ?>
        <?php try {
            ...
            Log::error('pos.script include Throwable: ' . $e->getMessage());
        } ?>
    <?php endif; ?>
</body>
