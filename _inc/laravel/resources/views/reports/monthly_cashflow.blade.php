    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
               href="{{ route(ViewsConstants::RPT . '.quarterly.cashflow') }}"
               onclick="window.location.href = '{{ route(ViewsConstants::RPT . '.quarterly.cashflow') }}'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2"id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Collective\Html\FormFacade::open(array('route' => array(ViewsConstants::RPT . '.monthly.cashflow'),'method' => 'GET','id'=>'monthly_cashflow')) }}
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="{{route(ViewsConstants::RPT . '.monthly.cashflow')}}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"  title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
