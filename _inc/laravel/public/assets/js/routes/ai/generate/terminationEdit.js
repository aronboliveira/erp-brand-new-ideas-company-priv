...
(() => {
    try {
        ...
        a.addEventListener("click", (e) => {
            try {
                ...
                if (window.location.hostname === "localhost" ||
                    ...
                    console.error("[assets/js/routes/terminations/generateAi.js] Click handler error:", 
        ...
        if (window.location.hostname === "localhost" ||
            window.location.hostname === "127.0.0.1")
            console.error("[assets/js/routes/terminations/generateAi.js] Initialization error:", 
            error?.constructor?.name ?? "Error", 
            error?.message ?? "Unknown error");
    }
})();
//# sourceMappingURL=terminationEdit.js.map