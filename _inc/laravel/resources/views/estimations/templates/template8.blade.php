                                ...
                                <div data-v-136bf9b5 class="d-inner">
                                    <div data-v-136bf9b5 class="row">
                                        <div data-v-136bf9b5 class="col-66">
                                            <img data-v-136bf9b5 src="{{ $imgSrc }}" class="d-logo" style="max-width:200px;">
                                            <h3 data-v-136bf9b5>{{ ($settings['company_name'] ?? '') !== '' ? $settings['company_name'] : __('No company name available') }}</h3>
                                            <pre data-v-136bf9b5>{{ ($settings['company_address'] ?? '') !== '' ? $settings['company_address'] : __('No address available for company') }}</pre>
                                            <p data-v-136bf9b5>
                                            ...
                                            <p data-v-136bf9b5>{{ (($settings['company_country'] ?? '') !== '') ? $settings['company_country'] : __('No country available for company') }}</p>
                                        </div>
                                        <div data-v-136bf9b5 class="col-33">
                                            <h1 data-v-136bf9b5 class="fancy-title mb5" style="color: {{ $color === '#ffffff' ? 'black' : $color }};">{{ __('ESTIMATION') }}</h1>
                                        </div>
                                    </div>
                                    <div data-v-136bf9b5 class="break-50"></div>
                                    <div data-v-136bf9b5 class="row">
                                        <div data-v-136bf9b5 class="col-66">
                                            <strong data-v-136bf9b5 class="mb5">{{ __('Bill To') }}:</strong>
                                            <p data-v-136bf9b5>{{ isset($client->name) && $client->name !== '' ? $client->name : __('No client name available') }}</p>
                                            <pre data-v-136bf9b5>{{ isset($client->email) && $client->email !== '' ? $client->email : __('No client email available') }}</pre>
                                        </div>
                                        <div data-v-136bf9b5 class="col-33">
                                            <table data-v-136bf9b5 class="summary-table">
                                                <tbody data-v-136bf9b5>
                                                    <tr data-v-136bf9b5>
                                                        ...
                                                        <td data-v-136bf9b5 class="{{ VC::TX_END }}">
                                    ...
                                    <div data-v-136bf9b5 class="d-table">
                                        <div data-v-136bf9b5 class="d-table">
                                            <div data-v-136bf9b5 class="d-table-tr">
                                                ...
                                                <div data-v-136bf9b5 class="d-table-th w-3 {{ VC::TX_END }}">{{ __('Amount') }}</div>
                                            </div>
                                                    ...
                                                    @foreach($items as $key => $item)
                                                        @php
                                                            try {
                                                                ...
                                                                \Log::error('estimations/templates/template8 — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
                                                            }
@endphp
                                                        <div data-v-136bf9b5 class="d-table-tr">
                                                            <div data-v-136bf9b5 class="d-table-td w-2"><span data-v-136bf9b5>{{ (int)$key + 1 }}</span></div>
                                                            <div data-v-136bf9b5 class="d-table-td w-13">
                                                                <pre data-v-136bf9b5>{{ isset($item->name) && $item->name !== '' ? $item->name : __('No item name available') }}<br data-v-136bf9b5></pre>
                                                            </div>
                                                            <div data-v-136bf9b5 class="d-table-td w-3">
                                                                <span data-v-136bf9b5>
                                                                    @if(!is_null($p))
                                                            ...
                                                            <div data-v-136bf9b5 class="d-table-td w-2"><span data-v-136bf9b5>{{ !is_null($q) ? $q : __('No quantity available') }}</span></div>
                                                            <div data-v-136bf9b5 class="d-table-td w-3 {{ VC::TX_END }}">
                                                                <span data-v-136bf9b5>
                                                                    @if(!is_null($lt))
                                                ...
                                                @else
                                                    <div data-v-136bf9b5 class="d-table-tr">
                                                        ...
                                                        <div data-v-136bf9b5 class="d-table-td w-13"><pre data-v-136bf9b5>-<br data-v-136bf9b5></pre></div>
                                                        <div data-v-136bf9b5 class="d-table-td w-3"><span data-v-136bf9b5>-</span></div>
                                                        <div data-v-136bf9b5 class="d-table-td w-2"><span data-v-136bf9b5>-</span></div>
                                                        <div data-v-136bf9b5 class="d-table-td w-3 {{ VC::TX_END }}"><span data-v-136bf9b5>-</span></div>
                                                    </div>
                                                @endif
                                            </div>
                                            <div data-v-136bf9b5 class="d-table-footer">
                                                ...
                                                <div data-v-136bf9b5 class="d-table-summary">
                                                    <div data-v-136bf9b5 class="d-table-summary-item">
                                                        ...
                                                        <div data-v-136bf9b5 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($subTotalVal) : number_format($subTotalVal, 2) }}</div>
                                                    </div>
                                                    @if($discountVal > 0)
                                                        <div data-v-136bf9b5 class="d-table-summary-item">
                                                            <div data-v-136bf9b5 class="d-table-label">{{ __('Discount') }}:</div>
                                                            <div data-v-136bf9b5 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($discountVal) : number_format($discountVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    @if($taxVal > 0)
                                                        <div data-v-136bf9b5 class="d-table-summary-item">
                                                            <div data-v-136bf9b5 class="d-table-label">{{ (data_get($estimation, 'tax.name') ?: __('Tax')) }} ({{ (string)(data_get($estimation, 'tax.rate') ?? '0') }}%):</div>
                                                            <div data-v-136bf9b5 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($taxVal) : number_format($taxVal, 2) }}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-136bf9b5 class="d-table-summary-item">
                                                        <div data-v-136bf9b5 class="d-table-label">{{ __('Total') }}:</div>
                                                        <div data-v-136bf9b5 class="d-table-value">{{ $hasPriceFormat ? (string)$usr->priceFormat($totalVal) : number_format($totalVal, 2) }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
