...
((): void => {
  try {
    ...
    const flag = "data-reset-payroll-report-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          e.preventDefault();
          const msg =
            a.getAttribute("data-guard-msg") ?? "Payroll reset route is unavailable. Please contact technical support or your domain administrator.";
