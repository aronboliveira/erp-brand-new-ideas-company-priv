/**
 * @fileoverview TypeScript version of public/assets/js/routes/attendances/bulk/lang/toggle.js
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    da: {
      present_all_toggle_failed:
        "Kunne ikke slå alle afkrydsningsfelter til/fra.",
      present_toggle_failed: "Kunne ikke skifte tilstedeværelsesfelt.",
    },
    de: {
      present_all_toggle_failed:
        "Konnte nicht alle Kontrollkästchen umschalten.",
      present_toggle_failed:
        "Konnte das Anwesenheitskontrollkästchen nicht umschalten.",
    },
    en: {
    ...
    it: {
      present_all_toggle_failed:
        "Impossibile attivare/disattivare tutte le caselle.",
      present_toggle_failed:
        "Impossibile attivare/disattivare la casella di presenza.",
    },
    ja: {
      present_all_toggle_failed:
        "すべてのチェックボックスの切り替えに失敗しました。",
      present_toggle_failed: "出席チェックボックスの切り替えに失敗しました。",
    },
    nl: {
      present_all_toggle_failed: "Kan niet alle selectievakjes wisselen.",
      present_toggle_failed:
        "Kan selectievakje voor aanwezigheid niet wisselen.",
    },
    pl: {
      present_all_toggle_failed:
        "Nie udało się przełączyć wszystkich pól wyboru.",
      present_toggle_failed: "Nie udało się przełączyć pola wyboru obecności.",
    },
    pt: {
      present_all_toggle_failed:
        "Falha ao alternar todas as caixas de seleção.",
