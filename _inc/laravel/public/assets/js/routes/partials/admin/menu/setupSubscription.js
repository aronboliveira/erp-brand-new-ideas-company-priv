/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/setupSubscription.js
 * @generated from original JavaScript - manual review recommended
 * @module setupSubscription
 */
(() => {
    const listenerAttr = "data-setup-subscription-plan-listener-active", el = document.getElementById("setup-subscription-plan-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[setupSubscription] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=setupSubscription.js.map