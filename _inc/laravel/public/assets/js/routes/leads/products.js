...
(function () {
    const L = "data-guard-listener", DCL = "data-client-localized", DGM = "data-guard-msg", DSL = "data-sv-localized";
    ...
    function bindSubmitGuard() {
        try {
            ...
            const form = document.getElementById("lead-products-update-form"), btn = document.getElementById("lead-products-update-submit");
            if (!form || !btn)
                return;
