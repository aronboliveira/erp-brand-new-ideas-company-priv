...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('vendor.index')}}">{{__('Vendor')}}</a></li>
...
@section('action-btn')
    <div class="float-end">
        ...
        @can('edit vendor')
            <a href="#" class="btn btn-sm btn-primary" data-size="xl" data-url="{{ route('vendor.edit',$vendor['id']) }}" data-ajax-popup="true" title="{{__('Edit')}}" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}">
                <i class="ti ti-pencil"></i>
            </a>
        @endcan
        @can('delete vendor')
            {!! Form::open(['method' => 'DELETE', 'route' => ['vendor.destroy', $vendor['id']],'class'=>'delete-form-btn','id'=>'delete-form-'.$vendor['id']]) !!}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="p-4">
                                ...
                                <h6 class="report-text mb-3">{{\Auth::user()->vendorNumberFormat($vendor->vendor_id)}}</h6>
