...
try {
    ...
    Log::error('purchaseNumber Throwable: ' . $e->getMessage());
...
try {
    ...
    Log::error('purchaseDate Throwable: ' . $e->getMessage());
...
try {
    ...
    Log::error('QR Route Throwable: ' . $e->getMessage());
    $qrValue = '#';
}
...
<body>
                        ...
                        <td>
                            ...
                            <div class="view-qrcode" style="margin-top:5px;margin-left:0;margin-right:0;">
                                ...
                                try {
                                    ...
                                    Log::error('QR HTML Throwable: ' . $e->getMessage());
                                    echo '<div></div>';
                                }
                                ?>
                            </div>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        try {
                                            $discTotal = method_exists($purchase, 'getTotalDiscount') ? $purchase->getTotalDiscount() : 0;
                                            echo e(Utility::priceFormat($settings, $discTotal));
                                        } catch (\Throwable $e) {
    ...
    <?php if (!isset($preview)): ?>
        ...
        try {
            ...
            Log::error('script include Throwable: ' . $e->getMessage());
        }
        ?>
    <?php endif; ?>
</body>
