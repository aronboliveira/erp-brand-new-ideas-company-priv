...
$lang = Utility::fetchUserLang();
		...
		\Log::error('termination_types/index — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	}
@endphp
...
@section(YieldingConstants::ADM_BDC)
	...
	<li class="{{ VC::BCI }}">{{ __('Termination Type') }}</li>
@endsection
