/**
 * Jest unit tests for indicators routes
...
describe('indicators.create', () => {
  // TypeScript sources: src/public/assets/js/routes/indicators/store
  // Import would be: import * as module0 from 'src/public/assets/js/routes/indicators/store';
...
describe('indicators.index', () => {
  // TypeScript sources: src/public/assets/js/routes/indicators/index
  // Import would be: import * as module0 from 'src/public/assets/js/routes/indicators/index';
