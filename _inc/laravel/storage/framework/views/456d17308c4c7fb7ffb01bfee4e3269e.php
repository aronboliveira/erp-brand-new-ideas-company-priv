                ...
                <div class="<?php echo e(ViewClassNamesConstants::CD); ?>">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Collective\Html\FormFacade::label('Banner', __('Banner'), [
                                        'class' => 'form-label',
                                        'id' => 'banner_image'
                                    ])); ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php if ($lpSettings[LandingPageSettingsConstants::HM_LGO_K] != ''): ?>
                                    <div id="imageContainer">
                                        <?php $__currentLoopData = explode(',', $lpSettings[LandingPageSettingsConstants::HM_LGO_K]);
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $k => $home_logo): $__env->incrementLoopIndices();
