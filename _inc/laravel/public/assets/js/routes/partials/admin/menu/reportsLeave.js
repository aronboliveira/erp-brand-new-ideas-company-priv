/**
 * @fileoverview TypeScript version of public/assets/js/routes/partials/admin/menu/reportsLeave.js
 * @generated from original JavaScript - manual review recommended
 * @module reportsLeave
 */
(() => {
    const listenerAttr = "data-leave-listener-active", el = document.getElementById("reports-leave-link");
    ...
    if (!el.getAttribute("data-listener-bound-click")) {
        ...
        el.addEventListener("click", event => {
            try {
                ...
                console.error(`[reportsLeave] Error:`, error);
            }
        });
    }
...
//# sourceMappingURL=reportsLeave.js.map