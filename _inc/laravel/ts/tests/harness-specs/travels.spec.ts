/**
 * Auto-generated Playwright tests for travels routes
...
test.describe('travels.create', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/travels-create.html');
...
test.describe('travels.edit', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/travels-edit.html');
    await page.waitForLoadState('networkidle');
...
test.describe('travels.index', () => {
  test('should load without JavaScript errors', async ({ page }) => {
    const errors: string[] = [];
    page.on('pageerror', err => errors.push(err.message));
    
    await page.goto('/harness/pages/travels-index.html');
    await page.waitForLoadState('networkidle');
