/**
 * @fileoverview TypeScript version of public/assets/js/routes/landingPage/menubar/edit.js
  ...
  ((): void => {
    ...
    const start = (): void => {
      try {
        ...
        showToastOrAlert(
          (e instanceof Error ? e.message : null) || tr("init_failed"),
        );
      }
    };
