/**
 * @fileoverview TypeScript version of public/assets/js/routes/reports/posVsPurchase/lang/pdf.js
...
(function (): void {
  ...
  const t: Record<string, Record<string, string>> = {
    ...
    he: {
      ...
      chart_unavailable: "לא ניתן היה להציג את התרשים.",
    },
    it: {
