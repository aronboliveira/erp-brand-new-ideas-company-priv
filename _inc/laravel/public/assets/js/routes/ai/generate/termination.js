        ...
        l.addEventListener("click", (e) => {
            try {
                ...
                const msgAttr = l.hasAttribute("data-guard-msg")
                    ...
                    ? msgAttr
                    : "Generate termination route is unavailable. Please contact technical support or your domain administrator.", bootstrapLink = document.querySelector('link[href*="bootstrap"]'), hasBootstrap = !!(bootstrapLink && typeof window.bootstrap.Toast !== "undefined");
