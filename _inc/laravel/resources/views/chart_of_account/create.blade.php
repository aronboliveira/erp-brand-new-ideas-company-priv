{{ Collective\Html\FormFacade::open(array('url' => 'chart-of-account')) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Collective\Html\FormFacade::number('code', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
            {{ Collective\Html\FormFacade::label('type', __('Account'),['class'=>'form-label']) }}
            {{ Collective\Html\FormFacade::select('type', $types,null, array('class' => 'form-control select','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('sub_type',__('Type'),['class'=>'form-label'])}}
            <select class="form-control select" name="sub_type" id="sub_type" required>
            </select>
        </div>
        <div class="form-group col-md-6">
            {{Collective\Html\FormFacade::label('is_enabled',__('Is Enabled'),array('class'=>'form-label')) }}
