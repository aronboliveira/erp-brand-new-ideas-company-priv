...
@push(StacksConstants::ADM_SCR_PG)
    ...
    <script>
        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                url: '{{route(ViewsConstants::RPT . '.payroll.getdepartment')}}',
                type: 'POST',
                data: {
                    "branch_id": bid,
                    "_token": "{{ csrf_token() }}",
        ...
        function getEmployee(did) {
            $.ajax({
                url: '{{route(ViewsConstants::RPT . '.payroll.getemployee')}}',
                type: 'POST',
                data: {
                    "department_id": did,
                    "_token": "{{ csrf_token() }}",
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Collective\Html\FormFacade::open(array('route' => array(ViewsConstants::RPT . '.payroll'),'method'=>'get','id'=>'report_payroll')) }}
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-auto mt-4">
                                ...
                                <a href="{{route(ViewsConstants::RPT . '.payroll')}}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="{{ __('Reset') }}" data-original-title="{{__('Reset')}}">
