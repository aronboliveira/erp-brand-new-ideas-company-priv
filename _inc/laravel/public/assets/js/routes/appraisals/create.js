/**
 * @fileoverview TypeScript version of public/assets/js/routes/appraisals/create.js
 * @generated from original JavaScript - manual review recommended
 * @module create
 */
(() => {
    const el = document.getElementById("appraisal-create-link"), flagAttr = "data-listener-active";
