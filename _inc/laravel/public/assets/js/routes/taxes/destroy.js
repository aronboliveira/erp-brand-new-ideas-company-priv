...
(() => {
    try {
            ...
            try {
                ...
                f.addEventListener("submit", (e) => {
                    try {
                        ...
                        if (bsLink && window.bootstrap.Toast) {
                            ...
                            try {
                                ...
                                if (window.location.hostname === "localhost" ||
                                    ...
                                    console.error("[assets/js/routes/taxes/destroy.js] Bootstrap toast error:",
                        ...
                        if (window.location.hostname === "localhost" ||
                            window.location.hostname === "127.0.0.1")
                            console.error("[assets/js/routes/taxes/destroy.js] Submit handler error:",
                ...
                if (window.location.hostname === "localhost" ||
                    window.location.hostname === "127.0.0.1")
                    console.error("[assets/js/routes/taxes/destroy.js] Form binding error:",
        ...
        if (window.location.hostname === "localhost" ||
            window.location.hostname === "127.0.0.1")
            console.error("[assets/js/routes/taxes/destroy.js] Initialization error:",
