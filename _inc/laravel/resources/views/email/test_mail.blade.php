...
$lang = Utility::fetchUserLang();
        ...
        \Log::error('email/test_mail — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
    }
@endphp
<!doctype html>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" class="{{ VC::W100 }}">
                            ...
                            <td class="text-start">
                                ...
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="{{ VC::MB2 }} fw-bold">{{ __('Subject : ') . 'Testing purpose mail send' }}</p>
                                        <p class="{{ VC::MB3_FWB }}">{{ __('Hi Dear,') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="{{ VC::MB3 }}">{{ __('This mail send only for testing purpose.') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-0">
                                    <div class="fs-6">
                                        <p class="{{ VC::MY2 }}">{{ __('Feel free to reach out if you have any questions.') }}</p>
                                        <p class="{{ VC::MY2 }}">{{ __('Thank you for your business!') }}</p>
                                    </div>
                                    </td>
                                </tr>
                                <tr>
