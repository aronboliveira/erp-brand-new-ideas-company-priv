...
((): void => {
  try {
    ...
    const flag = "data-download-invoice-reports-listener";
    ...
    document.addEventListener(
      ...
      function (e) {
        try {
          ...
          const msg =
            a.getAttribute("data-guard-msg") ?? "Download function for invoice reports is unavailable. Please contact technical support or your domain administrator.";
