...
(function () {
    const $ = window.jQuery;
    const errFb = "# ERROR", dataClientLocalized = "data-client-localized", dataGuardMsg = "data-guard-msg", dataSvLocalized = "data-sv-localized", dataErrGuard = "data-error-guard", dataCalGuard = "data-cal-guard";
    ...
    const getData = () => {
        ...
        const base = String(jQ("#task_calendar").val() ?? "").trim(), endpoint = base && base !== "#"
            ? base.replace(/\/$/, "") + "/calendar/get_task_data"
            : "", urlAttr = $calendar.attr("data-url"), hrefAttr = $calendar.is("form")
