...
trait DescribesClientField
{
	...
	protected static function bootDescribesClientField(): void
	{
	    try {
	        ...
	        Log::error(static::class . '::bootDescribesClientField — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected function addClientFieldColumns(
	    ...
	    try {
	        ...
	        Log::error(static::class . '::addClientFieldColumns — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected function dropClientFieldColumns(
	    ...
	    try {
	        ...
	        Log::error(static::class . '::dropClientFieldColumns — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function normalizeClientFieldCore(Model $model): void
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeClientFieldCore — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function normalizeClientFieldFlagsAndRanges(Model $model): void
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeClientFieldFlagsAndRanges — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function normalizeClientFieldOptions(Model $model): void
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeClientFieldOptions — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function normalizeRangeAttributes(Model $model, ?FieldType $typeEnum): void
	{
	    try {
	        ...
	        Log::error(static::class . '::normalizeRangeAttributes — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	    }
	}
	...
	protected static function defaultDateRange(?FieldType $type): array
	{
	    try {
	        ...
	        Log::error(static::class . '::defaultDateRange — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
	...
	protected static function compareDateBoundaries(?FieldType $type, string $a, string $b): int
	{
	    try {
	        ...
	        Log::error(static::class . '::compareDateBoundaries — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return 0;
	    }
	}
	...
	protected static function sanitizeOptionsArray(array $options): array
	{
	    try {
	        ...
	        Log::error(static::class . '::sanitizeOptionsArray — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
	...
	protected static function sanitizeOptgroupsArray(array $optgroups): array
	{
	    try {
	        ...
	        Log::error(static::class . '::sanitizeOptgroupsArray — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
	...
	protected static function sanitizeAcceptsArray(array $accepts): array
	{
	    try {
	        ...
	        Log::error(static::class . '::sanitizeAcceptsArray — ' . get_class($e) . ': ' . $e->getMessage(), ['file' => $e->getFile(), 'line' => $e->getLine()]);
	        return [];
	    }
	}
