        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <?php echo e(Collective\Html\FormFacade::model(null, array('route' => array('landingpage.store'), 'method' => 'POST'))); ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="topbar_status"
                                                    id="topbar_status" <?php echo e(!empty($lpSettings[LandingPageSettingsConstants::TB_STT_K]) && $lpSettings[LandingPageSettingsConstants::TB_STT_K] === 'on' ? 'checked="checked"' : ''); ?>>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        <?php echo e(Collective\Html\FormFacade::label('content', __('Message'), ['class' => 'col-form-label text-dark'])); ?>

                                        <?php echo e(Collective\Html\FormFacade::textarea(LandingPageSettingsConstants::TB_NTF_MSG_K,$lpSettings[LandingPageSettingsConstants::TB_NTF_MSG_K], ['class' => 'summernote-simple form-control', 'required' => 'required'])); ?>
...
<?php echo $__env->make(ExtendingLayoutsConstants::ADM, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aron\Desktop\programming\Prestech\erp\erpgo-fork\erp_prestech\_inc\laravel\Modules/LandingPage\Resources/views/landingpage/topbar.blade.php ENDPATH**/ ?>